...
TL;DR: 新加坡2025年AI安全会议报告提出AI安全的三个研究领域：开发可信AI系统、评估风险及部署后监控。


<details>
  <summary>Details</summary>
Motivation: AI能力的快速提升引发对其安全性的担忧，需建立可信生态系统以促进创新并避免反弹。

Method: 采用防御深度模型，将AI安全研究分为开发、评估和控制三个领域。

Result: 报告整合了国际AI安全研究重点，得到33国政府支持。

Conclusion: 构建可信AI生态系统是确保AI安全、可靠和创新的关键。
...
TL;DR: 论文研究了基于LLM的代理是否理解上下文隐私，并评估了它们在多轮对话中保护用户隐私的能力。结果显示当前模型在隐私保护和协作任务完成方面表现不佳。


<details>
  <summary>Details</summary>
Motivation: 随着LLM代理的普及，代理间协作任务（如调度、协商等）对隐私保护的需求日益重要。现有基准测试仅针对单轮简单任务，无法评估复杂场景下的隐私保护能力。

Method: 提出了MAGPIE基准测试，包含158个高复杂度场景，评估LLM代理对上下文隐私的理解及协作能力。测试了GPT-4o和Claude-2.7-Sonnet等模型。

Result: 当前模型对上下文隐私的理解不足，错误分类隐私数据的比例为25.2%和43.6%。在多轮对话中，隐私泄露率高达59.9%和50.5%，且71%的场景任务未完成。
...
TL;DR: 提出了一种动态上下文感知的提示推荐系统，用于领域特定的AI应用，通过多阶段方法生成高质量提示。
...
Result: 在真实数据集上验证了方法的高实用性和相关性，得到自动化和专家评估的双重认可。
...
TL;DR: 论文提出了一种框架，用于评估语言模型建议的宏观社会影响，并引入了一个测试间接危害的数据集，结果显示在安全性和预测能力上有显著提升。


<details>
  <summary>Details</summary>
Motivation: 随着语言模型在公共政策和医疗等高影响力决策中的作用增强，需要确保其建议的长期社会影响是积极的。
...
TL;DR: 论文探讨了大型语言模型（LLMs）的因果推理能力，发现其仅能进行浅层（level-1）推理，缺乏人类深层（level-2）推理能力，并提出G^2-Reasoner方法以提升LLMs的因果推理能力。


<details>
  <summary>Details</summary>
Motivation: 研究LLMs是否具备类似人类的真实因果推理能力，填补其在深层推理上的不足。

Method: 通过分析LLMs的自回归机制，提出CausalProbe-2024基准测试，并设计G^2-Reasoner方法，结合通用知识和目标导向提示。

Result: LLMs在CausalProbe-2024上表现显著下降，而G^2-Reasoner显著提升了其在新鲜和反事实情境中的推理能力。

Conclusion: G^2-Reasoner为LLMs实现深层因果推理提供新路径，推动其向level-2推理迈进。
...
Result: 在EB-ALFRED基准测试中，任务成功率提升60.7%，尤其在常识推理和长程规划方面表现突出。
...
TL;DR: IXAII是一个交互式可解释AI系统，整合了LIME、SHAP、Anchors和DiCE四种方法，为不同用户群体提供定制化解释，并通过专家和普通用户的访谈验证其有效性。


<details>
  <summary>Details</summary>
Motivation: 现有的大多数可解释AI方法是静态的且忽略了用户视角，限制了其对目标受众的有效性。

Method: 开发了交互式可解释智能系统IXAII，整合四种可解释AI方法，并提供定制化视图和用户控制权。

Result: IXAII通过多重视觉化选项和不同解释方式，被用户认为有助于提高透明度。
...
TL;DR: 论文提出AI驱动的科学发现需解决抽象、推理和现实三大差距，而非依赖模型规模或数据。提出主动推理AI系统，结合因果模型、符号规划、知识图谱和闭环实验验证，强调人类判断的不可或缺性。


<details>
  <summary>Details</summary>
Motivation: 当前AI系统在科学发现中存在局限性，如架构僵化、推理脆弱及与现实脱节。论文旨在通过解决三大差距推动AI在科学中的应用。

Method: 提出主动推理AI系统，包括因果自监督基础模型、贝叶斯保护的符号规划、知识图谱构建及闭环实验验证。

Result: 系统通过内部模型与外部验证的互动实现科学发现，强调人类判断在不确定反馈中的关键作用。

Conclusion: 论文为AI驱动的科学发现提出新架构，强调人类与AI的协同是未来发展的核心。
...
TL;DR: TableMoE提出了一种神经符号混合专家架构，用于处理多模态表格数据的复杂结构和视觉退化问题，显著优于现有方法。
...
Method: 采用神经符号路由机制，动态分配表格元素到专用专家模块，并利用大规模对齐数据集进行预训练。
...
TL;DR: 论文探讨了视觉语言模型（VLMs）是否能像人类一样通过少量视角构建完整场景的空间心理模型，并提出了MindCube基准测试。通过三种方法提升VLMs的空间推理能力，其中“map-then-reason”方法显著提升了性能。


<details>
  <summary>Details</summary>
Motivation: 研究VLMs是否能够像人类一样构建空间心理模型，以填补现有模型在空间推理能力上的不足。

Method: 提出了MindCube基准测试，并探索了三种方法：生成中间视角、自然语言推理链和认知地图。最佳方法是“map-then-reason”联合训练。

Result: 通过“map-then-reason”方法，准确率从37.8%提升至60.8%，结合强化学习后达到70.7%。

Conclusion: 构建和利用内部结构化空间表示的空间心理模型支架，显著提升了VLMs对不可观测空间的理解能力。
...
<details>
  <summary>Details</summary>
Motivation: 解决AI代理与人类无缝协调的挑战，尤其是Hanabi游戏中人类评估的困难。

Method: 开发人类代理代理，使用大规模人类数据集作为评估伙伴，并开源有限数据集以鼓励数据高效方法。

Result: 提供了两玩家和三玩家Hanabi场景的基线结果，并通过受控评估系统确保公平性。
...
TL;DR: 论文介绍了Mind2Web 2基准测试，用于评估复杂、长周期的代理搜索系统，并提出了一种新的Agent-as-a-Judge评估框架。
...
Method: 构建了130个高质量、长周期的任务，并设计了基于树状结构的Agent-as-a-Judge框架进行自动评估。
...
TL;DR: PsyLite是一个轻量级心理咨询大语言模型，基于InternLM2.5-7B-chat开发，通过两阶段训练策略提升推理、咨询和对话安全能力，并在低资源环境下高效部署。
...
TL;DR: 论文探讨了AI安全的重要性，提出了构建可信生态系统的框架，并通过国际会议和报告明确了AI安全研究的三个关键领域。


<details>
  <summary>Details</summary>
Motivation: 随着AI能力的快速提升和自主性增强，确保AI的安全性（可信、可靠、安全）成为关键议题，需要建立可信的生态系统以促进创新并避免负面影响。

Method: 通过2025年新加坡AI安全会议（SCAI）和国际AI安全报告，汇集全球AI科学家，采用深度防御模型，将AI安全研究分为开发、评估和控制三个领域。

Result: 报告明确了AI安全研究的三大挑战：开发可信AI系统、评估风险以及部署后的监控与干预。

Conclusion: 构建可信的AI生态系统是确保AI安全的关键，需要国际合作和多层次的研究框架。
...
### [15] [MAGPIE: A dataset for Multi-AGent contextual PrIvacy Evaluation](https://arxiv.org/abs/2506.20737)
*Gurusha Juneja,Alon Albalak,Wenyue Hua,William Yang Wang*

Main category: cs.AI

TL;DR: 论文研究了LLM代理在协作任务中是否理解上下文隐私，并评估了其在多轮对话中保护隐私的能力。结果显示当前模型（如GPT-4o和Claude-2.7-Sonnet）在隐私分类和多轮对话中表现不佳。


<details>
  <summary>Details</summary>
Motivation: 随着LLM代理的广泛应用，隐私保护在多代理协作任务中变得至关重要。现有基准测试仅针对单轮简单任务，无法评估复杂场景下的隐私保护能力。

Method: 提出了MAGPIE基准测试，包含158个高风险场景，评估LLM代理对上下文隐私的理解和协作能力。

Result: 当前模型在隐私分类和多轮对话中表现不佳，错误率高且任务完成率低。

Conclusion: 现有模型在上下文隐私保护和协作任务解决方面尚未达到理想水平。
...
### [16] [Dynamic Context-Aware Prompt Recommendation for Domain-Specific AI Applications](https://arxiv.org/abs/2506.20815)
*Xinye Tang,Haijun Zhai,Chaitanya Belwal,Vineeth Thayanithi,Philip Baumann,Yogesh K Roy*
...
<details>
  <summary>Details</summary>
Motivation: 解决领域特定应用中用户提示质量不稳定的问题，提升提示的相关性和实用性。

Method: 结合上下文查询分析、检索增强知识基础、分层技能组织和自适应技能排名，利用行为遥测和两阶段分层推理动态生成提示。

Result: 在真实数据集上验证了方法的高实用性和相关性，得到自动化和专家评估的认可。

Conclusion: 该系统能有效提升领域特定应用中提示的质量和用户体验。
...
### [17] [Beyond Reactive Safety: Risk-Aware LLM Alignment via Long-Horizon Simulation](https://arxiv.org/abs/2506.20949)
*Chenkai Sun,Denghui Zhang,ChengXiang Zhai,Heng Ji*
...
<details>
  <summary>Details</summary>
Motivation: 随着语言模型在高风险社会决策中的影响力增加，需要确保其建议的积极影响，并理解其潜在深远影响。

Method: 提出了一个概念验证框架，用于模拟模型生成建议在社会系统中的宏观传播，并引入了一个包含100个间接危害场景的数据集。
...
### [18] [Unveiling Causal Reasoning in Large Language Models: Reality or Mirage?](https://arxiv.org/abs/2506.21215)
*Haoang Chi,He Li,Wenjing Yang,Feng Liu,Long Lan,Xiaoguang Ren,Tongliang Liu,Bo Han*

Main category: cs.AI

TL;DR: 论文探讨了大型语言模型（LLMs）的因果推理能力，指出其仅能进行浅层（level-1）推理，缺乏人类深度（level-2）推理能力，并提出G^2-Reasoner方法以提升LLMs的因果推理能力。


<details>
  <summary>Details</summary>
Motivation: 研究LLMs是否具备类似人类的真实因果推理能力，发现其仅能进行浅层推理，需改进以接近人类水平。

Method: 通过分析LLMs的自回归机制，提出CausalProbe-2024基准测试，并设计G^2-Reasoner方法，结合通用知识和目标导向提示。

Result: LLMs在CausalProbe-2024上表现显著下降，而G^2-Reasoner显著提升了其在新鲜和反事实情境中的推理能力。

Conclusion: G^2-Reasoner为LLMs迈向深度因果推理提供了新路径，超越浅层推理，接近人类水平。
...
### [19] [World-aware Planning Narratives Enhance Large Vision-Language Model Planner](https://arxiv.org/abs/2506.21230)
*Junhao Shi,Zhaoye Fei,Siyin Wang,Qipeng Guo,Jingjing Gong,Xipeng QIu*
...
<details>
  <summary>Details</summary>
Motivation: 现有LVLMs在复杂场景中表现不佳，缺乏环境感知能力，依赖额外线索而非视觉推理。

Method: WAP框架通过视觉外观建模、空间推理、功能抽象和语法接地四种能力，结合课程学习，提升模型性能。

Result: 在EB-ALFRED基准测试中，任务成功率提升60.7，常识推理和长时规划分别提升60.0和70.0。

Conclusion: WAP显著优于现有专有系统，证明了环境感知对LVLMs的重要性。
...
### [20] [IXAII: An Interactive Explainable Artificial Intelligence Interface for Decision Support Systems](https://arxiv.org/abs/2506.21310)
*Pauline Speckmann,Mario Nadj,Christian Janiesch*
...
Conclusion: IXAII通过结合交互性和多方法解释，为AI解释实践和人机交互提供了新视角。
...
### [21] [Active Inference AI Systems for Scientific Discovery](https://arxiv.org/abs/2506.21329)
*Karthik Duraisamy*

Main category: cs.AI

TL;DR: 论文提出了一种主动推理AI系统，旨在通过填补抽象、推理和现实三个关键缺口，推动AI驱动的科学发展。


<details>
  <summary>Details</summary>
Motivation: 当前AI系统在科学发现中存在局限性，如脆弱的推理机制和脱离实验现实，因此需要改进架构以支持更有效的科学推理。

Method: 提出主动推理AI系统，结合因果自监督基础模型、贝叶斯保护的符号或神经符号规划器、持久知识图谱，并通过闭环交互优化内部表征。

Result: 该系统通过内部模型与外部验证的互动实现科学发现，同时强调人类判断在不确定性和模糊反馈中的不可或缺作用。

Conclusion: 论文认为，科学发现的未来依赖于结合AI与人类判断的主动推理系统，而非单纯依赖模型规模或计算资源。
...
### [22] [TableMoE: Neuro-Symbolic Routing for Structured Expert Reasoning in Multimodal Table Understanding](https://arxiv.org/abs/2506.21393)
*Junwen Zhang,Pu Chen,Yin Zhang*

Main category: cs.AI

TL;DR: 论文提出TableMoE，一种神经符号混合专家架构，用于处理复杂多模态表格数据，显著优于现有模型。


<details>
  <summary>Details</summary>
Motivation: 现有多模态大语言模型在真实世界复杂表格（如模糊、倾斜、嵌套布局等）中表现不佳，需改进。

Method: 提出TableMoE架构，采用神经符号路由机制和专家动态分配策略，并引入大规模预训练数据集TableMoE-Align。

Result: TableMoE在WildStruct基准测试中显著优于现有模型，验证了神经符号路由和专家对齐的关键作用。

Conclusion: TableMoE通过神经符号推理有效提升多模态表格理解的鲁棒性和可解释性。
...
### [23] [Spatial Mental Modeling from Limited Views](https://arxiv.org/abs/2506.21458)
*Baiqiao Yin,Qineng Wang,Pingyue Zhang,Jianshu Zhang,Kangrui Wang,Zihan Wang,Jieyu Zhang,Keshigeyan Chandrasegaran,Han Liu,Ranjay Krishna,Saining Xie,Manling Li,Jiajun Wu,Li Fei-Fei*
...
<details>
  <summary>Details</summary>
Motivation: 探索视觉语言模型是否能像人类一样从少量视角构建完整场景的空间心理模型。

Method: 使用MindCube基准测试评估VLMs的空间心理模型能力，并提出三种方法（中间视图、自然语言推理链、认知地图），最终采用“map-then-reason”联合训练方法。

Result: 通过“map-then-reason”方法，准确率从37.8%提升至60.8%，结合强化学习后达到70.7%。

Conclusion: 构建和利用内部结构化空间表示的空间心理模型支架显著提升了对不可见空间的理解。
...
### [24] [Ad-Hoc Human-AI Coordination Challenge](https://arxiv.org/abs/2506.21490)
*Tin Dizdarević,Ravi Hammond,Tobias Gessler,Anisoara Calinescu,Jonathan Cook,Matteo Gallici,Andrei Lupu,Jakob Nicolaus Foerster*

Main category: cs.AI

TL;DR: 论文提出AH2AC2挑战，通过人类代理解决Hanabi游戏中人机协作评估的高成本和不可重复性问题，并开源数据集和基线结果。


<details>
  <summary>Details</summary>
Motivation: 解决人机协作中评估成本高和不可重复的问题，推动数据高效方法的发展。

Method: 开发人类代理作为评估伙伴，开源有限的人类游戏数据集，提供两到三人Hanabi场景的基线结果。

Result: 建立了低成本、可重复的人类代理评估系统，并开源了3,079局游戏数据集。

Conclusion: AH2AC2挑战为研究人机协作提供了实用且可扩展的评估框架。
...
### [25] [Mind2Web 2: Evaluating Agentic Search with Agent-as-a-Judge](https://arxiv.org/abs/2506.21506)
*Boyu Gou,Zanming Huang,Yuting Ning,Yu Gu,Michael Lin,Weijian Qi,Andrei Kopanev,Botao Yu,Bernal Jiménez Gutiérrez,Yiheng Shu,Chan Hee Song,Jiaman Wu,Shijie Chen,Hanane Nour Moussa,Tianshu Zhang,Jian Xie,Yifei Li,Tianci Xue,Zeyi Liao,Kai Zhang,Boyuan Zheng,Zhaowei Cai,Viktor Rozgic,Morteza Ziyadi,Huan Sun,Yu Su*

Main category: cs.AI

TL;DR: Mind2Web 2是一个包含130个长时程任务的基准测试，用于评估自主网络搜索系统的性能，并提出了一种基于树形结构的Agent-as-a-Judge评估框架。
...
Method: 构建Mind2Web 2基准测试，提出Agent-as-a-Judge框架，通过任务特定的评判代理自动评估答案正确性和来源标注。
...
### [26] [PsyLite Technical Report](https://arxiv.org/abs/2506.21536)
*Fangjun Ding,Renyu Zhang,Xinyu Feng,Chengye Xie,Zheng Zhang,Yanting Zhang*

Main category: cs.AI

TL;DR: PsyLite是一个基于InternLM2.5-7B-chat开发的轻量级心理咨询大语言模型，通过两阶段训练策略提升推理能力、心理咨询能力和对话安全性，并在资源受限环境中实现高效部署。


<details>
  <summary>Details</summary>
Motivation: 现有AI心理咨询模型在对话安全、场景处理轻量部署方面存在不足，PsyLite旨在解决这些问题。
...
### [27] [OTSurv: A Novel Multiple Instance Learning Framework for Survival Prediction with Heterogeneity-aware Optimal Transport](https://arxiv.org/abs/2506.20741)
*Qin Ren,Yifan Wang,Ruogu Fang,Haibin Ling,Chenyu You*

Main category: cs.CV

TL;DR: OTSurv是一种基于最优传输（OT）的多实例学习框架，用于从全切片图像（WSIs）预测生存率，通过全局和局部约束显式建模病理异质性，显著提升了预测性能。
...
Method: OTSurv将生存预测建模为带约束的OT问题，包括全局长尾约束和局部不确定性约束，并通过不平衡OT公式高效求解。

Result: 在六个基准测试中，OTSurv的平均C-index绝对提升3.6%，且在统计显著性测试中表现优异。

Conclusion: OTSurv通过OT框架显式建模病理异质性，显著提升了生存预测性能，并具有高可解释性。
...
### [28] [StereoDiff: Stereo-Diffusion Synergy for Video Depth Estimation](https://arxiv.org/abs/2506.20756)
*Haodong Li,Chen Wang,Jiahui Lei,Kostas Daniilidis,Lingjie Liu*

Main category: cs.CV

TL;DR: StereoDiff结合立体匹配和视频深度扩散，分别处理视频中的静态和动态区域，显著提升了视频深度估计的一致性和准确性。


<details>
  <summary>Details</summary>
Motivation: 视频深度估计不能简单扩展图像深度估计方法，因为静态和动态区域的时序一致性需求不同。静态区域更适合通过立体匹配获取全局3D线索，而动态区域则需要从大规模视频数据中学习。

Method: 提出两阶段视频深度估计器StereoDiff，第一阶段利用立体匹配处理静态区域，第二阶段通过视频深度扩散模型处理动态区域。通过频域分析证明两者的互补性。

Result: 在零样本、真实世界动态视频深度基准测试中，StereoDiff表现出最先进的性能，一致性和准确性显著优于现有方法。

Conclusion: StereoDiff通过结合立体匹配和视频深度扩散，为视频深度估计提供了一种更有效的方法，特别适用于静态和动态区域的协同处理。
...
### [29] [ConViTac: Aligning Visual-Tactile Fusion with Contrastive Representations](https://arxiv.org/abs/2506.20757)
...
Method: 提出ConViTac网络，利用对比嵌入条件（CEC）机制，通过自监督对比学习预训练的编码器将视觉和触觉输入投影到统一的潜在嵌入中，并通过跨模态注意力进行特征融合。

Result: 实验表明，ConViTac在材料分类和抓取预测任务中比现有方法性能更优，准确率提升高达12.0%。

Conclusion: ConViTac通过对比表征和跨模态注意力机制，有效提升了视觉-触觉特征融合的效果，为机器人感知任务提供了新的解决方案。
...
### [30] [AI-Driven MRI-based Brain Tumour Segmentation Benchmarking](https://arxiv.org/abs/2506.20786)
*Connor Ludwig,Khashayar Namdar,Farzad Khalvati*

Main category: cs.CV

TL;DR: 该研究评估了多种可提示模型（如SAM、SAM 2、MedSAM等）在医学图像分割中的表现，发现SAM和SAM 2在精确边界框提示下表现优异，但nnU-Net仍是主导模型。


<details>
  <summary>Details</summary>
Motivation: 缺乏对不同可提示模型在医学数据集上的评估与比较，尤其是在不同提示质量下的表现。

Method: 使用SAM、SAM 2、MedSAM、SAM-Med-3D和nnU-Net在BraTS 2023数据集上进行零样本推理，并比较不同提示质量下的表现。还对部分模型进行了微调。

Result: SAM和SAM 2在精确边界框提示下Dice分数高达0.894和0.893，优于nnU-Net，但nnU-Net仍是主导模型。微调后点提示性能显著提升，但仍不及边界框提示或nnU-Net。

Conclusion: 可提示模型在精确提示下表现优异，但nnU-Net仍是医学图像分割的首选。微调显示未来潜力，但需进一步研究。
...
### [31] [How do Foundation Models Compare to Skeleton-Based Approaches for Gesture Recognition in Human-Robot Interaction?](https://arxiv.org/abs/2506.20795)
*Stephanie Käs,Anton Burenko,Louis Markert,Onur Alp Culha,Dennis Mack,Timm Linder,Bastian Leibe*

Main category: cs.CV

TL;DR: 研究比较了V-JEPA、Gemini Flash 2.0和HD-GCN在动态全身手势识别中的表现，发现HD-GCN表现最佳，但V-JEPA接近且简化了系统复杂度。Gemini在零样本设置中表现不佳。
...
Method: 比较V-JEPA、Gemini Flash 2.0和HD-GCN在NUGGET数据集上的表现，评估其手势识别能力。

Result: HD-GCN表现最佳，V-JEPA接近且简化系统复杂度，Gemini在零样本设置中表现不佳。

Conclusion: V-JEPA有望作为共享多任务模型减少系统复杂度，但需进一步研究Gemini的输入表示。
...
### [32] [Leveraging Vision-Language Models to Select Trustworthy Super-Resolution Samples Generated by Diffusion Models](https://arxiv.org/abs/2506.20832)
*Cansu Korkmaz,Ahmet Murat Tekalp,Zafer Dogan*

Main category: cs.CV

TL;DR: 本文提出了一种基于视觉语言模型（VLM）的自动化框架，用于从扩散模型生成的高分辨率图像中选择最可信的样本，并通过一种新的可信度评分（TWS）验证其有效性。


<details>
  <summary>Details</summary>
Motivation: 超分辨率（SR）问题存在多个可行解，传统方法在保真度和感知质量之间难以平衡，而扩散模型生成的多样解中缺乏可信度评估机制。
...
Conclusion: 该方法为生成式SR提供了可扩展、通用的可信度评估框架，为领域设定了新标准。
...
### [33] [FixCLR: Negative-Class Contrastive Learning for Semi-Supervised Domain Generalization](https://arxiv.org/abs/2506.20841)
*Ha Min Son,Shahbaz Rezaei,Xin Liu*

Main category: cs.CV

TL;DR: FixCLR是一种半监督领域泛化（SSDG）方法，通过对比学习显式正则化领域不变表示，结合伪标签类别信息，提升性能。


<details>
  <summary>Details</summary>
Motivation: 解决领域泛化中标签稀缺导致性能下降的问题，现有方法未显式正则化领域不变表示。

Method: 引入FixCLR，结合对比学习和伪标签类别信息，仅使用排斥项进行正则化。

Result: FixCLR显著提升SSDG性能，尤其在与其他半监督方法结合时表现更佳。

Conclusion: FixCLR是一种有效的SSDG方法，适用于多领域数据集，并可与其他方法互补。
...
### [34] [Vector Contrastive Learning For Pixel-Wise Pretraining In Medical Vision](https://arxiv.org/abs/2506.20850)
*Yuting He,Shuo Li*
...
Method: 提出向量对比学习（vector CL），将其重新表述为向量回归问题，并通过COVER框架实现，包括向量自学习、优化流程和向量金字塔架构。
...
### [35] [Enhancing Ambiguous Dynamic Facial Expression Recognition with Soft Label-based Data Augmentation](https://arxiv.org/abs/2506.20867)
*Ryosuke Kawamura,Hideaki Hayashi,Shunsuke Otake,Noriko Takemura,Hajime Nagahara*

Main category: cs.CV

TL;DR: MIDAS是一种数据增强方法，通过结合视频帧和软标签来提升动态面部表情识别（DFER）的性能，特别是在处理模糊表情时表现优异。
...
Method: 提出MIDAS方法，通过凸组合视频帧和软标签来增强训练数据，扩展了mixup方法的应用。

Result: 在DFEW和FERV39k-Plus数据集上，MIDAS训练模型表现优于现有方法。

Conclusion: MIDAS是一种简单高效的数据增强方法，显著提升了DFER的性能。
...
### [36] [THIRDEYE: Cue-Aware Monocular Depth Estimation via Brain-Inspired Multi-Stage Fusion](https://arxiv.org/abs/2506.20877)
*Calin Teodor Ioan*

Main category: cs.CV

TL;DR: ThirdEye是一种单目深度估计方法，通过预训练和冻结的专家网络提供显式视觉线索，结合三阶段皮层层次结构和工作记忆模块，生成高分辨率视差图。


<details>
  <summary>Details</summary>
Motivation: 传统单目深度估计方法忽略了人类视觉系统依赖的显式线索（如遮挡边界、阴影和透视），ThirdEye旨在通过专门设计的网络模块显式利用这些线索。

Method: ThirdEye采用预训练和冻结的专家网络提供视觉线索，通过三阶段皮层层次结构（V1->V2->V3）和工作记忆模块融合线索，并使用自适应分箱变换器生成视差图。

Result: ThirdEye继承了大量外部监督，仅需少量微调，能够生成高分辨率视差图。

Conclusion: ThirdEye通过显式利用视觉线索和模块化设计，提升了单目深度估计的性能和效率。
...
### [37] [MultiHuman-Testbench: Benchmarking Image Generation for Multiple Humans](https://arxiv.org/abs/2506.20879)
...
Method: 构建包含多样化文本提示和人脸图像的基准，提出基于人脸计数、ID相似性、提示对齐和动作检测的评估指标，并引入图像分割和匈牙利匹配技术。

Result: 通过评估多种模型，发现提出的技术显著提高了ID相似性，并提供了标准化工具。

Conclusion: MultiHuman-Testbench为多人生成图像研究提供了有价值的见解和标准化工具。
...
### [38] [The Role of Cyclopean-Eye in Stereo Vision](https://arxiv.org/abs/2506.20900)
*Sherlon Almeida da Silva,Davi Geiger,Luiz Velho,Moacir Antonelli Ponti*

Main category: cs.CV

TL;DR: 论文研究了现代立体视觉系统的几何基础，结合3D结构和人类感知改进深度重建，提出新几何约束并评估深度学习特征匹配。


<details>
  <summary>Details</summary>
Motivation: 探索立体视觉系统的几何基础，结合人类感知和3D结构提升深度重建的准确性。

Method: 重新审视Cyclopean Eye模型，提出新几何约束，评估深度学习特征匹配及注意力机制的作用。
...
### [39] [FaSTA$^*$: Fast-Slow Toolpath Agent with Subroutine Mining for Efficient Multi-turn Image Editing](https://arxiv.org/abs/2506.20911)
...
<details>
  <summary>Details</summary>
Motivation: 解决多轮图像编辑任务中高成本和低效率的问题，结合LLM的快速规划和A$^*$搜索的精确性。

Method: 结合LLM的快速高级规划和A$^*$搜索的低级工具调用，通过归纳推理复用成功子程序，形成自适应快慢规划策略。

Result: FaSTA$^*$在计算效率上显著优于现有方法，同时保持与最先进基线相当的成功率。

Conclusion: FaSTA$^*$通过快慢规划和子程序复用，实现了高效且成本低廉的图像编辑解决方案。
...
### [40] [M2SFormer: Multi-Spectral and Multi-Scale Attention with Edge-Aware Difficulty Guidance for Image Forgery Localization](https://arxiv.org/abs/2506.20922)
...
<details>
  <summary>Details</summary>
Motivation: 当前深度学习方法在像素级伪造定位中面临计算开销大和表征能力有限的问题，尤其是对复杂或细微篡改的处理不足。

Method: 提出M2SFormer框架，通过多频率和多尺度注意力机制统一处理空间和频率线索，并利用全局先验图和难度引导注意力模块保留细微篡改。

Result: 在多个基准数据集上的实验表明，M2SFormer优于现有最先进模型，具有更强的跨领域伪造检测和定位能力。

Conclusion: M2SFormer通过创新设计解决了现有方法的局限性，为图像伪造定位提供了更高效和准确的解决方案。
...
### [41] [PhysRig: Differentiable Physics-Based Skinning and Rigging Framework for Realistic Articulated Object Modeling](https://arxiv.org/abs/2506.20936)
...
### [42] [AIR-VIEW: The Aviation Image Repository for Visibility Estimation of Weather, A Dataset and Benchmark](https://arxiv.org/abs/2506.20939)
...
Result: 新数据集填补了现有空白，基准测试结果显示其有效性，并与ASTM标准进行了对比。

Conclusion: 该数据集为航空天气能见度估计提供了重要资源，推动了机器学习在该领域的应用。
...
### [43] [Hierarchical Sub-action Tree for Continuous Sign Language Recognition](https://arxiv.org/abs/2506.20947)
*Dejie Yang,Zhu Xu,Xinjie Gao,Yang Liu*

Main category: cs.CV

TL;DR: 提出了一种名为HST-CSLR的方法，通过构建层次子动作树（HST）结合视觉和文本模态，提升连续手语识别（CSLR）的性能。


<details>
  <summary>Details</summary>
Motivation: 解决CSLR中因缺乏大规模数据集和精确标注导致的训练数据不足问题，并更有效地利用文本知识。

Method: 构建HST表示文本信息，逐步对齐视觉和文本模态，并通过对比对齐增强减少模态差异。
...
### [44] [OmniEval: A Benchmark for Evaluating Omni-modal Models with Visual, Auditory, and Textual Inputs](https://arxiv.org/abs/2506.20960)
...
<details>
  <summary>Details</summary>
Motivation: 现有基准未能充分评估全模态模型的协作能力，因此设计OmniEval以填补这一空白。

Method: 设计了包含810个音视频同步视频和2617个问答对的基准，涵盖3大类任务和12个子任务，并引入更细粒度的视频定位任务。

Result: 实验验证了OmniEval的全面性，为评估全模态模型的上下文理解和构建能力提供了平台。

Conclusion: OmniEval为全模态模型的评估提供了新标准，代码和数据已开源。
...
### [45] [Evidence-based diagnostic reasoning with multi-agent copilot for human pathology](https://arxiv.org/abs/2506.20964)
...
TL;DR: PathChat+是一种专为病理学设计的新型多模态大语言模型，通过整合自然语言指令和文本上下文，解决了现有模型的局限性，并在多个病理学基准测试中表现优异。


<details>
  <summary>Details</summary>
Motivation: 传统病理学模型缺乏对自然语言指令和文本上下文的整合，且现有多模态大语言模型在病理学领域存在数据不足、多图像理解支持不足等问题。

Method: 开发了PathChat+，基于超过100万病理学特定指令样本和550万问答对进行训练，并引入SlideSeek系统，通过迭代分层诊断推理自主评估全切片图像。

Result: PathChat+在多个病理学基准测试中显著优于现有模型，SlideSeek系统在开放诊断基准测试中达到高准确率，并能生成可视化报告。

Conclusion: PathChat+和SlideSeek系统为病理学的数字化和智能化提供了有效工具，展示了多模态模型在医学领域的潜力。
...
### [46] [DFVEdit: Conditional Delta Flow Vector for Zero-shot Video Editing](https://arxiv.org/abs/2506.20967)
*Lingling Cai,Kang Zhao,Hangjie Yuan,Xiang Wang,Yingya Zhang,Kejie Huang*

Main category: cs.CV

TL;DR: DFVEdit是一种高效的零样本视频编辑方法，专为视频扩散变换器（Video DiTs）设计，无需注意力修改或微调，通过流变换直接操作潜在空间，显著提升计算效率和编辑质量。


<details>
  <summary>Details</summary>
Motivation: 现有视频编辑方法在Video DiTs上计算开销大，因注意力修改或微调资源密集，亟需高效解决方案。

Method: 提出DFVEdit，基于连续流视角统一编辑与采样，引入条件Delta流向量（CDFV），结合隐式交叉注意力（ICA）和嵌入强化（ER）提升质量。

Result: DFVEdit在Video DiTs上实现至少20倍推理加速和85%内存节省，在结构保真度、时空一致性和编辑质量上达到SOTA。

Conclusion: DFVEdit为Video DiTs提供高效、高质量的零样本编辑方案，具有广泛适用性和显著性能优势。
...
### [47] [From Cradle to Cane: A Two-Pass Framework for High-Fidelity Lifespan Face Aging](https://arxiv.org/abs/2506.20977)
*Tao Liu,Dafeng Zhang,Gengchen Li,Shizhuo Liu,Yongqi Song,Senmao Li,Shiqi Yang,Boqian Li,Kai Wang,Yaxing Wang*

Main category: cs.CV

TL;DR: Cradle2Cane是一个基于扩散模型的两阶段人脸老化框架，通过自适应噪声注入和身份感知嵌入解决了年龄准确性和身份保留的权衡问题。


<details>
  <summary>Details</summary>
Motivation: 现有的人脸老化方法在年龄准确性和身份保留之间存在权衡问题，难以实现真实且无缝的老化效果。

Method: 提出两阶段框架：第一阶段通过自适应噪声注入（AdaNI）实现年龄准确性；第二阶段通过身份感知嵌入（IDEmb）增强身份保留。

Result: 在CelebA-HQ数据集上，Cradle2Cane在年龄准确性和身份一致性上优于现有方法。

Conclusion: Cradle2Cane有效解决了人脸老化中的Age-ID权衡问题，实现了更优的老化效果。
...
TL;DR: PathSegmentor是一种基于文本提示的病理图像分割基础模型，利用PathSeg数据集（最大、最全面的病理分割数据集），显著提升了分割精度和适用性。
...
Method: 提出PathSegmentor模型和PathSeg数据集，支持自然语言提示的分割任务。
...
### [49] [3D Scene-Camera Representation with Joint Camera Photometric Optimization](https://arxiv.org/abs/2506.20979)
...
<details>
  <summary>Details</summary>
Motivation: 相机成像中的光度失真会降低图像质量，进而影响3D场景表示，需要一种方法分离这些失真。

Method: 结合内外光度模型，提出完整的光度模型和相机表示，并通过优化参数和深度正则化分离无关信息。

Result: 实验表明，该方法在成像退化条件下（如暗角和污垢）仍能生成高质量的3D场景表示。

Conclusion: 该方法通过联合优化相机光度参数和场景表示，显著提升了3D场景重建的质量。
...
### [50] [Multimodal Prompt Alignment for Facial Expression Recognition](https://arxiv.org/abs/2506.21017)
...
<details>
  <summary>Details</summary>
Motivation: 当前基于视觉语言模型的面部表情识别方法难以捕捉细粒度的文本-视觉关系，影响了对细微表情差异的区分。

Method: 结合多粒度硬提示生成策略（利用LLM生成详细描述）和原型引导的视觉特征对齐，同时引入跨模态全局-局部对齐模块。

Result: 在三个FER基准数据集上表现优于现有方法，同时保持了预训练模型的优势并降低了计算成本。

Conclusion: MPA-FER框架通过细粒度语义引导和跨模态对齐，显著提升了面部表情识别的准确性和可解释性。
...
### [51] [Rethink Sparse Signals for Pose-guided Text-to-image Generation](https://arxiv.org/abs/2506.20983)
...
<details>
  <summary>Details</summary>
Motivation: 密集信号在姿态引导的图像生成中虽然提供了详细的空间指导，但带来了编辑困难和与文本提示不一致的挑战。稀疏信号因其简单性和形状无关性，成为值得重新探索的替代方案。

Method: 论文扩展了OpenPose为可学习的空间表示，使关键点嵌入更具区分性和表现力；同时引入关键点概念学习，增强关键点令牌对空间位置的注意力，从而改善姿态对齐。

Result: 在动物和人类为中心的图像生成任务中，SP-Ctrl在稀疏姿态引导下优于现有方法，甚至与基于密集信号的方法性能相当，并展示了跨物种生成的潜力。

Conclusion: 稀疏信号在姿态引导的图像生成中具有潜力，SP-Ctrl通过改进稀疏信号的可控性，为未来研究提供了新方向。
...
### [52] [Improving Diffusion-Based Image Editing Faithfulness via Guidance and Scheduling](https://arxiv.org/abs/2506.21045)
*Hansam Cho,Seoung Bum Kim*

Main category: cs.CV

TL;DR: 提出FGS方法，通过忠实性指导和调度策略，在图像编辑中平衡可编辑性和忠实性。
...
Method: 引入忠实性指导以增强输入图像信息的保留，并提出调度策略解决可编辑性与忠实性的不对齐。

Result: 实验表明FGS在保持可编辑性的同时显著提升忠实性，且兼容多种编辑方法。

Conclusion: FGS是一种有效的解决方案，适用于多样化的高质量图像编辑任务。
...
### [53] [EVA: Mixture-of-Experts Semantic Variant Alignment for Compositional Zero-Shot Learning](https://arxiv.org/abs/2506.20986)
*Xiao Zhang,Yongqiang Ma,Haodong Jing,Nanning Zheng*

Main category: cs.CV

TL;DR: 论文提出了一种名为EVA的混合专家语义变体对齐框架，用于改进组合零样本学习（CZSL），通过多专家学习和语义变体对齐显著提升了性能。


<details>
  <summary>Details</summary>
Motivation: 现有CZSL方法通过简单的组合-原型映射提取特征，忽略了语义子集的区分性和组合差异，导致图像-组合对齐不精细。

Method: 提出EVA框架，采用多专家领域适应实现令牌感知学习，并通过语义变体对齐选择语义相关表示进行图像-原语匹配。

Result: 在三个流行基准测试中，EVA在封闭和开放世界设置下均显著优于其他最先进的CZSL方法。

Conclusion: EVA通过多专家学习和语义对齐有效提升了组合零样本学习的性能，证明了其方法的有效性。
...
### [54] [EgoAdapt: Adaptive Multisensory Distillation and Policy Learning for Efficient Egocentric Perception](https://arxiv.org/abs/2506.21080)
...
Result: 在三个数据集上测试，计算量减少89.09%，参数减少82.02%，能耗降低9.6倍，性能仍优于或持平现有模型。
...
<details>
  <summary>Details</summary>
Motivation: 现有VideoLLMs在多镜头场景（如不同摄像机角度或场景变化）中表现不佳，存在实例身份遗忘和关键帧忽略的问题。
...
### [56] [TSDASeg: A Two-Stage Model with Direct Alignment for Interactive Point Cloud Segmentation](https://arxiv.org/abs/2506.20991)
*Chade Li,Pengju Zhang,Yihong Wu*

Main category: cs.CV

TL;DR: 提出TSDASeg模型，通过直接跨模态对齐和记忆模块解决3D点云分割中3D-文本对齐不足的问题，实现交互式分割。


<details>
  <summary>Details</summary>
Motivation: 现有3D视觉语言模型在点级任务（如分割）中表现不佳，主要因缺乏直接的3D-文本对齐，无法将局部3D特征与文本上下文关联。

Method: TSDASeg采用两阶段模型，结合直接跨模态对齐模块和记忆模块。记忆模块通过专用内存库存储文本、视觉特征及其跨模态映射，并利用自注意力和跨注意力机制动态更新场景特征。

Result: 在多个3D指令、参考和语义分割数据集上，TSDASeg实现了最先进的性能。

Conclusion: TSDASeg通过直接跨模态对齐和动态记忆模块，显著提升了交互式点云分割的效果。
...
### [57] [Robust Deep Learning for Myocardial Scar Segmentation in Cardiac MRI with Noisy Labels](https://arxiv.org/abs/2506.21151)
*Aida Moafi,Danial Moafi,Evgeny M. Mirkes,Gerry P. McCann,Abbas S. Alatrany,Jayanth R. Arnold,Mostafa Mehdipour Ghazi*

Main category: cs.CV

TL;DR: 提出了一种基于深度学习的自动化心肌瘢痕分割方法，通过优化模型和损失函数解决了标签噪声和数据异质性等问题，性能优于现有技术。
...
Method: 通过微调前沿模型，使用Kullback-Leibler损失和大量数据增强，解决标签噪声、数据异质性和类别不平衡问题。

Result: 模型在急性和慢性病例中表现优异，优于nnU-Net等现有技术，并在分布外测试集上展现出强泛化能力。
...
Conclusion: 该方法在视频到音频生成中表现出色，为复合音频合成提供了高质量解决方案。
...
### [59] [Task-Aware KV Compression For Cost-Effective Long Video Understanding](https://arxiv.org/abs/2506.21184)
...
<details>
  <summary>Details</summary>
Motivation: 长视频理解（LVU）因计算成本高而难以实现，现有KV压缩方法在高压缩比下信息损失严重。

Method: 提出Video-X^2L，包含双级KV压缩（生成低压缩和高压缩KV）和选择性KV重加载（解码阶段动态选择KV）。

Result: 在多个LVU基准测试中表现优异，显著节省计算成本。

Conclusion: Video-X^2L无需额外训练，兼容现有MLLMs，是高效解决LVU问题的有效方法。
...
### [60] [DBMovi-GS: Dynamic View Synthesis from Blurry Monocular Video via Sparse-Controlled Gaussian Splatting](https://arxiv.org/abs/2506.20998)
...
<details>
  <summary>Details</summary>
Motivation: 现有新视角合成方法依赖高分辨率图像或静态几何假设，无法有效处理动态物体和相机运动导致的模糊问题。
...
### [61] [BitMark for Infinity: Watermarking Bitwise Autoregressive Image Generative Models](https://arxiv.org/abs/2506.21209)
*Louis Kerner,Michel Meintz,Bihe Zhao,Franziska Boenisch,Adam Dziedzic*

Main category: cs.CV

TL;DR: 本文介绍了BitMark，一种用于Infinity文本到图像模型的鲁棒位级水印框架，旨在防止模型崩溃。
...
Result: BitMark具有高放射性，即使用水印生成图像训练的其他生成模型也会携带水印，且即使在微调扩散或自回归模型后仍可检测到。

Conclusion: BitMark为图像生成模型提供了一种可靠的方法，通过检测生成输出来防止模型崩溃。
...
### [62] [Style-Aligned Image Composition for Robust Detection of Abnormal Cells in Cytopathology](https://arxiv.org/abs/2506.21001)
...
Method: 通过属性指导选择异常细胞，结合高频特征重建实现风格对齐的图像合成，并利用大视觉语言模型筛选高质量合成图像。

Result: 实验表明，SAIC合成的图像显著提升了尾部类别和风格的检测性能与鲁棒性。

Conclusion: SAIC在临床应用场景中具有广泛的通用性和实用性。
...
### [63] [Holistic Surgical Phase Recognition with Hierarchical Input Dependent State Space Models](https://arxiv.org/abs/2506.21330)
...
Conclusion: 该方法通过线性扩展性和分层建模，有效解决了长时手术视频分析的挑战。
...
### [64] [Inverse Scene Text Removal](https://arxiv.org/abs/2506.21002)
*Takumi Yoshimatsu,Shumpei Takezaki,Seiichi Uchida*

Main category: cs.CV

TL;DR: 本文提出逆向场景文本移除（ISTR），用于检测图像是否经过文本移除处理，并定位被移除的文本区域。实验证明任务可行，且能帮助防止滥用和改进文本移除技术。


<details>
  <summary>Details</summary>
Motivation: 场景文本移除（STR）技术可能被滥用，因此需要一种方法检测和定位被移除的文本区域，以防止潜在风险。

Method: 提出逆向STR（ISTR），通过二分类和定位任务检测图像是否经过STR处理，并尝试恢复移除的文本内容。

Result: 实验表明，ISTR在检测和定位任务上具有高准确性，并能部分恢复移除的文本。
...
### [65] [CA-I2P: Channel-Adaptive Registration Network with Global Optimal Selection](https://arxiv.org/abs/2506.21364)
...
### [66] [VisionGuard: Synergistic Framework for Helmet Violation Detection](https://arxiv.org/abs/2506.21005)
...
### [67] [TITAN: Query-Token based Domain Adaptive Adversarial Learning](https://arxiv.org/abs/2506.21484)
...
<details>
  <summary>Details</summary>
Motivation: 在无源数据的情况下，现有方法因伪标签噪声高导致性能下降，需改进伪标签可靠性。

Method: 提出TITAN方法，将目标域图像分为易/难子集，利用检测方差估计分区，并引入查询令牌对抗模块以减少域间差异。

Result: 在多个数据集上验证，TITAN性能优于现有方法，mAP提升显著（最高+22.7%）。

Conclusion: TITAN通过优化伪标签生成和域间对齐，有效解决了无源域自适应目标检测问题。
...
Method: 结合FFCL预训练策略和SAM模型，通过标注SR图像中的恶性、非恶性组织和病理确认边缘，预训练ResNet-18进行边缘状态分类，并生成粗二值掩码以提示SAM进行精细肿瘤边缘分割。

Result: 边缘分类的AUC达到0.8455，Dice相似性比基线模型提高27.4%，推理时间缩短至每张图像47毫秒。
...
### [69] [HalluSegBench: Counterfactual Visual Reasoning for Segmentation Hallucination Evaluation](https://arxiv.org/abs/2506.21546)
*Xinzhuo Li,Adheesh Juvekar,Xingyou Liu,Muntasir Wahed,Kiet A. Nguyen,Ismini Lourentzou*

Main category: cs.CV

TL;DR: HalluSegBench是一个新基准，用于通过反事实视觉推理评估视觉语言分割模型中的幻觉现象，揭示了视觉驱动幻觉的普遍性。
...
Method: 提出HalluSegBench，包含1340对反事实实例和281个对象类，并引入新指标量化视觉编辑下的幻觉敏感性。
...
### [70] [The Aging Multiverse: Generating Condition-Aware Facial Aging Tree via Training-Free Diffusion](https://arxiv.org/abs/2506.21008)
...
### [71] [Whole-Body Conditioned Egocentric Video Prediction](https://arxiv.org/abs/2506.21552)
*Yutong Bai,Danny Tran,Amir Bar,Yann LeCun,Trevor Darrell,Jitendra Malik*

Main category: cs.CV

TL;DR: 训练模型通过人体动作预测第一人称视频（PEVA），结合过去视频和3D身体姿态，模拟人类动作对环境的影响。


<details>
  <summary>Details</summary>
Motivation: 研究如何从第一人称视角模拟人类动作对复杂现实环境的影响，探索视频预测与具身智能的结合。

Method: 使用自回归条件扩散变换器，基于大规模真实世界数据集Nymeria（包含第一人称视频和身体姿态数据），并通过层次化评估协议测试模型能力。

Result: 模型能够从第一人称视角预测视频，模拟人类动作对环境的影响，并通过层次化评估验证其预测和控制能力。

Conclusion: 该研究为从人类视角建模复杂环境和具身行为提供了初步尝试，展示了视频预测在具身智能中的潜力。
...
TL;DR: 论文提出了一种基于局部重建光场和可视化误差的方法，用于减少用户在AR中采集新视角样本时的负担，并扩展了场景探索范围。


<details>
  <summary>Details</summary>
Motivation: 现有方法需要用户通过3D标注对齐AR显示采集新视角样本，任务繁重且场景受限。

Method: 使用局部重建光场和可视化误差，引导用户插入新视角以消除误差。

Result: 误差峰值可视化方法侵入性更低，减少用户失望，且所需样本更少。同时适用于大场景的辐射场重建。

Conclusion: 该方法解放了用户，提升了AR视图合成的效率和适用范围。
...
TL;DR: 论文提出了一种基于评分指令生成（SIG）的自动化流程，用于视频质量评估（VQA），解决了传统方法依赖人工标注和专有系统的问题，并通过Score2Instruct（S2I）数据集和渐进式调优策略提升了视频大型多模态模型（LMMs）的质量评分和解释能力。


<details>
  <summary>Details</summary>
Motivation: 传统VQA方法仅生成数值评分，无法描述视频的复杂质量维度，限制了其应用。通过指令调优的视频LMMs可以解决这一问题，但现有数据生成方法依赖人工标注和专有系统，难以扩展。

Method: 提出SIG流程，自动化生成视频质量指令数据，包括评分映射到文本级别和分层Chain-of-Thought（CoT）建模维度与整体质量的关系。构建S2I数据集和渐进式调优策略。

Result: 实验表明，该方法在S2I-Bench和现有基准测试中显著提升了视频LMMs的质量评分和解释能力。

Conclusion: SIG流程和S2I数据集为视频LMMs的指令调优提供了高效、可扩展的解决方案，推动了视频质量评估的发展。
...
TL;DR: 论文提出FedSC方法，通过语义感知协作解决联邦学习中的数据异构问题，利用关系原型和一致原型优化模型。


<details>
  <summary>Details</summary>
Motivation: 解决联邦学习中因数据异构导致的标签偏好问题，探索利用客户端内部语义信息的方法。

Method: 提出FedSC方法，构建关系原型和一致原型，采用对比学习和差异聚合策略优化模型。

Result: 实验证明FedSC在多种挑战性场景下有效，关键组件高效。

Conclusion: FedSC通过语义级协作成功解决数据异构问题，提供理论收敛保证。
...
TL;DR: 提出了一种经典-量子混合的生成对抗网络（GAN），用于生成彩色医学图像，解决了现有量子方法只能生成低质量灰度图像的问题。


<details>
  <summary>Details</summary>
Motivation: 皮肤疾病数据集的类别不平衡、隐私问题和对象偏差问题使得数据增强至关重要，但传统生成模型计算资源需求高，而现有量子方法生成图像质量低。

Method: 通过一种新颖的经典-量子潜在空间融合技术，开发了首个能够生成彩色医学图像的经典-量子GAN。

Result: 模型在图像生成质量和分类性能提升上优于传统深度卷积GAN和现有混合经典-量子GAN，且参数和训练周期大幅减少。

Conclusion: 量子图像生成在量子硬件进步后前景广阔，模型在真实IBM量子机器上表现稳健。
...
### [76] [LASFNet: A Lightweight Attention-Guided Self-Modulation Feature Fusion Network for Multimodal Object Detection](https://arxiv.org/abs/2506.21018)
...
Method: 引入注意力引导自调制特征融合（ASFF）模块和轻量级特征注意力转换模块（FATM）。
...
### [77] [Instella-T2I: Pushing the Limits of 1D Discrete Latent Space Image Generation](https://arxiv.org/abs/2506.21022)
*Ze Wang,Hao Chen,Benran Hu,Jiang Liu,Ximeng Sun,Jialian Wu,Yusheng Su,Xiaodong Yu,Emad Barsoum,Zicheng Liu*

Main category: cs.CV

TL;DR: 提出了一种基于1D二进制图像潜在空间的紧凑离散图像表示方法，显著减少了高分辨率图像建模所需的token数量，同时保持了细节和效率。
...
Method: 引入1D二进制图像潜在空间，将图像表示为二进制向量序列，替代传统的一热编码token。

Result: 在1024x1024图像上仅需128个离散token，比标准VQ-VAEs减少32倍token数量，训练和推理速度显著提升。

Conclusion: 该方法为图像生成提供了一种高效且可扩展的替代方案，无需私有数据或后训练优化即可达到现代图像生成模型的竞争性能。
...
### [78] [DidSee: Diffusion-Based Depth Completion for Material-Agnostic Robotic Perception and Manipulation](https://arxiv.org/abs/2506.21034)
...
<details>
  <summary>Details</summary>
Motivation: 商用RGB-D相机在非朗伯物体上生成的深度图存在噪声和缺失，传统方法因训练数据有限而泛化能力不足。扩散模型的视觉先验虽有助于提升泛化能力，但训练-推理不匹配和特征缺失问题限制了性能。

Method: 提出DidSee框架：1) 采用零终端信噪比的重缩放噪声调度器；2) 设计噪声无关的单步训练策略；3) 引入语义增强器联合深度补全与语义分割。

Result: 在多个基准测试中达到最优性能，展示了强大的现实泛化能力，并提升了下游任务（如姿态估计和机器人抓取）的效果。
...
### [79] [Boosting Domain Generalized and Adaptive Detection with Diffusion Models: Fitness, Generalization, and Transferability](https://arxiv.org/abs/2506.21042)
...
### [80] [Boosting Generative Adversarial Transferability with Self-supervised Vision Transformer Features](https://arxiv.org/abs/2506.21046)
*Shangbo Wu,Yu-an Tan,Ruinan Ma,Wencong Ma,Dehua Zhu,Yuanzhang Li*

Main category: cs.CV

TL;DR: 论文提出了一种基于自监督视觉Transformer（ViT）的对抗攻击方法dSVA，通过利用对比学习（CL）和掩码图像建模（MIM）的全局和局部特征，显著提升了黑盒对抗样本的迁移性。


<details>
  <summary>Details</summary>
Motivation: 现有对抗攻击方法主要依赖监督学习的中间特征，而自监督学习与ViT架构的结合表现出色。本文探索自监督ViT特征是否能进一步提升对抗迁移性。

Method: 设计了dSVA方法，结合CL和MIM的双重自监督ViT特征，利用生成器框架和注意力机制生成对抗样本。

Result: 实验表明，CL和MIM使ViT关注不同特征倾向，联合利用显著提升了对抗样本的黑盒迁移性，优于现有方法。

Conclusion: 自监督ViT的双重特征提取为对抗攻击提供了新的思路，dSVA在多种架构模型上表现出卓越的迁移性。
...
### [81] [Class-Agnostic Region-of-Interest Matching in Document Images](https://arxiv.org/abs/2506.21055)
...
Result: 实验表明，RoI-Matcher在基准数据集上表现有效，为后续研究提供了基线。
...
### [82] [SAMURAI: Shape-Aware Multimodal Retrieval for 3D Object Identification](https://arxiv.org/abs/2506.21056)
*Dinh-Khoi Vo,Van-Loc Nguyen,Minh-Triet Tran,Trung-Nghia Le*

Main category: cs.CV

TL;DR: SAMURAI结合CLIP语义匹配和形状引导重排，通过多数投票策略，解决了复杂室内环境中基于掩码2D图像和自然语言描述的3D对象检索问题。


<details>
  <summary>Details</summary>
Motivation: 在ROOMELSA挑战中，仅使用掩码2D图像和自然语言描述检索3D对象面临外观、几何和语义推理的困难，且受限于视角扭曲、无纹理区域、模糊语言提示和噪声分割掩码。

Method: SAMURAI整合了CLIP语义匹配和基于二值轮廓的形状引导重排，采用多数投票策略，并通过预处理提升掩码质量。

Result: 在ROOMELSA私有测试集上表现优异，证明了结合形状先验和语言理解的重要性。

Conclusion: SAMURAI展示了形状和语言线索结合在开放世界3D对象检索中的有效性。
...
### [83] [PoseMaster: Generating 3D Characters in Arbitrary Poses from a Single Image](https://arxiv.org/abs/2506.21076)
...
Method: 提出基于流的3D原生生成框架，利用3D骨骼作为姿势条件，并通过随机清空条件训练提升控制效果。
...
### [84] [ESMStereo: Enhanced ShuffleMixer Disparity Upsampling for Real-Time and Accurate Stereo Matching](https://arxiv.org/abs/2506.21091)
...
<details>
  <summary>Details</summary>
Motivation: 立体匹配在自动驾驶系统中至关重要，但现有深度学习方法难以同时实现高精度和实时性。大尺度成本体积计算量大，而小尺度成本体积信息不足。

Method: ESM通过将主要特征整合到视差上采样单元中，快速提取初始视差估计特征并与图像特征融合，通过混洗和分层分割混合特征，再通过紧凑的特征引导沙漏网络细化。

Result: ESM在高端GPU上达到116 FPS，AGX Orin上达到91 FPS，实现了高精度实时视差图重建。
...
### [85] [OracleFusion: Assisting the Decipherment of Oracle Bone Script with Structurally Constrained Semantic Typography](https://arxiv.org/abs/2506.21101)
...
TL;DR: 本文提出了一种名为OracleFusion的两阶段语义排版框架，用于解决甲骨文未解字符的解译难题。该方法结合多模态大语言模型和空间感知推理，生成语义丰富的矢量字体，显著提升了可读性和美观性。


<details>
  <summary>Details</summary>
Motivation: 甲骨文作为古老语言，其未解字符的结构复杂且抽象，解译难度大。本文旨在通过技术手段辅助专家解译这些字符。

Method: OracleFusion分为两阶段：1）利用增强空间感知推理的多模态大语言模型分析字形结构；2）引入甲骨结构矢量融合技术，生成语义丰富的矢量字体。

Result: 实验表明，OracleFusion在语义、视觉吸引力和字形保持方面优于现有基准模型，并能提供专家级见解。

Conclusion: OracleFusion为甲骨文解译提供了有效工具，显著提升了未解字符的可读性和美观性。
...
### [86] [Pushing Trade-Off Boundaries: Compact yet Effective Remote Sensing Change Detection](https://arxiv.org/abs/2506.21109)
...
<details>
  <summary>Details</summary>
Motivation: 现代深度学习模型复杂度高但精度提升有限，而卫星上处理需要高效轻量模型。

Method: 提出FlickCD，包含增强差异模块（EDM）和局部-全局融合块（SWSA和EGSA）。

Result: 在四个基准数据集上，FlickCD显著降低计算和存储开销，同时达到或接近SOTA性能。

Conclusion: FlickCD在性能和资源消耗之间取得了优异平衡，适用于卫星上处理。
...
### [87] [CL-Splats: Continual Learning of Gaussian Splatting with Local Optimization](https://arxiv.org/abs/2506.21117)
...
<details>
  <summary>Details</summary>
Motivation: 在动态3D环境中，实时更新场景表示对机器人、混合现实和具身AI至关重要，需避免全场景重新优化的计算开销。

Method: 引入CL-Splats，通过变化检测模块分割动态与静态部分，实现局部优化，并支持场景状态的存储与恢复。

Result: 实验表明，CL-Splats能高效更新并提升重建质量，优于现有技术。
...
### [88] [GoIRL: Graph-Oriented Inverse Reinforcement Learning for Multimodal Trajectory Prediction](https://arxiv.org/abs/2506.21121)
...
Method: 开发了特征适配器将车道图特征聚合到网格空间，结合最大熵IRL推断奖励分布；采用分层参数化轨迹生成器和细化模块提升预测精度。
...
### [89] [Learning to See in the Extremely Dark](https://arxiv.org/abs/2506.21132)
*Hai Jiang,Binhao Guan,Zhen Liu,Xiaohong Liu,Jian Yu,Zheng Liu,Songchen Han,Shuaicheng Liu*

Main category: cs.CV

TL;DR: 论文提出了一种用于极低光照（低至0.0001 lux）RAW图像增强的数据合成方法和扩散模型框架，并发布了SIED数据集。
...
Method: 提出数据合成管道生成极低光照RAW图像及sRGB参考，并设计扩散模型框架，包含自适应光照校正模块和颜色一致性损失。
...
### [90] [YOLO-FDA: Integrating Hierarchical Attention and Detail Enhancement for Surface Defect Detection](https://arxiv.org/abs/2506.21135)
*Jiawei Hu*
...
<details>
  <summary>Details</summary>
Motivation: 工业表面缺陷检测因缺陷类型多样、形状不规则、细粒度要求高和材质纹理复杂而具有挑战性，现有AI检测器存在冗余特征、细节敏感度不足和多尺度鲁棒性差的问题。

Method: 提出YOLO-FDA框架，采用BiFPN架构增强多级特征聚合，引入DDFM模块捕获细粒度结构变化，并提出AC和CAF两种注意力融合策略优化上下文表示。
...
### [91] [Tree-based Semantic Losses: Application to Sparsely-supervised Large Multi-class Hyperspectral Segmentation](https://arxiv.org/abs/2506.21150)
*Junwen Wang,Oscar Maccormac,William Rochford,Aaron Kujawa,Jonathan Shapey,Tom Vercauteren*

Main category: cs.CV

TL;DR: 论文提出两种基于树结构的语义损失函数，用于改进高光谱图像（HSI）的分割任务，并整合到稀疏标注训练方法中，取得了最优性能。
...
Conclusion: 提出的方法在分割任务中表现优异，且能兼顾异常检测。
...
### [92] [Geometry and Perception Guided Gaussians for Multiview-consistent 3D Generation from a Single Image](https://arxiv.org/abs/2506.21152)
*Pufan Li,Bi'an Du,Wei Hu*

Main category: cs.CV

TL;DR: 提出一种新方法，通过结合几何和感知先验，从单张图像重建高保真3D物体，解决了多视角一致性和几何细节不足的问题。


<details>
  <summary>Details</summary>
Motivation: 现有方法在从单视角图像生成3D物体时，多视角一致性和几何细节表现不佳。

Method: 训练三个高斯分支（几何先验、感知先验和高斯噪声），通过交互优化和重投影策略提升3D一致性。

Result: 实验表明，该方法在3D重建和新视角合成上优于现有方法，生成结果更一致且细节丰富。

Conclusion: 该方法无需额外训练，即可实现高保真3D物体重建，解决了多视角一致性和几何细节问题。
...
### [93] [Topology-Aware Modeling for Unsupervised Simulation-to-Reality Point Cloud Recognition](https://arxiv.org/abs/2506.21165)
*Longkun Zou,Kangjun Liu,Ke Chen,Kailing Guo,Kui Jia,Yaowei Wang*

Main category: cs.CV

TL;DR: 论文提出了一种拓扑感知建模（TAM）框架，用于解决3D点云数据中模拟到现实（Sim2Real）的领域适应问题，通过全局空间拓扑和自监督学习任务提升分类器的泛化能力。


<details>
  <summary>Details</summary>
Motivation: 由于数据采集方法不同，3D点云数据存在显著的几何变化，导致模拟数据与真实数据之间存在领域差距，现有无监督领域适应（UDA）方法难以解决。

Method: 提出TAM框架，利用全局空间拓扑和局部几何特征的拓扑关系，结合自监督学习和自训练策略，减少噪声伪标签的影响。
...
### [94] [Out-of-Distribution Semantic Occupancy Prediction](https://arxiv.org/abs/2506.21185)
*Yuheng Zhang,Mengfei Duan,Kunyu Peng,Yuhang Wang,Ruiping Liu,Fei Teng,Kai Luo,Zhiyong Li,Kailun Yang*

Main category: cs.CV

TL;DR: 该论文提出了一种针对3D语义占用预测中分布外（OoD）检测的新方法OccOoD，通过合成异常数据集和几何-语义融合框架，显著提升了OoD检测性能。
...
Method: 提出合成异常集成管道生成数据集VAA-KITTI和VAA-KITTI-360，并开发OccOoD框架，结合Voxel-BEV渐进融合（VBPF）增强OoD检测。

Result: OccOoD在1.2m区域内OoD检测AuROC达67.34%，AuPRCr达29.21%，同时保持竞争力。

Conclusion: OccOoD有效解决了3D语义占用预测中的OoD检测问题，数据集和代码将公开。
...
### [95] [GroundFlow: A Plug-in Module for Temporal Reasoning on 3D Point Cloud Sequential Grounding](https://arxiv.org/abs/2506.21188)
*Zijun Lin,Shuting He,Cheston Tan,Bihan Wen*

Main category: cs.CV

TL;DR: 论文提出GroundFlow模块，通过提取短期和长期步骤信息，提升3D点云序列定位任务的准确性，显著优于现有方法。


<details>
  <summary>Details</summary>
Motivation: 现有3D视觉定位方法未充分利用文本指令中的时序信息，且无法处理代词依赖的上下文理解问题。

Method: 提出GroundFlow模块，选择性提取短期和长期步骤信息，增强时序推理能力。

Result: 在SG3D基准测试中，任务准确率提升7.5%和10.2%，优于预训练的3D大语言模型。
...
### [96] [Unlocking Constraints: Source-Free Occlusion-Aware Seamless Segmentation](https://arxiv.org/abs/2506.21198)
...
<details>
  <summary>Details</summary>
Motivation: 全景图像处理面临失真、遮挡和标注不足等问题，传统无监督域适应方法需依赖源数据，限制了实用性。
...
### [97] [MedPrompt: LLM-CNN Fusion with Weight Routing for Medical Image Segmentation and Classification](https://arxiv.org/abs/2506.21199)
*Shadman Sobhan,Kazi Abrar Mahmud,Abduz Zami*

Main category: cs.CV

TL;DR: MedPrompt是一个统一框架，结合了LLM和CNN，支持用户自定义工作流，无需重新训练整个系统。
...
### [98] [ReME: A Data-Centric Framework for Training-Free Open-Vocabulary Segmentation](https://arxiv.org/abs/2506.21233)
...
Conclusion: 数据为中心的设计对无需训练的OVS至关重要，方法代码已开源。
...
### [99] [Real-Time ESFP: Estimating, Smoothing, Filtering, and Pose-Mapping](https://arxiv.org/abs/2506.21234)
...
Method: 包含四个模块：3D骨架估计、平滑处理（HPSTM）、滤波和姿态映射。

Result: 能够生成平滑且符合解剖学合理性的关节轨迹。

Conclusion: ESFP提供了一种高效且低成本的方法，用于从视频生成机械臂控制指令。
...
### [100] [DiMPLe -- Disentangled Multi-Modal Prompt Learning: Enhancing Out-Of-Distribution Alignment with Invariant and Spurious Feature Separation](https://arxiv.org/abs/2506.21237)
*Umaima Rahman,Mohammad Yaqub,Dwarikanath Mahapatra*

Main category: cs.CV

TL;DR: DiMPLe是一种新型多模态提示学习方法，通过解耦视觉和语言模态中的不变特征和虚假特征，提升多模态学习的泛化能力和鲁棒性。


<details>
  <summary>Details</summary>
Motivation: 解决视觉数据中虚假相关性对分布外（OOD）性能的负面影响，传统方法仅关注图像特征，而DiMPLe跨模态解耦特征并保持对齐。

Method: 结合三个关键目标：不变与虚假特征的互信息最小化、虚假特征正则化、不变特征的对比学习。

Result: 在11个数据集上优于CoOp-OOD，基础类准确率提升15.27，新类准确率提升44.31。

Conclusion: DiMPLe通过跨模态特征解耦和一致性对齐，显著提升了多模态学习的泛化性能和鲁棒性。
...
### [101] [Temporal Rate Reduction Clustering for Human Motion Segmentation](https://arxiv.org/abs/2506.21249)
...
<details>
  <summary>Details</summary>
Motivation: 现有的人体运动分割方法主要基于子空间聚类，假设高维时间数据符合子空间联合分布，但在复杂背景下的视频帧可能不符合该分布。

Method: 提出TR²C方法，联合学习结构化表示和亲和力，确保时间一致性并符合子空间联合分布。

Result: 在五个基准数据集上进行了广泛实验，使用不同特征提取器均取得了最先进的性能。

Conclusion: TR²C方法通过学习结构化表示和亲和力，有效提升了人体运动分割的性能。
...
### [102] [DuET: Dual Incremental Object Detection via Exemplar-Free Task Arithmetic](https://arxiv.org/abs/2506.21260)
...
Method: 提出DuET框架，基于任务算术模型合并，结合方向一致性损失，支持多种检测器（如YOLO11和RT-DETR）实现实时增量学习。

Result: 在Pascal Series和Diverse Weather Series上，DuET的RAI分别提升了13.12%和11.39%，同时保持了较高的平均保留指数（89.3%和88.57%）。

Conclusion: DuIOD和DuET框架有效解决了类别和域增量学习的双重挑战，显著优于现有方法。
...
### [103] [Video Virtual Try-on with Conditional Diffusion Transformer Inpainter](https://arxiv.org/abs/2506.21270)
...
### [104] [WordCon: Word-level Typography Control in Scene Text Rendering](https://arxiv.org/abs/2506.21276)
...
Method: 构建单词级控制数据集，提出TIA框架和WordCon方法，利用跨模态对齐和参数高效微调，结合掩码损失和联合注意力损失。

Result: 在定性和定量结果上优于现有技术。

Conclusion: 方法有效提升了单词级排版控制的精确性和灵活性，数据集和代码将公开。
...
### [105] [HumanOmniV2: From Understanding to Omni-Modal Reasoning with Context](https://arxiv.org/abs/2506.21277)
...
### [106] [HieraSurg: Hierarchy-Aware Diffusion Model for Surgical Video Generation](https://arxiv.org/abs/2506.21287)
*Diego Biagini,Nassir Navab,Azade Farshad*

Main category: cs.CV

TL;DR: HieraSurg是一个层次感知的手术视频生成框架，通过两个专用扩散模型解决现有方法在手术视频生成中缺乏一致性和精细指导的问题。
...
Method: HieraSurg采用两阶段模型：首先生成粗粒度语义变化，再通过第二阶段模型结合细粒度视觉特征生成最终视频。
...
### [107] [Continual Self-Supervised Learning with Masked Autoencoders in Remote Sensing](https://arxiv.org/abs/2506.21312)
*Lars Möllenbrok,Behnood Rasti,Begüm Demir*

Main category: cs.CV

TL;DR: 提出了一种新的持续自监督学习方法CoSMAE，通过数据混合和模型混合知识蒸馏减少灾难性遗忘，并在遥感领域显著优于现有方法。
...
Method: CoSMAE结合数据混合（保留过去数据分布）和模型混合知识蒸馏（同时从过去和当前模型蒸馏知识），在数据和模型层面正则化MAE。

Result: 实验显示CoSMAE比现有方法性能提升高达4.94%。

Conclusion: CoSMAE通过自监督学习有效减少灾难性遗忘，适用于遥感领域的持续学习任务。
...
### [108] [DrishtiKon: Multi-Granular Visual Grounding for Text-Rich Document Images](https://arxiv.org/abs/2506.21316)
*Badri Vishal Kasuba,Parag Chaudhuri,Ganesh Ramakrishnan*

Main category: cs.CV

TL;DR: 论文提出了一种名为\drishtikon的多粒度视觉定位框架，用于提升文档图像中视觉问答（VQA）的可解释性和可信度。


<details>
  <summary>Details</summary>
Motivation: 解决文档智能和视觉问答系统中视觉定位的挑战，尤其是在多语言复杂文档中。

Method: 结合多语言OCR、大语言模型和新型区域匹配算法，实现块、行、词和点级别的精确定位。

Result: 在CircularsVQA测试集上创建了新基准，实验表明该方法在定位精度上达到最优，行级粒度在精度和召回率之间取得最佳平衡。
...
### [109] [LLaVA-Pose: Enhancing Human Pose and Action Understanding via Keypoint-Integrated Instruction Tuning](https://arxiv.org/abs/2506.21317)
*Dewen Zhang,Tahir Hussain,Wangpeng An,Hayaru Shouno*

Main category: cs.CV

TL;DR: 论文提出了一种通过整合人体关键点与传统视觉特征生成专用视觉-语言指令数据的方法，以提升视觉语言模型在人体姿态和动作任务上的表现。


<details>
  <summary>Details</summary>
Motivation: 现有视觉语言模型在复杂人体姿态和动作任务上表现不佳，缺乏专用数据是主要原因。

Method: 整合人体关键点与视觉特征（如标题和边界框）生成专用数据集，并微调LLaVA-1.5-7B模型。
...
### [110] [PanSt3R: Multi-view Consistent Panoptic Segmentation](https://arxiv.org/abs/2506.21348)
*Lojze Zust,Yohann Cabon,Juliette Marrie,Leonid Antsfeld,Boris Chidlovskii,Jerome Revaud,Gabriela Csurka*

Main category: cs.CV

TL;DR: PanSt3R提出了一种联合预测3D几何和多视角全景分割的统一方法，无需测试时优化，速度快且性能优越。
...
Method: 基于MUSt3R，PanSt3R联合预测3D几何和多视角全景分割，改进掩码合并方法，并支持新视角预测。

Result: PanSt3R在多个基准测试中达到最优性能，且速度远超现有方法。

Conclusion: PanSt3R是一种高效、可扩展的3D场景全景分割方法，显著优于现有技术。
...
### [111] [Generalizable Neural Electromagnetic Inverse Scattering](https://arxiv.org/abs/2506.21349)
...
<details>
  <summary>Details</summary>
Motivation: 电磁逆散射问题在医学成像等应用中至关重要，但传统方法（如Img-Interiors）存在泛化性差、对稀疏发射器配置不鲁棒等问题。本文旨在通过物理驱动的视角重新设计解决方案。

Method: 提出两阶段框架：1）电流估计器学习诱导电流作为入射场与散射场的物理桥梁；2）介电常数求解器直接从估计的电流计算相对介电常数。支持端到端训练和预测。

Result: 实验表明，该方法在重建精度、泛化性和鲁棒性上优于现有技术，特别是在稀疏发射器配置下表现优异。

Conclusion: 本文为电磁逆散射问题提供了新的物理驱动视角，为电磁成像的实际应用迈出了重要一步。
...
### [112] [ShotBench: Expert-Level Cinematic Understanding in Vision-Language Models](https://arxiv.org/abs/2506.21356)
...
Conclusion: ShotBench和ShotQA为AI驱动的电影理解和生成提供了重要工具，推动了该领域的发展。
...
### [113] [CoPa-SG: Dense Scene Graphs with Parametric and Proto-Relations](https://arxiv.org/abs/2506.21357)
...
Result: 比较多种场景图生成模型性能，展示新关系类型如何提升下游任务。

Conclusion: CoPa-SG和新型关系类型显著提升了场景理解和推理能力。
...
### [114] [ToosiCubix: Monocular 3D Cuboid Labeling via Vehicle Part Annotations](https://arxiv.org/abs/2506.21358)
...
Conclusion: ToosiCubix为低成本、可扩展的3D立方体标注提供了实用解决方案。
...
### [115] [GenFlow: Interactive Modular System for Image Generation](https://arxiv.org/abs/2506.21369)
*Duc-Hung Nguyen,Huu-Phuc Huynh,Minh-Triet Tran,Trung-Nghia Le*

Main category: cs.CV

TL;DR: GenFlow是一个模块化框架，通过节点编辑器和自然语言处理助手，简化生成艺术的创作流程，降低技术门槛。


<details>
  <summary>Details</summary>
Motivation: 生成艺术需要高级技术知识，限制了其潜力，GenFlow旨在解决这一问题。

Method: 采用模块化设计、节点编辑器及自然语言处理助手，自动化部署流程。

Result: 用户研究表明，GenFlow优化了工作流程，减少了任务完成时间，提升了用户体验。

Conclusion: GenFlow通过易用性和高效性，重新定义了生成艺术的普及性和效率。
...
### [116] [FastRef:Fast Prototype Refinement for Few-Shot Industrial Anomaly Detection](https://arxiv.org/abs/2506.21398)
...
Result: 实验表明，FastRef在多个基准数据集上表现优异，计算效率高。

Conclusion: FastRef通过特征转移和异常抑制，显著提升了少样本工业异常检测的性能。
...
### [117] [Curve-Aware Gaussian Splatting for 3D Parametric Curve Reconstruction](https://arxiv.org/abs/2506.21401)
*Zhirui Gao. Renjiao Yi,Yaqiao Dai,Xuening Zhu,Wei Chen,Chenyang Zhu,Kai Xu*

Main category: cs.CV

TL;DR: 提出了一种端到端框架，直接从多视角边缘图重建3D参数曲线，避免了传统两阶段方法的误差累积，并通过曲线感知的高斯表示实现可微渲染。


<details>
  <summary>Details</summary>
Motivation: 传统两阶段方法（先重建边缘点云再拟合参数曲线）存在优化间隙导致的误差累积问题，且参数曲线不适合基于渲染的多视角优化。

Method: 提出了一种双向耦合机制，将参数曲线与边缘导向的高斯分量结合，形成曲线感知的高斯表示（CurveGaussian），并引入动态自适应拓扑优化框架。

Result: 在ABC数据集和真实基准测试中表现优于两阶段方法，重建结果更干净、更鲁棒，且训练参数更少，效率更高。
...
### [118] [XVerse: Consistent Multi-Subject Control of Identity and Semantic Attributes via DiT Modulation](https://arxiv.org/abs/2506.21416)
*Bowen Chen,Mengyi Zhao,Haomiao Sun,Li Chen,Xu Wang,Kang Du,Xinglong Wu*

Main category: cs.CV

TL;DR: XVerse模型通过将参考图像转换为特定令牌的文本流偏移，实现了对多主体图像生成的高保真和可编辑控制。


<details>
  <summary>Details</summary>
Motivation: 解决文本到图像生成中多主体控制的编辑性和一致性不足问题。

Method: 将参考图像转换为偏移量，用于特定令牌的文本流调制，避免干扰图像潜在特征。

Result: 实现了高保真、可编辑的多主体图像合成，精确控制个体特征和语义属性。
...
### [119] [EndoFlow-SLAM: Real-Time Endoscopic SLAM with Flow-Constrained Gaussian Splatting](https://arxiv.org/abs/2506.21420)
...
Method: 引入光流损失作为几何约束，并提出深度正则化策略以解决光度不一致问题；改进3DGS细化策略，关注关键帧的渲染质量。

Result: 在C3VD静态数据集和StereoMIS动态数据集上，该方法在新视角合成和位姿估计方面优于现有方法。
...
### [120] [HyperSORT: Self-Organising Robust Training with hyper-networks](https://arxiv.org/abs/2506.21430)
*Samuel Joutard,Marijn Stollenga,Marc Balle Sanchez,Mohammad Farid Azampour,Raphael Prevost*

Main category: cs.CV

TL;DR: HyperSORT是一种利用超网络预测UNet参数的框架，用于处理医学影像数据中的异质性偏差，并通过潜在向量表征图像和标注的变异性。


<details>
  <summary>Details</summary>
Motivation: 医学影像数据常包含异质性偏差，如错误标签或不一致的标注风格，这些偏差会影响深度学习分割网络的性能。识别和表征这些偏差是一项繁琐且具有挑战性的任务。

Method: HyperSORT通过超网络预测UNet参数，潜在向量表征图像和标注的变异性。超网络参数和潜在向量集合通过训练数据联合学习，从而学习UNet参数的复杂分布。

Result: 在3D腹部CT数据集上的实验表明，HyperSORT能够结构化映射数据集，识别系统性偏差和错误样本，潜在空间聚类生成的UNet参数能根据学习到的系统性偏差进行分割。

Conclusion: HyperSORT提供了一种有效的方法来识别和处理医学影像数据中的偏差，提升了分割网络的鲁棒性和性能。
...
### [121] [Benchmarking Deep Learning and Vision Foundation Models for Atypical vs. Normal Mitosis Classification with Cross-Dataset Evaluation](https://arxiv.org/abs/2506.21444)
...
TL;DR: 该论文研究了通过深度学习方法自动分类非典型有丝分裂（AMF），并比较了多种模型在乳腺癌数据集上的表现，展示了迁移学习和微调技术的有效性。
...
Method: 研究比较了基线模型、线性探测的基础模型和低秩适应（LoRA）微调的基础模型，并引入了两个新的AMF数据集（AtNorM-Br和AtNorM-MD）进行严格评估。
...
### [122] [Controllable 3D Placement of Objects with Scene-Aware Diffusion Models](https://arxiv.org/abs/2506.21446)
...
<details>
  <summary>Details</summary>
Motivation: 现有文本条件生成模型在对象放置时难以实现精确位置和方向控制，需要复杂的掩码或提示。

Method: 设计了一种结合视觉地图和粗略对象掩码的条件信号，基于修复模型保持背景完整。

Result: 在汽车场景中验证了方法的有效性，能够实现高质量的对象放置，包括形状和方向变化。

Conclusion: 该方法结合了位置和外观控制，实现了精确的对象放置。
...
### [123] [A Comprehensive Dataset for Underground Miner Detection in Diverse Scenario](https://arxiv.org/abs/2506.21451)
*Cyrus Addy,Ajay Kumar Gurumadaiah,Yixiang Gao,Kwame Awuah-Offei*

Main category: cs.CV

TL;DR: 论文提出了一种新型热成像数据集，用于开发和验证矿工检测系统，评估了多种先进目标检测算法，为地下采矿环境的安全应用奠定了基础。


<details>
  <summary>Details</summary>
Motivation: 地下采矿作业面临重大安全挑战，需要可靠的矿工检测能力以支持应急响应。目前缺乏针对地下环境的热成像数据集，限制了深度学习算法的应用。

Method: 通过系统采集各种采矿活动和场景的热成像数据，创建了一个专门的数据集，并评估了YOLOv8、YOLOv10、YOLO11和RT-DETR等目标检测算法的性能。

Result: 研究证明了热成像用于矿工检测的可行性，并为未来在这一关键安全应用中的研究奠定了基础。

Conclusion: 该数据集是开发可靠热成像矿工检测系统的重要第一步，为实际应急场景的部署提供了支持。
...
### [124] [Rethinking Oversaturation in Classifier-Free Guidance via Low Frequency](https://arxiv.org/abs/2506.21452)
...
TL;DR: 论文提出动态、静态和混合三种基于转向运动计数（TMC）的交通信号配置方法，通过视觉跟踪系统估算TMC，并在仿真中评估信号性能。实验表明，90和120秒的周期时间效果最佳，混合方法在高峰和非高峰时段表现更好。
...
Method: 开发视觉跟踪系统估算TMC，结合仿真工具SUMO评估动态、静态和混合信号配置方法。

Result: 90和120秒周期时间效果最佳；动态配置适用于多数交叉口，混合方法在高峰和非高峰时段表现更优。

Conclusion: 混合信号方法能适应不同交通模式，尤其适用于交通分布不均的交叉口。
...
### [126] [Logios : An open source Greek Polytonic Optical Character Recognition system](https://arxiv.org/abs/2506.21474)
...
Result: 系统在准确性和效率上有显著提升，并开源模型供学术使用。

Conclusion: 该OCR系统为希腊多调文本的数字化提供了有效工具，具有学术和实用价值。
...
### [127] [Global and Local Entailment Learning for Natural World Imagery](https://arxiv.org/abs/2506.21476)
...
TL;DR: 论文提出了一种基于空间统计学的目标检测模型，解决了现有模型在未检测区域不确定性量化不足的问题，适用于自动驾驶等安全关键应用。
...
Method: 采用空间统计学中的标记点过程，将边界框数据建模为点事件，通过基于似然的训练提供区域可行驶性的明确置信度估计。

Result: 通过校准评估和性能测试验证了方法的有效性。

Conclusion: 提出的统计框架为目标检测提供了更可靠的置信度估计，尤其在未检测区域的不确定性量化方面表现优异。
...
### [129] [Mitigating Hallucination of Large Vision-Language Models via Dynamic Logits Calibration](https://arxiv.org/abs/2506.21509)
*Jiahe Chen,Jiaying He,Qian Shao,Qiyuan Chen,Jiahe Ying,Hongxia Xu,Jintai Chen,Jianwei Zheng,Jian Wu*

Main category: cs.CV

TL;DR: 论文提出了一种名为动态对数校准（DLC）的解码框架，用于减少大型视觉语言模型（LVLM）中的幻觉现象，通过动态调整生成文本与视觉证据的对齐。
...
### [130] [GGTalker: Talking Head Systhesis with Generalizable Gaussian Priors and Identity-Specific Adaptation](https://arxiv.org/abs/2506.21513)
*Wentao Hu,Shunkai Li,Ziqiao Peng,Haoxian Zhang,Fan Shi,Xiaoqiang Liu,Pengfei Wan,Di Zhang,Hui Tian*

Main category: cs.CV

TL;DR: GGTalker提出了一种结合通用先验和身份特定适应的两阶段训练策略，用于生成高质量、泛化性强的语音驱动3D说话头部模型。
...
Method: 采用两阶段Prior-Adaptation训练策略，学习高斯头部先验并适应个体特征。包括Audio-Expression和Expression-Visual先验，以及颜色MLP和Body Inpainter技术。

Result: GGTalker在渲染质量、3D一致性、唇同步准确性和训练效率上达到最先进水平。

Conclusion: GGTalker通过通用先验和身份适应解决了现有方法的局限性，显著提升了说话头部模型的性能。
...
### [131] [G$^{2}$D: Boosting Multimodal Learning with Gradient-Guided Distillation](https://arxiv.org/abs/2506.21514)
*Mohammed Rakib,Arunkumar Bagavathi*

Main category: cs.CV

TL;DR: 论文提出Gradient-Guided Distillation (G²D)框架，解决多模态学习中模态不平衡问题，通过动态顺序模态优先技术提升弱模态表现。


<details>
  <summary>Details</summary>
Motivation: 传统多模态模型常因模态不平衡导致弱模态利用不足，G²D旨在优化这一问题。

Method: 结合单模态和多模态目标的损失函数，并引入动态顺序模态优先技术（SMP）。

Result: 在多个真实数据集上验证，G²D显著提升弱模态表现，优于现有方法。
...
### [132] [MADrive: Memory-Augmented Driving Scene Modeling](https://arxiv.org/abs/2506.21520)
*Polina Karpikova,Daniil Selikhanovych,Kirill Struminsky,Ruslan Musaev,Maria Golitsyna,Dmitry Baranchuk*

Main category: cs.CV

TL;DR: MADrive是一个记忆增强的场景重建框架，通过替换观测车辆为外部记忆库中的3D资产，提升自动驾驶环境的真实感合成能力。


<details>
  <summary>Details</summary>
Motivation: 现有场景重建方法难以支持显著改变或新颖驾驶场景的真实感合成。

Method: 引入MAD-Cars数据集和检索模块，从记忆库中检索相似车辆资产，进行3D重建并集成到目标场景中。

Result: 实验证明，该方法能实现多视角车辆表示，支持高度改变的配置的真实感合成。

Conclusion: MADrive扩展了现有重建方法的能力，为自动驾驶场景的真实感合成提供了新途径。
...
### [133] [WAFT: Warping-Alone Field Transforms for Optical Flow](https://arxiv.org/abs/2506.21526)
*Yihan Wang,Jia Deng*

Main category: cs.CV

TL;DR: WAFT是一种简单高效的用于光流估计的方法，通过高分辨率扭曲替代成本体积，在降低内存消耗的同时提升精度。
...
Method: 使用高分辨率扭曲替代成本体积，设计简单灵活，依赖最小归纳偏置和定制设计。

Result: 在Spring和KITTI基准测试中排名第一，KITTI零样本泛化表现最佳，速度比同类方法快4.1倍。

Conclusion: WAFT证明了无需成本体积也能实现高性能光流估计，同时具有高效和灵活的优势。
...
### [134] [Maximal Matching Matters: Preventing Representation Collapse for Robust Cross-Modal Retrieval](https://arxiv.org/abs/2506.21538)
*Hani Alomari,Anushka Sivakumar,Andrew Zhang,Chris Thomas*

Main category: cs.CV

TL;DR: 论文提出了一种改进跨模态图像-文本检索的方法，通过优化嵌入集的一对一匹配和引入两种损失函数，解决了稀疏监督和集合坍缩问题。


<details>
  <summary>Details</summary>
Motivation: 传统单向量嵌入方法难以捕捉跨模态的多样关联，而基于集合的方法虽能捕捉更丰富关系，但仍面临稀疏监督和集合坍缩的挑战。
...
### [135] [StruMamba3D: Exploring Structural Mamba for Self-supervised Point Cloud Representation Learning](https://arxiv.org/abs/2506.21541)
*Chuxin Wang,Yixin Zha,Wenfei Yang,Tianzhu Zhang*

Main category: cs.CV

TL;DR: StruMamba3D提出了一种自监督点云表示学习新范式，解决了Mamba方法在3D点云处理中破坏邻接性和长序列记忆保留的问题。


<details>
  <summary>Details</summary>
Motivation: Mamba方法在点云表示学习中表现出色，但仍存在破坏3D点邻接性和长序列记忆丢失的问题。

Method: 设计了空间状态代理保留点间空间依赖，增强SSM的状态更新策略，并引入轻量卷积促进空间状态交互。

Result: 在四个下游任务中表现优异，ModelNet40准确率达95.1%，ScanObjectNN达92.75%。

Conclusion: StruMamba3D通过保留空间依赖和自适应序列长度策略，显著提升了点云表示学习性能。
...
### [136] [DeOcc-1-to-3: 3D De-Occlusion from a Single Image via Self-Supervised Multi-View Diffusion](https://arxiv.org/abs/2506.21544)
*Yansong Qu,Shaohui Dai,Xinyang Li,Yuze Wang,You Shen,Liujuan Cao,Rongrong Ji*

Main category: cs.CV

TL;DR: 提出了一种端到端的框架，用于从单张部分遮挡图像生成多视角视图，以提升3D重建质量。
...
Method: 采用自监督训练管道，利用遮挡-未遮挡图像对和伪真实视图，联合学习补全和多视角生成。

Result: 成功生成了六种结构一致的新视角视图，无需先验修复或手动标注。

Conclusion: 该方法在遮挡感知重建方面表现优异，并提供了首个标准化评测基准。
...
### [137] [SAM4D: Segment Anything in Camera and LiDAR Streams](https://arxiv.org/abs/2506.21547)
...
### [138] [SiM3D: Single-instance Multiview Multimodal and Multisetup 3D Anomaly Detection Benchmark](https://arxiv.org/abs/2506.21549)
...
Result: SiM3D数据集包含333个实例的8类对象，提供手动标注的3D分割GT，并建立了单视图方法的基线性能。

Conclusion: SiM3D为多视角3D ADS任务提供了首个基准和数据集，填补了从合成数据泛化到真实数据的空白。
...
### [139] [OTSurv: A Novel Multiple Instance Learning Framework for Survival Prediction with Heterogeneity-aware Optimal Transport](https://arxiv.org/abs/2506.20741)
*Qin Ren,Yifan Wang,Ruogu Fang,Haibin Ling,Chenyu You*
...
Conclusion: OTSurv是一个高效、可解释的生存预测工具，适用于数字病理学。
...
### [140] [StereoDiff: Stereo-Diffusion Synergy for Video Depth Estimation](https://arxiv.org/abs/2506.20756)
*Haodong Li,Chen Wang,Jiahui Lei,Kostas Daniilidis,Lingjie Liu*
...
Method: 提出两阶段视频深度估计器StereoDiff，静态区域依赖立体匹配，动态区域利用视频深度扩散保持一致性。通过频域分析证明两者的互补性。

Result: 在零样本、真实世界动态视频深度基准测试中，StereoDiff表现出色，一致性和准确性均达到SoTA水平。

Conclusion: StereoDiff通过结合立体匹配和视频深度扩散，显著提升了视频深度估计的性能，尤其在静态和动态区域的协同处理上表现出色。
...
### [141] [ConViTac: Aligning Visual-Tactile Fusion with Contrastive Representations](https://arxiv.org/abs/2506.20757)
*Zhiyuan Wu,Yongqiang Zhao,Shan Luo*
...
Method: 提出ConViTac网络，采用对比嵌入条件（CEC）机制，通过自监督对比学习预训练的对比编码器，将视觉和触觉输入投影到统一的潜在嵌入中，并通过跨模态注意力耦合特征融合。
...
### [142] [AI-Driven MRI-based Brain Tumour Segmentation Benchmarking](https://arxiv.org/abs/2506.20786)
*Connor Ludwig,Khashayar Namdar,Farzad Khalvati*

Main category: cs.CV

TL;DR: 论文评估了多种可提示模型（如SAM、SAM 2、MedSAM等）在医学图像分割中的表现，发现某些模型在精确提示下表现优于nnU-Net，但nnU-Net仍因实用性占优。


<details>
  <summary>Details</summary>
Motivation: 缺乏对多种可提示模型在医学数据集上的统一评估与比较，研究旨在填补这一空白。

Method: 使用SAM、SAM 2、MedSAM、SAM-Med-3D和nnU-Net在BraTS 2023数据集上进行零样本推理，并评估不同提示质量下的表现。

Result: SAM和SAM 2在精确边界框提示下Dice分数最高（0.894和0.893），但nnU-Net仍更实用。微调后点提示性能提升显著，但未超越边界框或nnU-Net。
...
### [143] [How do Foundation Models Compare to Skeleton-Based Approaches for Gesture Recognition in Human-Robot Interaction?](https://arxiv.org/abs/2506.20795)
*Stephanie Käs,Anton Burenko,Louis Markert,Onur Alp Culha,Dennis Mack,Timm Linder,Bastian Leibe*

Main category: cs.CV

TL;DR: 研究探讨了基于视觉基础模型（VFMs）和视觉语言模型（VLMs）的动态全身手势识别，比较了V-JEPA、Gemini Flash 2.0和HD-GCN的性能，并提出了NUGGET数据集。HD-GCN表现最佳，但V-JEPA接近其性能，展示了简化系统复杂性的潜力。


<details>
  <summary>Details</summary>
Motivation: 在嘈杂环境中，手势识别对非语言人机交互至关重要。传统方法依赖任务特定架构，而VFMs和VLMs的泛化能力可能简化系统设计。

Method: 研究比较了V-JEPA（VFM）、Gemini Flash 2.0（VLM）和HD-GCN（骨架方法）在手势识别中的表现，并使用了NUGGET数据集进行评估。

Result: HD-GCN表现最佳，V-JEPA接近其性能；Gemini在零样本设置中表现不佳，凸显了输入表示的研究需求。

Conclusion: V-JEPA展示了作为共享多任务模型的潜力，而Gemini的局限性表明需要进一步研究手势的输入表示。
...
### [144] [Leveraging Vision-Language Models to Select Trustworthy Super-Resolution Samples Generated by Diffusion Models](https://arxiv.org/abs/2506.20832)
*Cansu Korkmaz,Ahmet Murat Tekalp,Zafer Dogan*

Main category: cs.CV

TL;DR: 本文提出了一种利用视觉语言模型（VLM）从扩散模型生成的超分辨率（SR）图像中选择最可信样本的自动化框架，并通过新颖的信任度评分（TWS）验证其有效性。


<details>
  <summary>Details</summary>
Motivation: 超分辨率问题存在多解性，传统方法在平衡保真度和感知质量时可能引入信息模糊的伪影，而扩散模型生成的多样性样本缺乏可信度评估机制。

Method: 利用VLM（如BLIP-2、GPT-4o）通过结构化查询评估语义正确性、视觉质量和伪影，并设计TWS（结合CLIP嵌入、SSIM和小波分解）量化可靠性。

Result: 实验表明TWS与人类偏好高度相关，VLM引导的选择能稳定获得高TWS值，优于传统指标（如PSNR、LPIPS）。

Conclusion: 该方法为生成式SR提供了可扩展且通用的可信度评估方案，设定了新的可信度基准。
...
### [145] [FixCLR: Negative-Class Contrastive Learning for Semi-Supervised Domain Generalization](https://arxiv.org/abs/2506.20841)
*Ha Min Son,Shahbaz Rezaei,Xin Liu*

Main category: cs.CV

TL;DR: FixCLR是一种半监督领域泛化方法，通过对比学习实现显式领域不变性正则化，提升性能。
...
Method: 引入FixCLR，利用伪标签的类别信息和排斥项，适配对比学习以实现领域不变性正则化。

Result: FixCLR在多种实验中表现优异，尤其与其他半监督方法结合时效果显著。

Conclusion: FixCLR是有效的半监督领域泛化方法，可与其他方法互补提升性能。
...
### [146] [Vector Contrastive Learning For Pixel-Wise Pretraining In Medical Vision](https://arxiv.org/abs/2506.20850)
*Yuting He,Shuo Li*
...
Method: 提出向量对比学习（vector CL），将CL重新定义为向量回归问题，并设计了COVER框架，通过向量金字塔架构实现粒度适应。
...
### [147] [Enhancing Ambiguous Dynamic Facial Expression Recognition with Soft Label-based Data Augmentation](https://arxiv.org/abs/2506.20867)
*Ryosuke Kawamura,Hideaki Hayashi,Shunsuke Otake,Noriko Takemura,Hajime Nagahara*
...
Method: 提出MIDAS，通过软标签和视频帧的凸组合增强训练数据，扩展mixup方法至视频数据。

Result: 在DFEW和FERV39k-Plus数据集上，MIDAS训练模型性能优于现有最优方法。

Conclusion: MIDAS简单高效，显著提升了DFER在模糊表情识别中的表现。
...
### [148] [THIRDEYE: Cue-Aware Monocular Depth Estimation via Brain-Inspired Multi-Stage Fusion](https://arxiv.org/abs/2506.20877)
*Calin Teodor Ioan*

Main category: cs.CV

TL;DR: ThirdEye是一种基于显式单目线索的深度估计方法，通过预训练网络提供线索，并利用三阶段皮层层次结构融合线索，生成高分辨率视差图。
...
Method: ThirdEye通过预训练和冻结的网络提供显式线索，利用三阶段皮层层次结构（V1->V2->V3）和键值工作记忆模块融合线索，并使用自适应分箱变换器生成视差图。

Result: ThirdEye继承了大量外部监督，仅需少量微调，但具体量化结果将在未来版本中公布。
...
### [149] [MultiHuman-Testbench: Benchmarking Image Generation for Multiple Humans](https://arxiv.org/abs/2506.20879)
*Shubhankar Borse,Seokeon Choi,Sunghyun Park,Jeongho Kim,Shreya Kadambi,Risheek Garrepalli,Sungrack Yun,Munawar Hayat,Fatih Porikli*
...
Method: 引入MultiHuman-Testbench基准，提供多样化的文本提示和人脸图像，提出多指标评估方法，并改进ID相似性的技术。

Result: 基准测试和评估方法为多人生成图像研究提供了标准化工具和重要见解。

Conclusion: MultiHuman-Testbench为多人生成图像研究提供了有价值的基准和评估方法，推动了该领域的进展。
...
### [150] [The Role of Cyclopean-Eye in Stereo Vision](https://arxiv.org/abs/2506.20900)
*Sherlon Almeida da Silva,Davi Geiger,Luiz Velho,Moacir Antonelli Ponti*

Main category: cs.CV

TL;DR: 论文探讨了现代立体视觉系统的几何基础，结合3D结构和人类感知改进深度重建，提出新几何约束并评估深度学习特征匹配质量。


<details>
  <summary>Details</summary>
Motivation: 研究立体视觉系统中几何约束和人类感知如何提升深度重建的准确性。
...
### [151] [FaSTA$^*$: Fast-Slow Toolpath Agent with Subroutine Mining for Efficient Multi-turn Image Editing](https://arxiv.org/abs/2506.20911)
*Advait Gupta,Rishie Raj,Dang Nguyen,Tianyi Zhou*

Main category: cs.CV

TL;DR: 提出了一种名为FaSTA$^*$的神经符号代理，结合LLMs的快速高层规划和A$^*$搜索的精确工具使用，以高效完成多轮图像编辑任务。


<details>
  <summary>Details</summary>
Motivation: 解决多轮图像编辑任务的高成本问题，通过结合快速规划和精确工具使用来提高效率。

Method: 结合LLMs的高层规划和A$^*$搜索的局部工具使用，通过归纳推理提取可重用的子程序以减少成本。
...
### [152] [M2SFormer: Multi-Spectral and Multi-Scale Attention with Edge-Aware Difficulty Guidance for Image Forgery Localization](https://arxiv.org/abs/2506.20922)
*Ju-Hyeon Nam,Dong-Hyun Moon,Sang-Chul Lee*

Main category: cs.CV

TL;DR: M2SFormer是一种基于Transformer的框架，通过统一多频率和多尺度注意力，以及利用全局先验图和难度引导注意力模块，显著提升了图像伪造定位的准确性和泛化能力。


<details>
  <summary>Details</summary>
Motivation: 当前深度学习方法在像素级伪造定位中存在计算开销大和表征能力有限的问题，尤其是对细微或复杂篡改的处理不足。

Method: 提出M2SFormer框架，结合多频率和多尺度注意力，并引入全局先验图和难度引导注意力模块以保留细微篡改。
...
### [153] [PhysRig: Differentiable Physics-Based Skinning and Rigging Framework for Realistic Articulated Object Modeling](https://arxiv.org/abs/2506.20936)
*Hao Zhang,Haolan Xu,Chun Feng,Varun Jampani,Narendra Ahuja*
...
<details>
  <summary>Details</summary>
Motivation: 传统LBS方法无法模拟弹性材料（如软组织、毛发等），且存在体积损失和变形不自然的问题。
...
### [154] [AIR-VIEW: The Aviation Image Repository for Visibility Estimation of Weather, A Dataset and Benchmark](https://arxiv.org/abs/2506.20939)
*Chad Mourning,Zhewei Wang,Justin Murray*

Main category: cs.CV

TL;DR: 论文介绍了一个用于航空天气能见度估计的新数据集，并比较了三种常见方法在不同数据集上的表现。


<details>
  <summary>Details</summary>
Motivation: 航空天气能见度估计缺乏公开的大规模数据集，本文旨在填补这一空白。

Method: 通过FAA天气摄像头网络收集数据，并测试三种常见方法和一个基线模型。

Result: 新数据集填补了研究空白，方法表现与ASTM标准进行了比较。

Conclusion: 新数据集和方法为航空天气能见度估计提供了有价值的资源。
...
### [155] [Hierarchical Sub-action Tree for Continuous Sign Language Recognition](https://arxiv.org/abs/2506.20947)
*Dejie Yang,Zhu Xu,Xinjie Gao,Yang Liu*

Main category: cs.CV

TL;DR: 提出了一种名为HST-CSLR的方法，通过结合大语言模型的文本知识和视觉表示学习，改进连续手语识别。


<details>
  <summary>Details</summary>
Motivation: 当前连续手语识别（CSLR）面临数据集不足和标注不精确的问题，且现有方法未充分利用文本知识。

Method: 构建层次子动作树（HST），结合大语言模型的文本知识，逐步对齐视觉和文本模态，并引入对比对齐增强。
...
### [156] [OmniEval: A Benchmark for Evaluating Omni-modal Models with Visual, Auditory, and Textual Inputs](https://arxiv.org/abs/2506.20960)
*Yiman Zhang,Ziheng Luo,Qiangyu Yan,Wei He,Borui Jiang,Xinghao Chen,Kai Han*

Main category: cs.CV

TL;DR: OmniEval是一个用于评估全模态模型（如MiniCPM-O 2.6）的基准测试，涵盖视觉、听觉和文本输入，具有全模态协作、多样化的视频和任务设计。
...
Method: 设计了包含810个音视频同步视频和2617个问题的基准测试，涵盖3大类任务和12个子任务类型。
...
### [157] [Evidence-based diagnostic reasoning with multi-agent copilot for human pathology](https://arxiv.org/abs/2506.20964)
*Chengkuan Chen,Luca L. Weishaupt,Drew F. K. Williamson,Richard J. Chen,Tong Ding,Bowen Chen,Anurag Vaidya,Long Phi Le,Guillaume Jaume,Ming Y. Lu,Faisal Mahmood*

Main category: cs.CV

TL;DR: PathChat+是一种专为病理学设计的多模态大语言模型，通过大量病理学指令样本训练，显著优于现有模型，并结合SlideSeek系统实现自主诊断。
...
Method: 开发PathChat+，训练超过100万病理学指令样本和550万问答对，结合SlideSeek系统进行迭代式分层诊断推理。
...
### [158] [DFVEdit: Conditional Delta Flow Vector for Zero-shot Video Editing](https://arxiv.org/abs/2506.20967)
*Lingling Cai,Kang Zhao,Hangjie Yuan,Xiang Wang,Yingya Zhang,Kejie Huang*

Main category: cs.CV

TL;DR: DFVEdit是一种高效的零样本视频编辑方法，专为Video DiTs设计，避免了注意力修改和微调，通过流变换直接在潜在空间操作，显著提升了计算效率和编辑质量。
...
Method: 提出Conditional Delta Flow Vector (CDFV)和结合Implicit Cross Attention (ICA)与Embedding Reinforcement (ER)，直接在潜在空间通过流变换实现编辑。

Result: DFVEdit在推理速度上提升20倍，内存减少85%，并在多个Video DiTs上达到SOTA性能。

Conclusion: DFVEdit是一种高效、高质量的Video DiTs视频编辑方法，具有广泛适用性。
...
### [159] [From Cradle to Cane: A Two-Pass Framework for High-Fidelity Lifespan Face Aging](https://arxiv.org/abs/2506.20977)
*Tao Liu,Dafeng Zhang,Gengchen Li,Shizhuo Liu,Yongqi Song,Senmao Li,Shiqi Yang,Boqian Li,Kai Wang,Yaxing Wang*

Main category: cs.CV

TL;DR: 提出了一种名为Cradle2Cane的双阶段人脸老化框架，通过自适应噪声注入和身份感知嵌入，解决了年龄准确性与身份一致性之间的权衡问题。
...
### [160] [Segment Anything in Pathology Images with Natural Language](https://arxiv.org/abs/2506.20988)
*Zhixuan Chen,Junlin Hou,Liqi Lin,Yihui Wang,Yequan Bie,Xi Wang,Yanning Zhou,Ronald Cheong Kin Chan,Hao Chen*
...
### [161] [3D Scene-Camera Representation with Joint Camera Photometric Optimization](https://arxiv.org/abs/2506.20979)
*Weichen Dai,Kangcheng Ma,Jiaxin Wang,Kecen Pan,Yuhang Ming,Hua Zhang,Wanzeng Kong*
...
### [162] [Multimodal Prompt Alignment for Facial Expression Recognition](https://arxiv.org/abs/2506.21017)
*Fuyan Ma,Yiran He,Bin Sun,Shutao Li*

Main category: cs.CV

TL;DR: 提出了一种名为MPA-FER的多模态提示对齐框架，用于改进视觉语言模型在面部表情识别中的细粒度文本-视觉关系捕捉。


<details>
  <summary>Details</summary>
Motivation: 当前基于视觉语言模型的面部表情识别方法难以捕捉细粒度的文本-视觉关系，而这对区分细微表情差异至关重要。

Method: 采用多粒度硬提示生成策略，利用大型语言模型生成详细描述，并通过特征差异最小化将外部知识注入软提示。同时，结合原型引导的视觉特征对齐和跨模态全局-局部对齐模块。

Result: 在三个面部表情识别基准数据集上表现优于现有方法，同时保留了预训练模型的优势并降低了计算成本。
...
### [163] [Rethink Sparse Signals for Pose-guided Text-to-image Generation](https://arxiv.org/abs/2506.20983)
*Wenjie Xuan,Jing Zhang,Juhua Liu,Bo Du,Dacheng Tao*
...
Method: 引入忠实性指导以增强输入图像信息的保留，并采用调度策略解决可编辑性与忠实性之间的不对齐问题。
...
### [165] [EVA: Mixture-of-Experts Semantic Variant Alignment for Compositional Zero-Shot Learning](https://arxiv.org/abs/2506.20986)
*Xiao Zhang,Yongqiang Ma,Haodong Jing,Nanning Zheng*

Main category: cs.CV

TL;DR: 论文提出EVA框架，通过多专家模型和语义变体对齐提升组合零样本学习性能。


<details>
  <summary>Details</summary>
Motivation: 现有CZSL方法通过简单组合-原型映射生成特征，忽略了语义子集和组合差异，导致性能不佳。

Method: 提出EVA框架，结合多专家领域适应和语义变体对齐，优化原始表示和图像-组合匹配。

Result: 在三个流行基准测试中，EVA在封闭和开放世界设置下均显著优于现有方法。

Conclusion: EVA通过多专家和语义对齐有效提升CZSL性能，验证了其创新性。
...
### [166] [EgoAdapt: Adaptive Multisensory Distillation and Policy Learning for Efficient Egocentric Perception](https://arxiv.org/abs/2506.21080)
*Sanjoy Chowdhury,Subrata Biswas,Sayan Nag,Tushar Nagarajan,Calvin Murdock,Ishwarya Ananthabhotla,Yijun Qian,Vamsi Krishna Ithapu,Dinesh Manocha,Ruohan Gao*

Main category: cs.CV

TL;DR: EgoAdapt框架通过跨模态蒸馏和策略学习，显著提升了多感知自我中心任务的计算效率。


<details>
  <summary>Details</summary>
Motivation: 现代感知模型计算成本高，难以在资源受限环境中部署。

Method: 提出EgoAdapt框架，结合跨模态蒸馏和任务特定策略学习。

Result: 在多个数据集上，计算量减少89.09%，参数减少82.02%，能耗降低9.6倍，性能仍优于或持平现有模型。

Conclusion: EgoAdapt在高效性和性能之间取得了平衡，适用于多种自我中心任务。
...
### [167] [IPFormer-VideoLLM: Enhancing Multi-modal Video Understanding for Multi-shot Scenes](https://arxiv.org/abs/2506.21116)
*Yujia Liang,Jile Jiao,Zhicheng Wang,Xuetao Feng,Zixuan Ye,Yuan Wang,Hao Lu*

Main category: cs.CV

TL;DR: 论文提出新数据集MultiClip-Bench和新模型IPFormer-VideoLLM，以解决VideoLLMs在多镜头场景中的性能问题。


<details>
  <summary>Details</summary>
Motivation: 现有VideoLLMs在多镜头场景（如不同视角或场景切换）中表现不佳，存在实例身份遗忘和关键帧忽略的问题。
...
### [168] [TSDASeg: A Two-Stage Model with Direct Alignment for Interactive Point Cloud Segmentation](https://arxiv.org/abs/2506.20991)
*Chade Li,Pengju Zhang,Yihong Wu*

Main category: cs.CV

TL;DR: 提出TSDASeg模型，通过两阶段设计和直接跨模态对齐模块，解决3D点云与文本/图像对齐问题，提升交互式分割性能。


<details>
  <summary>Details</summary>
Motivation: 现有方法在点级任务（如分割）中表现不佳，主要因缺乏直接的3D-文本对齐，难以将局部3D特征与文本上下文关联。

Method: TSDASeg结合两阶段模型、直接跨模态对齐模块和记忆模块，通过多专用记忆库存储特征及映射，动态更新场景特征。

Result: 在多个3D数据集上实验，表现优于现有方法，达到最先进性能。

Conclusion: TSDASeg通过直接对齐和动态记忆机制，显著提升了交互式点云分割的准确性和一致性。
...
### [169] [Robust Deep Learning for Myocardial Scar Segmentation in Cardiac MRI with Noisy Labels](https://arxiv.org/abs/2506.21151)
*Aida Moafi,Danial Moafi,Evgeny M. Mirkes,Gerry P. McCann,Abbas S. Alatrany,Jayanth R. Arnold,Mostafa Mehdipour Ghazi*
...
<details>
  <summary>Details</summary>
Motivation: 心肌瘢痕的准确分割对临床评估和治疗规划至关重要，但现有方法面临标签噪声和数据异质性的挑战。

Method: 通过微调先进模型，结合Kullback-Leibler损失和大量数据增强，解决标签噪声、数据异质性和类别不平衡问题。

Result: 模型在急性和慢性病例中表现优异，优于nnU-Net等现有模型，并在分布外测试集上展现强泛化能力。
...
### [170] [Step-by-Step Video-to-Audio Synthesis via Negative Audio Guidance](https://arxiv.org/abs/2506.20995)
*Akio Hayakawa,Masato Ishii,Takashi Shibuya,Yuki Mitsufuji*
...
Conclusion: 该方法在视频到音频生成中表现出色，为高质量音频合成提供了新思路。
...
### [171] [Task-Aware KV Compression For Cost-Effective Long Video Understanding](https://arxiv.org/abs/2506.21184)
*Minghao Qin,Yan Shu,Peitian Zhang,Kun Lun,Huaying Yuan,Juenjie Zhou,Shitao Xiao,Bo Zhao,Zheng Liu*
...
<details>
  <summary>Details</summary>
Motivation: 长视频理解（LVU）对多模态大语言模型（MLLMs）提出了巨大挑战，主要因为高昂的计算成本。现有KV压缩方法在高压缩比下信息损失严重。

Method: Video-X^2L采用双层KV压缩（生成低压缩和高压缩KV）和选择性KV重加载（解码阶段动态选择KV），无需额外训练。

Result: 在多个LVU基准测试中，Video-X^2L显著优于现有KV压缩方法，同时大幅节省计算成本。

Conclusion: Video-X^2L是一种简单有效的方法，能够灵活保留关键视频信息，适用于现有KV可压缩的MLLMs。
...
### [172] [DBMovi-GS: Dynamic View Synthesis from Blurry Monocular Video via Sparse-Controlled Gaussian Splatting](https://arxiv.org/abs/2506.20998)
*Yeon-Ji Song,Jaein Kim,Byung-Ju Kim,Byoung-Tak Zhang*
...
Conclusion: DBMovi-GS为模糊单目视频输入提供了更真实的新视角合成解决方案。
...
### [173] [BitMark for Infinity: Watermarking Bitwise Autoregressive Image Generative Models](https://arxiv.org/abs/2506.21209)
*Louis Kerner,Michel Meintz,Bihe Zhao,Franziska Boenisch,Adam Dziedzic*
...
<details>
  <summary>Details</summary>
Motivation: 随着生成模型输出内容在互联网上的泛滥，这些内容可能被重新用作训练数据，导致模型性能逐渐退化（模型崩溃）。水印技术可以识别生成内容，从而缓解这一问题。

Method: 提出BitMark，通过在Infinity图像生成过程中在位级别嵌入水印，跨多尺度影响比特流，同时保持视觉保真度和生成速度。

Result: BitMark水印具有高放射性，即使水印图像被用于训练其他生成模型，其输出仍会携带水印。

Conclusion: BitMark为解决图像生成模型的模型崩溃问题提供了可靠的方法，能够有效检测生成内容。
...
### [174] [Style-Aligned Image Composition for Robust Detection of Abnormal Cells in Cytopathology](https://arxiv.org/abs/2506.21001)
*Qiuyi Qi,Xin Li,Ming Kong,Zikang Xu,Bingdi Chen,Qiang Zhu,S Kevin Zhou*
...
### [175] [Holistic Surgical Phase Recognition with Hierarchical Input Dependent State Space Models](https://arxiv.org/abs/2506.21330)
*Haoyang Wu,Tsun-Hsuan Wang,Mathias Lechner,Ramin Hasani,Jennifer A. Eckhoff,Paul Pak,Ozanan R. Meireles,Guy Rosman,Yutong Ban,Daniela Rus*
...
Method: 结合局部聚合和全局关系状态空间模块，利用线性扩展特性处理全视频，并采用混合离散-连续监督策略。

Result: 在多个数据集上显著超越现有方法（Cholec80 +2.8%，MICCAI2016 +4.3%，Heichole +12.9%）。

Conclusion: 该方法通过分层状态空间模型有效解决了长时间手术视频分析的效率问题，性能显著提升。
...
### [176] [Inverse Scene Text Removal](https://arxiv.org/abs/2506.21002)
*Takumi Yoshimatsu,Shumpei Takezaki,Seiichi Uchida*

Main category: cs.CV

TL;DR: 本文提出了一种逆向场景文本去除（ISTR）方法，用于检测图像是否经过文本去除处理，并定位被去除的文本区域，同时尝试恢复被去除的文本内容。


<details>
  <summary>Details</summary>
Motivation: 场景文本去除（STR）技术可能被滥用，因此需要一种方法来检测和防止其潜在的不当使用。

Method: 通过逆向分析STR处理后的图像，进行二分类（检测是否经过STR处理）和文本区域定位，并尝试训练文本识别器恢复被去除的文本。

Result: 实验表明，二分类和文本区域定位任务可以达到高精度，同时文本恢复任务展示了其难度。

Conclusion: ISTR方法能够有效检测STR的潜在滥用，并为进一步改进STR技术提供了方向。
...
### [177] [CA-I2P: Channel-Adaptive Registration Network with Global Optimal Selection](https://arxiv.org/abs/2506.21364)
*Zhixin Cheng,Jiacheng Deng,Xinjun Li,Xiaotian Yin,Bohao Liao,Baoqun Yin,Wenfei Yang,Tianzhu Zhang*

Main category: cs.CV

TL;DR: 论文提出了一种改进图像到点云配准的方法，通过CAA和GOS模块解决特征通道注意力差异和冗余对应问题。


<details>
  <summary>Details</summary>
Motivation: 图像和点云特征通道注意力差异导致匹配结果退化，场景中相似结构可能导致冗余对应，影响配准精度。
...
### [178] [VisionGuard: Synergistic Framework for Helmet Violation Detection](https://arxiv.org/abs/2506.21005)
*Lam-Huy Nguyen,Thinh-Phuc Nguyen,Thanh-Hai Nguyen,Gia-Huy Dinh,Minh-Triet Tran,Trung-Nghia Le*
...
Method: 提出VisionGuard框架，结合自适应标签模块（跟踪优化分类）和上下文扩展模块（生成虚拟框解决数据不平衡）。

Result: 实验显示VisionGuard比基线检测器mAP提升3.1%，适用于交通监控系统。

Conclusion: VisionGuard有效提升头盔违规检测性能，有望促进道路安全和法规遵从。
...
### [179] [TITAN: Query-Token based Domain Adaptive Adversarial Learning](https://arxiv.org/abs/2506.21484)
*Tajamul Ashraf,Janibul Bashir*

Main category: cs.CV

TL;DR: 论文提出了一种名为TITAN的方法，用于解决源数据不可用的无监督域自适应目标检测问题，通过分离目标域图像并引入查询令牌对抗模块，显著提升了性能。


<details>
  <summary>Details</summary>
Motivation: 解决在源数据不可用时，现有自监督方法（如学生-教师框架）因伪标签噪声导致性能下降的问题。

Method: 提出TITAN方法，将目标域图像分为易相似和难相似子集，利用检测方差估计分区，并引入查询令牌对抗模块减少域间特征差异。

Result: 在多个数据集上验证，TITAN性能显著优于现有方法，mAP提升最高达22.7%。

Conclusion: TITAN通过优化伪标签生成和域间特征对齐，有效提升了源数据不可用时的目标检测性能。
...
### [180] [Detection of Breast Cancer Lumpectomy Margin with SAM-incorporated Forward-Forward Contrastive Learning](https://arxiv.org/abs/2506.21006)
*Tyler Ward,Xiaoqin Wang,Braxton McFarland,Md Atik Ahamed,Sahar Nozad,Talal Arshad,Hafsa Nebbache,Jin Chen,Abdullah Imran*
...
Method: 结合FFCL预训练策略和SAM模型，通过标注SR图像中的恶性、非恶性组织和病理确认边缘，预训练ResNet-18进行分类，并利用SAM进行精细边缘分割。
...
### [181] [HalluSegBench: Counterfactual Visual Reasoning for Segmentation Hallucination Evaluation](https://arxiv.org/abs/2506.21546)
*Xinzhuo Li,Adheesh Juvekar,Xingyou Liu,Muntasir Wahed,Kiet A. Nguyen,Ismini Lourentzou*

Main category: cs.CV

TL;DR: HalluSegBench是一个新基准，用于评估视觉语言分割模型中的幻觉问题，通过反事实视觉推理揭示模型在视觉驱动幻觉上的显著问题。


<details>
  <summary>Details</summary>
Motivation: 现有评估协议未能充分诊断视觉语言分割模型中的幻觉问题，尤其是视觉驱动的幻觉。

Method: 提出HalluSegBench基准，包含1340个反事实实例对和新的量化指标，用于评估幻觉敏感性。

Result: 实验表明，视觉驱动幻觉比标签驱动更普遍，模型常持续错误分割。

Conclusion: 反事实推理是诊断视觉语言分割模型忠实性的关键。
...
### [182] [The Aging Multiverse: Generating Condition-Aware Facial Aging Tree via Training-Free Diffusion](https://arxiv.org/abs/2506.21008)
*Bang Gong,Luchao Qi,Jiaye Wu,Zhicheng Fu,Chunbo Song,David W. Jacobs,John Nicholson,Roni Sengupta*

Main category: cs.CV

TL;DR: 提出Aging Multiverse框架，通过单张图像生成多种受外部因素（如环境、健康、生活方式）影响的面部老化轨迹，形成老化树。采用无训练扩散方法，平衡身份保留、年龄准确性和条件控制。
...
Result: 实验和用户研究表明，在身份保留、老化真实性和条件对齐方面表现优异，优于现有编辑和年龄进展模型。
...
### [183] [Whole-Body Conditioned Egocentric Video Prediction](https://arxiv.org/abs/2506.21552)
*Yutong Bai,Danny Tran,Amir Bar,Yann LeCun,Trevor Darrell,Jitendra Malik*

Main category: cs.CV

TL;DR: 论文提出了一种通过人体动作预测第一人称视角视频（PEVA）的方法，基于过去的视频和3D身体姿态动作，利用条件扩散变换器进行训练。


<details>
  <summary>Details</summary>
Motivation: 研究动机是探索如何通过物理人体动作模拟第一人称视角下的环境变化，解决复杂现实环境和具身代理行为的建模挑战。

Method: 方法包括基于人体关节层次结构的运动学姿态轨迹条件化，使用自回归条件扩散变换器在Nymeria数据集上进行训练。
...
### [184] [User-in-the-Loop View Sampling with Error Peaking Visualization](https://arxiv.org/abs/2506.21009)
*Ayaka Yasunaga,Hideo Saito,Shohei Mori*
...
<details>
  <summary>Details</summary>
Motivation: 现有方法需要用户通过AR显示对齐3D标注来采集数据，任务繁重且限制场景探索范围。

Method: 利用局部重建光场和可视化误差，引导用户插入新视图以消除误差。

Result: 误差峰值可视化侵入性更低，减少用户失望，且需要更少的视图样本。该方法还可用于更大场景的辐射场重建。

Conclusion: 该方法释放了用户负担，扩展了场景探索能力，并在新视图合成中表现出色。
...
### [185] [Bridging Video Quality Scoring and Justification via Large Multimodal Models](https://arxiv.org/abs/2506.21011)
*Qizhi Xie,Kun Yuan,Yunpeng Qu,Jiachao Gong,Mingda Wu,Ming Sun,Chao Zhou,Jihong Zhu*
...
<details>
  <summary>Details</summary>
Motivation: 传统VQA方法仅生成数值评分，无法描述视频的复杂质量维度，限制了其应用。利用语言输出的优势，通过指令调优的视频大型多模态模型（LMMs）有望解决这一问题。

Method: 提出SIG管道，首先对未标注视频的多维度质量评分，并将评分映射到文本定义的级别，同时引入分层链式思维（CoT）建模维度与整体质量的相关性。

Result: 生成的Score2Instruct（S2I）数据集包含32万多样化的指令-响应对，实验表明该方法显著提升了视频LMMs的质量评分和解释能力。

Conclusion: SIG方法通过自动化数据生成和渐进式调优策略，有效提升了视频LMMs的质量评估能力，为VQA领域提供了新的解决方案。
...
### [186] [FedSC: Federated Learning with Semantic-Aware Collaboration](https://arxiv.org/abs/2506.21012)
*Huan Wang,Haoran Li,Huaming Chen,Jun Yan,Jiahua Shi,Jun Shen*
...
<details>
  <summary>Details</summary>
Motivation: 解决联邦学习中数据异构性问题，特别是客户端间的标签偏好差异，同时利用客户端内部的语义信息。

Method: FedSC通过构建关系原型和一致原型，结合对比学习和正则化策略，优化本地模型训练。

Result: 实验证明FedSC在多种挑战性场景下有效，关键组件显著提升性能。
...
### [187] [HybridQ: Hybrid Classical-Quantum Generative Adversarial Network for Skin Disease Image Generation](https://arxiv.org/abs/2506.21015)
*Qingyue Jiao,Kangyu Zheng,Yiyu Shi,Zhiding Liang*

Main category: cs.CV

TL;DR: 论文提出了一种结合经典与量子计算的生成对抗网络（GAN），用于生成彩色医学图像，解决了现有量子图像生成方法质量低的问题，并在性能和效率上优于传统方法。


<details>
  <summary>Details</summary>
Motivation: 皮肤疾病数据集的类不平衡、隐私问题和对象偏差问题使得数据增强变得必要，而传统生成模型计算资源消耗大，量子图像生成方法又只能生成低质量灰度图像。

Method: 通过一种新颖的经典-量子潜在空间融合技术，开发了首个能够生成彩色医学图像的经典-量子GAN。

Result: 该模型在图像生成质量和分类性能提升上优于传统深度卷积GAN和现有混合经典-量子GAN，且参数和训练周期大幅减少。

Conclusion: 量子图像生成在量子硬件进步下具有广阔前景，模型在真实IBM量子机器上表现出稳健性能。
...
### [188] [LASFNet: A Lightweight Attention-Guided Self-Modulation Feature Fusion Network for Multimodal Object Detection](https://arxiv.org/abs/2506.21018)
*Lei Hao,Lina Xu,Chang Liu,Yanni Dong*

Main category: cs.CV

TL;DR: 提出了一种轻量级注意力引导自调制特征融合网络（LASFNet），通过单一特征级融合单元简化训练过程，显著降低计算成本，同时提升检测精度。
...
Method: 使用单一特征级融合单元，引入注意力引导自调制特征融合模块（ASFF）和轻量级特征注意力转换模块（FATM）。

Result: 在三个数据集上实验表明，参数和计算成本分别减少90%和85%，检测精度（mAP）提升1%-3%。

Conclusion: LASFNet在效率和准确性之间取得了良好平衡，代码已开源。
...
### [189] [Instella-T2I: Pushing the Limits of 1D Discrete Latent Space Image Generation](https://arxiv.org/abs/2506.21022)
*Ze Wang,Hao Chen,Benran Hu,Jiang Liu,Ximeng Sun,Jialian Wu,Yusheng Su,Xiaodong Yu,Emad Barsoum,Zicheng Liu*

Main category: cs.CV

TL;DR: 该论文提出了一种1D二进制图像潜在表示方法，显著减少了图像建模所需的token数量，同时保持了高分辨率细节。
...
Method: 引入1D二进制图像潜在空间，将图像表示为二进制向量序列，取代传统的一热编码token。

Result: 在1024x1024图像上仅需128个离散token，比标准VQ-VAEs减少32倍token数量，训练和推理速度显著提升。

Conclusion: 该方法为图像生成提供了一种高效且可扩展的替代方案，无需私有数据或后训练优化即可达到现代模型的性能。
...
### [190] [DidSee: Diffusion-Based Depth Completion for Material-Agnostic Robotic Perception and Manipulation](https://arxiv.org/abs/2506.21034)
*Wenzhou Lyu,Jialing Lin,Wenqi Ren,Ruihao Xia,Feng Qian,Yang Tang*

Main category: cs.CV

TL;DR: 论文提出了一种基于扩散模型的深度补全框架DidSee，针对非朗伯物体的噪声和不完整深度图问题，通过改进噪声调度器和训练策略，结合语义增强器，实现了高性能的深度补全。


<details>
  <summary>Details</summary>
Motivation: 商用RGB-D相机对非朗伯物体生成的深度图通常噪声大且不完整，传统深度补全方法因训练数据有限而泛化能力差。扩散模型虽有潜力，但存在训练-推理偏差和特征不足的问题。

Method: 提出DidSee框架：1) 使用重新缩放的噪声调度器消除信号泄漏偏差；2) 设计噪声无关的单步训练策略减少误差累积；3) 结合语义增强器实现联合深度补全与语义分割。

Result: DidSee在多个基准测试中达到最优性能，表现出强大的泛化能力，并提升了下游任务（如类别级姿态估计和机器人抓取）的效果。

Conclusion: DidSee通过改进扩散框架和引入语义增强，有效解决了非朗伯物体深度补全的挑战，为实际应用提供了高性能解决方案。
...
### [191] [Boosting Domain Generalized and Adaptive Detection with Diffusion Models: Fitness, Generalization, and Transferability](https://arxiv.org/abs/2506.21042)
*Boyong He,Yuxiang Ji,Zhuoyue Tan,Liaoni Wu*

Main category: cs.CV

TL;DR: 提出一种基于扩散模型的域泛化与适应方法，通过单步扩散提取特征减少推理时间75%，并构建对象中心辅助分支提升性能。


<details>
  <summary>Details</summary>
Motivation: 解决检测器因训练与测试数据域差异导致的性能下降问题，并优化扩散模型在域泛化与适应任务中的应用。

Method: 提取单步扩散中间特征，构建对象中心辅助分支，应用一致性损失对齐分支，并在统一框架中通过特征与对象级对齐提升性能。

Result: 在3个DA和5个DG基准测试中取得竞争性结果，在COCO泛化基准中表现优异。
...
### [192] [Boosting Generative Adversarial Transferability with Self-supervised Vision Transformer Features](https://arxiv.org/abs/2506.21046)
*Shangbo Wu,Yu-an Tan,Ruinan Ma,Wencong Ma,Dehua Zhu,Yuanzhang Li*

Main category: cs.CV

TL;DR: 本文提出了一种基于自监督Vision Transformer（ViT）的双特征攻击方法dSVA，通过结合对比学习（CL）和掩码图像建模（MIM）的特征，显著提升了对抗样本的黑盒迁移能力。
...
Conclusion: 自监督ViT的双特征攻击dSVA在对抗迁移性上表现优异，为对抗攻击提供了新思路。
...
### [193] [Class-Agnostic Region-of-Interest Matching in Document Images](https://arxiv.org/abs/2506.21055)
*Demin Zhang,Jiahao Lyu,Zhijie Shen,Yu Zhou*
...
<details>
  <summary>Details</summary>
Motivation: 现有文档分析方法无法满足用户自定义需求，因此需要一种灵活、多粒度且开放的任务。

Method: 使用视觉提示输入模型，采用孪生网络提取多级特征，并通过交叉注意力层对齐语义。
...
### [194] [SAMURAI: Shape-Aware Multimodal Retrieval for 3D Object Identification](https://arxiv.org/abs/2506.21056)
*Dinh-Khoi Vo,Van-Loc Nguyen,Minh-Triet Tran,Trung-Nghia Le*

Main category: cs.CV

TL;DR: SAMURAI提出了一种结合形状和语言的多模态检索方法，用于在复杂室内环境中基于掩码2D图像和自然语言描述检索3D物体。


<details>
  <summary>Details</summary>
Motivation: 在ROOMELSA挑战中，仅使用掩码2D图像和自然语言描述检索3D物体面临诸多挑战，如缺乏完整3D场景上下文、视角扭曲、模糊语言提示等。

Method: SAMURAI结合了CLIP语义匹配和基于二值轮廓的形状引导重排序，并采用多数投票策略。预处理流程优化掩码质量。
...
### [195] [PoseMaster: Generating 3D Characters in Arbitrary Poses from a Single Image](https://arxiv.org/abs/2506.21076)
*Hongyu Yan,Kunming Luo,Weiyu Li,Yixun Liang,Shengming Li,Jingwei Huang,Chunchao Guo,Ping Tan*
...
### [196] [ESMStereo: Enhanced ShuffleMixer Disparity Upsampling for Real-Time and Accurate Stereo Matching](https://arxiv.org/abs/2506.21091)
*Mahmoud Tahmasebi,Saif Huq,Kevin Meehan,Marion McAfee*

Main category: cs.CV

TL;DR: 提出了一种增强型混洗混合器（ESM），用于解决基于小规模成本体积的立体匹配中的信息丢失问题，实现高精度和实时性能。


<details>
  <summary>Details</summary>
Motivation: 立体匹配在自动驾驶系统中至关重要，但现有方法难以同时实现高精度和实时性能。大规模成本体积计算复杂，小规模则信息不足。

Method: ESM通过将主要特征整合到视差上采样单元中，快速提取初始视差估计的特征并与图像特征融合，通过混洗和分层分割混合特征，再通过紧凑的特征引导沙漏网络细化。
...
### [197] [OracleFusion: Assisting the Decipherment of Oracle Bone Script with Structurally Constrained Semantic Typography](https://arxiv.org/abs/2506.21101)
*Caoshuo Li,Zengmao Ding,Xiaobin Hu,Bang Li,Donghao Luo,AndyPian Wu,Chaoyang Wang,Chengjie Wang,Taisong Jin,SevenShu,Yunsheng Wu,Yongge Liu,Rongrong Ji*
...
Method: 第一阶段使用增强空间感知推理的多模态大语言模型（MLLM）分析字形结构；第二阶段引入甲骨结构向量融合（OSVF），确保生成语义丰富的矢量字体。

Result: OracleFusion在语义、视觉吸引力和字形维护方面优于现有模型，显著提升了可读性和美学质量。
...
### [198] [Pushing Trade-Off Boundaries: Compact yet Effective Remote Sensing Change Detection](https://arxiv.org/abs/2506.21109)
*Luosheng Xu,Dalin Zhang,Zhaohui Song*

Main category: cs.CV

TL;DR: FlickCD是一种轻量级遥感变化检测模型，通过增强差异模块和多尺度特征融合，在减少资源消耗的同时保持高精度。


<details>
  <summary>Details</summary>
Motivation: 现代深度学习模型复杂度高且计算需求大，但精度提升有限。研究旨在开发高效轻量级模型，适用于卫星端处理。

Method: 提出FlickCD，包含增强差异模块（EDM）和局部-全局融合块（SWSA和EGSA），以多尺度捕获语义信息。

Result: 在四个基准数据集上，FlickCD显著减少计算和存储开销，同时达到或接近SOTA性能。
...
### [199] [CL-Splats: Continual Learning of Gaussian Splatting with Local Optimization](https://arxiv.org/abs/2506.21117)
*Jan Ackermann,Jonas Kulhanek,Shengqu Cai,Haofei Xu,Marc Pollefeys,Gordon Wetzstein,Leonidas Guibas,Songyou Peng*
...
Method: CL-Splats利用高斯泼溅技术增量更新3D表示，集成变化检测模块，分离动态与静态部分，实现局部优化。

Result: 实验表明，CL-Splats在高效更新的同时，重建质量优于现有技术。

Conclusion: CL-Splats为实时3D场景重建任务提供了鲁棒基础。
...
### [200] [GoIRL: Graph-Oriented Inverse Reinforcement Learning for Multimodal Trajectory Prediction](https://arxiv.org/abs/2506.21121)
*Muleilan Pei,Shaoshuai Shi,Lu Zhang,Peiliang Li,Shaojie Shen*

Main category: cs.CV

TL;DR: 提出了一种基于图导向逆强化学习（GoIRL）的轨迹预测框架，通过上下文向量化表示和分层轨迹生成器，显著提升了预测性能和泛化能力。


<details>
  <summary>Details</summary>
Motivation: 自动驾驶中周围代理的轨迹预测具有高度不确定性和多模态性，现有数据驱动方法主要依赖监督学习，难以充分捕捉复杂行为模式。

Method: 采用图导向逆强化学习框架，结合特征适配器和分层轨迹生成器，通过最大熵IRL推断奖励分布并生成多模态轨迹。

Result: 在Argoverse和nuScenes基准测试中达到最优性能，并展现出优于现有监督模型的泛化能力。

Conclusion: GoIRL框架通过逆强化学习和分层生成策略，有效解决了轨迹预测中的不确定性和多模态问题，具有广泛的应用潜力。
...
### [201] [Learning to See in the Extremely Dark](https://arxiv.org/abs/2506.21132)
*Hai Jiang,Binhao Guan,Zhen Liu,Xiaohong Liu,Jian Yu,Zheng Liu,Songchen Han,Shuaicheng Liu*
...
### [202] [YOLO-FDA: Integrating Hierarchical Attention and Detail Enhancement for Surface Defect Detection](https://arxiv.org/abs/2506.21135)
*Jiawei Hu*

Main category: cs.CV

TL;DR: YOLO-FDA是一种基于YOLO的检测框架，通过细粒度细节增强和注意力引导特征融合，解决了工业表面缺陷检测中的冗余特征、细节敏感性和多尺度鲁棒性问题。


<details>
  <summary>Details</summary>
Motivation: 工业表面缺陷检测因缺陷类型多样、形状不规则、细粒度要求和复杂纹理而具有挑战性，现有AI检测方法存在冗余特征、细节敏感性不足和多尺度鲁棒性弱的问题。

Method: 提出YOLO-FDA框架，采用BiFPN架构增强多级特征聚合，引入DDFM模块捕捉细粒度结构变化，并提出两种注意力融合策略（AC和CAF）优化上下文表示和减少特征噪声。
...
### [203] [Tree-based Semantic Losses: Application to Sparsely-supervised Large Multi-class Hyperspectral Segmentation](https://arxiv.org/abs/2506.21150)
*Junwen Wang,Oscar Maccormac,William Rochford,Aaron Kujawa,Jonathan Shapey,Tom Vercauteren*
...
Result: 在包含107类的稀疏标注HSI数据集上达到SOTA性能，并能有效检测OOD像素。

Conclusion: 该方法在保持ID像素分割性能的同时，显著提升了OOD像素检测能力。
...
### [204] [Geometry and Perception Guided Gaussians for Multiview-consistent 3D Generation from a Single Image](https://arxiv.org/abs/2506.21152)
*Pufan Li,Bi'an Du,Wei Hu*

Main category: cs.CV

TL;DR: 提出一种新方法，通过几何和感知先验的无缝集成，从单张图像重建高保真3D物体，无需额外训练。


<details>
  <summary>Details</summary>
Motivation: 解决现有方法在多视角一致性和几何细节上的不足，实现更高质量的3D重建。

Method: 训练三个高斯分支（几何先验、感知先验和高斯噪声），通过交互和重投影策略优化3D高斯分支。

Result: 实验表明，该方法在视角合成和3D重建上优于现有方法，生成结果更一致且细节丰富。

Conclusion: 该方法有效提升了单图像3D重建的质量和一致性。
...
### [205] [Topology-Aware Modeling for Unsupervised Simulation-to-Reality Point Cloud Recognition](https://arxiv.org/abs/2506.21165)
*Longkun Zou,Kangjun Liu,Ke Chen,Kailing Guo,Kui Jia,Yaowei Wang*

Main category: cs.CV

TL;DR: 论文提出了一种新的拓扑感知建模（TAM）框架，用于解决3D点云数据中的Sim2Real域适应问题，通过全局空间拓扑和自监督学习任务提升泛化能力。
...
Method: 提出TAM框架，利用全局空间拓扑和局部几何特征的拓扑关系，结合自监督学习任务和自训练策略，减少噪声伪标签的影响。

Result: 在三个Sim2Real基准测试中，TAM框架表现优于现有方法，验证了其有效性。

Conclusion: TAM框架通过拓扑建模和自训练策略，显著提升了Sim2Real域适应的性能，为3D点云处理提供了新思路。
...
### [206] [Out-of-Distribution Semantic Occupancy Prediction](https://arxiv.org/abs/2506.21185)
*Yuheng Zhang,Mengfei Duan,Kunyu Peng,Yuhang Wang,Ruiping Liu,Fei Teng,Kai Luo,Zhiyong Li,Kailun Yang*

Main category: cs.CV

TL;DR: 论文提出了一种针对3D语义占用预测中的分布外（OoD）检测方法，通过合成异常注入和新型框架OccOoD，显著提升了OoD检测性能。


<details>
  <summary>Details</summary>
Motivation: 现有方法集中于分布内场景，对分布外对象和长尾分布敏感，增加了安全隐患。

Method: 提出合成异常集成管道创建数据集VAA-KITTI和VAA-KITTI-360，并开发OccOoD框架，利用Voxel-BEV渐进融合（VBPF）增强OoD检测。

Result: OccOoD在1.2m区域内实现了67.34%的AuROC和29.21%的AuPRCr，同时保持竞争性的占用预测性能。

Conclusion: 该方法显著提升了OoD检测能力，数据集和代码将公开以促进研究。
...
### [207] [GroundFlow: A Plug-in Module for Temporal Reasoning on 3D Point Cloud Sequential Grounding](https://arxiv.org/abs/2506.21188)
*Zijun Lin,Shuting He,Cheston Tan,Bihan Wen*
...
<details>
  <summary>Details</summary>
Motivation: 现有3D视觉定位方法未充分利用文本指令中的时序信息，且无法处理代词依赖的上下文，导致在SG3D任务中表现不佳。
...
### [208] [Unlocking Constraints: Source-Free Occlusion-Aware Seamless Segmentation](https://arxiv.org/abs/2506.21198)
*Yihong Cao,Jiaming Zhang,Xu Zheng,Hao Shi,Kunyu Peng,Hang Liu,Kailun Yang,Hui Zhang*
...
Method: UNLOCK框架包含Omni Pseudo-Labeling Learning和Amodal-Driven Context Learning两个模块，无需源数据或目标标签即可实现分割。

Result: 实验表明，该方法在mAAP和mAP指标上分别达到10.9和11.6，mAPQ比源数据方法提高了4.3。

Conclusion: UNLOCK为全景图像分割提供了一种更实用的解决方案，性能优异且无需依赖源数据。
...
### [209] [MedPrompt: LLM-CNN Fusion with Weight Routing for Medical Image Segmentation and Classification](https://arxiv.org/abs/2506.21199)
*Shadman Sobhan,Kazi Abrar Mahmud,Abduz Zami*
...
Method: 使用LLM（Llama-4-17B）进行任务规划和动态路由，结合模块化CNN（DeepFusionLab）处理图像。

Result: 在19个数据集上表现优异，任务执行正确率达97%，推理延迟2.5秒，分割和分类性能强。
...
### [210] [ReME: A Data-Centric Framework for Training-Free Open-Vocabulary Segmentation](https://arxiv.org/abs/2506.21233)
*Xiwei Xuan,Ziquan Deng,Kwan-Liu Ma*
...
### [211] [Real-Time ESFP: Estimating, Smoothing, Filtering, and Pose-Mapping](https://arxiv.org/abs/2506.21234)
*Qifei Cui,Yuang Zhou,Ruichen Deng*
...
Result: 生成平滑、解剖学合理且噪声低的机械臂轨迹。

Conclusion: ESFP提供了一种高效且实用的方法，将视频动作转化为机械臂控制指令。
...
### [212] [DiMPLe -- Disentangled Multi-Modal Prompt Learning: Enhancing Out-Of-Distribution Alignment with Invariant and Spurious Feature Separation](https://arxiv.org/abs/2506.21237)
*Umaima Rahman,Mohammad Yaqub,Dwarikanath Mahapatra*

Main category: cs.CV

TL;DR: DiMPLe提出了一种新的多模态提示学习方法，通过解耦视觉和语言模态中的不变特征和虚假特征，提升分布外性能。


<details>
  <summary>Details</summary>
Motivation: 多模态学习中虚假相关性会阻碍分布外性能，现有方法仅关注图像特征，DiMPLe通过跨模态解耦特征提升泛化能力。

Method: 结合三个目标：(1)不变与虚假特征互信息最小化，(2)虚假特征正则化，(3)不变特征的对比学习。

Result: 在11个数据集上优于CoOp-OOD，基础类准确率提升15.27，新类准确率提升44.31。

Conclusion: DiMPLe通过解耦多模态特征显著提升了泛化能力和鲁棒性。
...
### [213] [Temporal Rate Reduction Clustering for Human Motion Segmentation](https://arxiv.org/abs/2506.21249)
*Xianghan Meng,Zhengyu Tong,Zhiyuan Huang,Chun-Guang Li*
...
<details>
  <summary>Details</summary>
Motivation: 现有的人体运动分割方法主要基于子空间聚类，假设高维时间数据符合子空间联合分布，但复杂背景下的视频帧可能不符合这一假设，因此需要更有效的方法。

Method: TR²C方法联合学习结构化表示和亲和力，确保表示具有时间一致性并符合子空间联合结构，适用于人体运动分割任务。

Result: 在五个基准数据集上进行了广泛实验，使用不同特征提取器均取得了最先进的性能。

Conclusion: TR²C方法通过结构化表示学习，显著提升了人体运动分割的性能，适用于复杂背景下的视频帧。
...
### [214] [DuET: Dual Incremental Object Detection via Exemplar-Free Task Arithmetic](https://arxiv.org/abs/2506.21260)
*Munish Monga,Vishal Chudasama,Pankaj Wasnik,Biplab Banerjee*
...
<details>
  <summary>Details</summary>
Motivation: 现实世界中的目标检测系统需要同时处理新类别学习和环境变化适应，现有方法（CIOD和DIOD）仅解决单一方面问题，限制了实际应用。

Method: 提出DuET框架，基于任务算术模型合并，结合方向一致性损失，实现无示例的类别和域增量学习。

Result: 在Pascal Series和Diverse Weather Series上，DuET分别实现了+13.12%和+11.39%的RAI提升，同时保持高平均保留指数。

Conclusion: DuIOD和DuET框架有效解决了类别和域增量学习的双重挑战，为实时增量目标检测提供了通用解决方案。
...
### [215] [Video Virtual Try-on with Conditional Diffusion Transformer Inpainter](https://arxiv.org/abs/2506.21270)
*Cheng Zou,Senlin Cheng,Bolei Xu,Dandan Zheng,Xiaobo Li,Jingdong Chen,Ming Yang*

Main category: cs.CV

TL;DR: ViTI提出了一种基于条件视频修复的视频虚拟试穿方法，通过3D时空注意力框架和多阶段训练，显著提升了时空一致性和细节保留。


<details>
  <summary>Details</summary>
Motivation: 现有基于图像的试穿方法在视频中表现不佳，时空一致性差，而现有视频试穿方法仍存在一致性问题。

Method: 将视频虚拟试穿建模为条件视频修复任务，基于Diffusion Transformer构建3D时空注意力框架，采用多阶段训练和掩码策略。

Result: ViTI在定量和定性实验中均优于现有方法，表现出更好的时空一致性和细节保留。

Conclusion: ViTI通过视频生成框架解决了视频试穿的时空一致性问题，为未来研究提供了新思路。
...
### [216] [WordCon: Word-level Typography Control in Scene Text Rendering](https://arxiv.org/abs/2506.21276)
*Wenda Shi,Yiren Song,Zihan Rao,Dengming Zhang,Jiaming Liu,Xingxing Zou*

Main category: cs.CV

TL;DR: 提出了一种文本图像对齐（TIA）框架和WordCon方法，用于精确控制生成图像中的文字排版，提高了效率和可控性。


<details>
  <summary>Details</summary>
Motivation: 解决生成图像中文字级排版控制的难题。

Method: 构建了文字级控制的数据集，提出TIA框架和WordCon方法，结合掩码损失和联合注意力损失。

Result: 在定性和定量上均优于现有技术。

Conclusion: 方法在文字排版控制上表现出色，数据集和代码将公开。
...
### [217] [HumanOmniV2: From Understanding to Omni-Modal Reasoning with Context](https://arxiv.org/abs/2506.21277)
*Qize Yang,Shimin Yao,Weixuan Chen,Shenghao Fu,Detao Bai,Jiaxing Zhao,Boyuan Sun,Bowen Yin,Xihan Wei,Jingren Zhou*
...
<details>
  <summary>Details</summary>
Motivation: 多模态大语言模型在理解人类意图方面存在不足，尤其是全局上下文理解和捷径问题，亟需改进。

Method: 引入上下文奖励、格式奖励、准确性奖励和逻辑奖励，通过强化学习优化模型推理能力，并提出了IntentBench基准测试。
...
### [218] [HieraSurg: Hierarchy-Aware Diffusion Model for Surgical Video Generation](https://arxiv.org/abs/2506.21287)
*Diego Biagini,Nassir Navab,Azade Farshad*

Main category: cs.CV

TL;DR: HieraSurg是一个层次感知的手术视频生成框架，通过两阶段扩散模型实现高质量视频合成，结合手术阶段和分割信息，显著优于现有方法。


<details>
  <summary>Details</summary>
Motivation: 现有手术视频生成方法多为无条件生成，缺乏对手术动作和阶段的语义一致性，难以实现真实模拟。
...
### [219] [Continual Self-Supervised Learning with Masked Autoencoders in Remote Sensing](https://arxiv.org/abs/2506.21312)
*Lars Möllenbrok,Behnood Rasti,Begüm Demir*

Main category: cs.CV

TL;DR: 提出了一种新的持续自监督学习方法CoSMAE，通过数据混合和模型混合知识蒸馏，减少灾难性遗忘，并在实验中优于现有方法。


<details>
  <summary>Details</summary>
Motivation: 解决遥感领域中持续学习需要大量标注数据的问题，提出自监督学习方法以降低成本。

Method: 结合数据混合（保留历史数据分布）和模型混合知识蒸馏（同时利用历史模型和当前模型知识），优化MAE。
...
### [220] [DrishtiKon: Multi-Granular Visual Grounding for Text-Rich Document Images](https://arxiv.org/abs/2506.21316)
*Badri Vishal Kasuba,Parag Chaudhuri,Ganesh Ramakrishnan*

Main category: cs.CV

TL;DR: 提出了一种多粒度视觉定位框架Drishtikon，用于提升多语言文档VQA系统的可解释性和准确性。
...
### [221] [LLaVA-Pose: Enhancing Human Pose and Action Understanding via Keypoint-Integrated Instruction Tuning](https://arxiv.org/abs/2506.21317)
*Dewen Zhang,Tahir Hussain,Wangpeng An,Hayaru Shouno*

Main category: cs.CV

TL;DR: 论文提出了一种通过结合人体关键点与传统视觉特征生成专用视觉语言数据的方法，以提升视觉语言模型在人体姿态和动作任务中的表现。
...
Method: 通过整合人体关键点与视觉特征（如标题和边界框）生成数据集，并构建E-HPAUB基准评估模型性能。

Result: 微调后的LLaVA-Pose模型在基准测试中相比原模型提升了33.2%。

Conclusion: 结合关键点的数据能有效增强多模态模型在人体中心视觉理解任务中的表现。
...
### [222] [PanSt3R: Multi-view Consistent Panoptic Segmentation](https://arxiv.org/abs/2506.21348)
*Lojze Zust,Yohann Cabon,Juliette Marrie,Leonid Antsfeld,Boris Chidlovskii,Jerome Revaud,Gabriela Csurka*

Main category: cs.CV

TL;DR: PanSt3R提出了一种无需测试时优化的统一方法，通过单次前向预测3D几何和多视角全景分割，显著提升了效率和性能。


<details>
  <summary>Details</summary>
Motivation: 现有方法依赖2D全景分割和隐式几何表示，未能充分利用多视角空间关系且计算成本高。

Method: 基于MUSt3R，PanSt3R联合预测3D几何和多视角全景分割，并改进了掩码合并方法。

Result: PanSt3R在多个基准测试中达到最优性能，且速度远超现有方法。

Conclusion: PanSt3R是一种高效、可扩展的解决方案，显著提升了3D场景全景分割的性能和速度。
...
### [223] [Generalizable Neural Electromagnetic Inverse Scattering](https://arxiv.org/abs/2506.21349)
*Yizhe Cheng,Chunxun Tian,Haoru Wang,Wentao Zhu,Xiaoxuan Ma,Yizhou Wang*

Main category: cs.CV

TL;DR: 论文提出了一种基于物理驱动的通用框架，解决电磁逆散射问题（EISP），通过两阶段逆传输-散射过程，利用诱导电流作为中间表示，显著提升了重建精度、泛化能力和鲁棒性。


<details>
  <summary>Details</summary>
Motivation: 电磁逆散射问题在医学成像等应用中至关重要，但传统方法（如Img-Interiors）存在泛化能力差、对稀疏发射器配置敏感等问题。本文旨在通过物理驱动的框架解决这些局限性。

Method: 提出两阶段框架：1）电流估计器学习诱导电流作为入射场与散射场的桥梁；2）介电常数求解器直接从估计的电流计算相对介电常数。框架支持端到端训练和预测。

Result: 实验表明，该方法在重建精度、泛化能力和鲁棒性上优于现有技术，尤其在稀疏发射器配置下表现优异。

Conclusion: 本文为电磁逆散射问题提供了新的物理驱动视角，为低成本电磁成像解决方案迈出了重要一步。
...
### [224] [ShotBench: Expert-Level Cinematic Understanding in Vision-Language Models](https://arxiv.org/abs/2506.21356)
*Hongbo Liu,Jingwen He,Yi Jin,Dian Zheng,Yuhao Dong,Fan Zhang,Ziqi Huang,Yinan He,Yangguang Li,Weichao Chen,Yu Qiao,Wanli Ouyang,Shengjie Zhao,Ziwei Liu*

Main category: cs.CV

TL;DR: ShotBench是一个专为电影语言理解设计的基准测试，包含3.5k专家标注的QA对，评估了24个领先的VLMs，发现其平均准确率不足60%。为解决这一问题，团队构建了ShotQA数据集（70k QA对），并开发了ShotVL模型，显著提升了性能。


<details>
  <summary>Details</summary>
Motivation: 现有视觉语言模型（VLMs）在理解电影语言的细微差别方面表现不足，限制了AI辅助视频生成的精确性。
...
### [225] [CoPa-SG: Dense Scene Graphs with Parametric and Proto-Relations](https://arxiv.org/abs/2506.21357)
*Julian Lorenz,Mrunmai Phatak,Robin Schön,Katja Ludwig,Nico Hörmann,Annemarie Friedrich,Rainer Lienhart*
...
Method: 提出CoPa-SG数据集，包含参数化关系和原型关系，并用于评估场景图生成模型。

Result: 展示了新关系类型如何提升下游应用的规划和推理能力。

Conclusion: CoPa-SG为场景理解提供了更丰富的数据支持和新方法。
...
### [226] [ToosiCubix: Monocular 3D Cuboid Labeling via Vehicle Part Annotations](https://arxiv.org/abs/2506.21358)
*Behrooz Nasihatkon,Hossein Resani,Amirreza Mehrzadian*

Main category: cs.CV

TL;DR: ToosiCubix是一种仅需单目图像和相机内参的3D立方体标注方法，通过少量用户点击和几何约束优化，实现高效且低成本的标注。
...
Method: 通过用户点击标注车辆特征，结合几何约束和优化问题（PnP和最小二乘子问题），利用概率尺寸先验处理模糊性。
...
### [227] [GenFlow: Interactive Modular System for Image Generation](https://arxiv.org/abs/2506.21369)
*Duc-Hung Nguyen,Huu-Phuc Huynh,Minh-Triet Tran,Trung-Nghia Le*
...
<details>
  <summary>Details</summary>
Motivation: 生成艺术需要高级技术知识，限制了其广泛应用。GenFlow旨在降低技术门槛，让更多人能轻松使用生成艺术工具。

Method: GenFlow采用模块化设计，结合节点编辑器与自然语言处理助手，自动化部署流程，减少技术障碍。

Result: 用户研究表明，GenFlow能优化工作流程，缩短任务完成时间，并通过直观界面提升用户体验。

Conclusion: GenFlow为生成艺术领域提供了突破性解决方案，提升了可访问性和效率。
...
### [228] [FastRef:Fast Prototype Refinement for Few-Shot Industrial Anomaly Detection](https://arxiv.org/abs/2506.21398)
*Long Tian,Yufei Li,Yuyang Dai,Wenchao Chen,Xiyang Liu,Bo Chen*

Main category: cs.CV

TL;DR: FastRef是一种高效的原型精炼框架，用于少样本工业异常检测（FS-IAD），通过特征转移和异常抑制两阶段迭代过程提升原型代表性。


<details>
  <summary>Details</summary>
Motivation: 现有方法在数据稀缺环境中未能充分利用查询图像统计信息来增强原型代表性，FastRef旨在解决这一问题。

Method: FastRef采用两阶段迭代过程：1）通过可优化变换矩阵将查询特征转移到原型；2）通过原型对齐实现异常抑制，使用最优传输（OT）技术。

Result: 在四个基准数据集上的实验表明，FastRef在1/2/4-shot设置下均表现出高效性和有效性。

Conclusion: FastRef通过系统性整合查询图像统计信息，显著提升了少样本工业异常检测的性能。
...
### [229] [Curve-Aware Gaussian Splatting for 3D Parametric Curve Reconstruction](https://arxiv.org/abs/2506.21401)
*Zhirui Gao. Renjiao Yi,Yaqiao Dai,Xuening Zhu,Wei Chen,Chenyang Zhu,Kai Xu*
...
<details>
  <summary>Details</summary>
Motivation: 现有两阶段方法存在优化间隙导致的误差累积问题，本文旨在通过一阶段方法直接优化3D参数曲线，提高重建质量和效率。
...
Conclusion: 本文的一阶段方法通过直接优化参数曲线，实现了更高的效率和性能，为3D曲线重建提供了新思路。
...
### [230] [XVerse: Consistent Multi-Subject Control of Identity and Semantic Attributes via DiT Modulation](https://arxiv.org/abs/2506.21416)
*Bowen Chen,Mengyi Zhao,Haomiao Sun,Li Chen,Xu Wang,Kang Du,Xinglong Wu*

Main category: cs.CV

TL;DR: XVerse模型通过将参考图像转换为特定令牌的文本流偏移，实现了对多主题图像生成的高保真和独立控制，显著提升了复杂场景的生成能力。


<details>
  <summary>Details</summary>
Motivation: 现有方法在文本到图像生成中对多主题的精细控制常导致编辑性和一致性下降，且易产生伪影或属性纠缠。

Method: XVerse通过将参考图像转换为令牌特定文本流的偏移量，实现对特定主题的精确独立控制，不干扰图像潜在特征。

Result: XVerse实现了高保真、可编辑的多主题图像合成，并具备对个体主题特征和语义属性的强健控制。

Conclusion: XVerse显著提升了复杂场景和个性化图像的生成能力，解决了现有方法的局限性。
...
### [231] [EndoFlow-SLAM: Real-Time Endoscopic SLAM with Flow-Constrained Gaussian Splatting](https://arxiv.org/abs/2506.21420)
*Taoyu Wu,Yiyi Miao,Zhuoxiao Li,Haocheng Zhao,Kang Dang,Jionglong Su,Limin Yu,Haoang Li*
...
<details>
  <summary>Details</summary>
Motivation: 内窥镜场景中存在非朗伯表面引起的光度不一致性和呼吸导致的动态运动，影响SLAM系统的性能。

Method: 引入光流损失作为几何约束，并提出深度正则化策略以解决光度不一致问题，同时优化3DGS细化策略。

Result: 在静态和动态手术场景中，该方法在视角合成和姿态估计上优于现有方法。

Conclusion: 该方法显著提升了内窥镜场景下3D重建和SLAM系统的性能。
...
### [232] [HyperSORT: Self-Organising Robust Training with hyper-networks](https://arxiv.org/abs/2506.21430)
*Samuel Joutard,Marijn Stollenga,Marc Balle Sanchez,Mohammad Farid Azampour,Raphael Prevost*
...
<details>
  <summary>Details</summary>
Motivation: 医学影像数据中存在多种偏差（如错误标签或不一致的标注风格），这些偏差会降低深度学习分割网络的性能。识别和表征这些偏差是一项复杂且耗时的任务。

Method: HyperSORT使用超网络从代表图像和标注变异的潜在向量中预测UNet参数，并联合学习超网络参数和每个训练样本的潜在向量集合。
...
### [233] [Benchmarking Deep Learning and Vision Foundation Models for Atypical vs. Normal Mitosis Classification with Cross-Dataset Evaluation](https://arxiv.org/abs/2506.21444)
*Sweta Banerjee,Viktoria Weiss,Taryn A. Donovan,Rutger A. Fick,Thomas Conrad,Jonas Ammeling,Nils Porsche,Robert Klopfleisch,Christopher Kaltenecker,Katharina Breininger,Marc Aubreville,Christof A. Bertram*
...
<details>
  <summary>Details</summary>
Motivation: 非典型有丝分裂是肿瘤恶性程度的独立预后标志物，但其识别因低发生率、形态差异小和数据集不平衡而具有挑战性。

Method: 研究比较了基线模型、线性探测的基础模型和LoRA微调的基础模型，并引入了两个新的数据集（AtNorM-Br和AtNorM-MD）进行验证。
...
### [234] [Controllable 3D Placement of Objects with Scene-Aware Diffusion Models](https://arxiv.org/abs/2506.21446)
*Mohamed Omran,Dimitris Kalatzis,Jens Petersen,Amirhossein Habibian,Auke Wiggers*

Main category: cs.CV

TL;DR: 论文提出了一种基于视觉地图和粗略对象掩码的高质量对象放置方法，解决了精确定位和方向控制的挑战。


<details>
  <summary>Details</summary>
Motivation: 现有方法在精确定位和方向控制上存在不足，通常需要复杂的掩码或提示。

Method: 设计了一种结合视觉地图和粗略对象掩码的条件信号，基于修复模型实现背景保留。

Result: 在汽车场景中验证了方法的有效性，实现了高质量的对象放置，包括形状和方向的变化。

Conclusion: 该方法能够精确控制对象的位置和外观，适用于复杂场景中的对象编辑。
...
### [235] [A Comprehensive Dataset for Underground Miner Detection in Diverse Scenario](https://arxiv.org/abs/2506.21451)
*Cyrus Addy,Ajay Kumar Gurumadaiah,Yixiang Gao,Kwame Awuah-Offei*

Main category: cs.CV

TL;DR: 本文提出了一种专门用于矿工检测的热成像数据集，以支持地下采矿环境中的紧急响应能力开发。
...
Method: 通过系统采集各种采矿活动和场景的热成像数据，构建了一个数据集，并评估了多种先进的目标检测算法（如YOLOv8、YOLOv10、YOLO11和RT-DETR）。
...
### [236] [Rethinking Oversaturation in Classifier-Free Guidance via Low Frequency](https://arxiv.org/abs/2506.21452)
*Kaiyu Song,Hanjiang Lai*

Main category: cs.CV

TL;DR: 论文提出了一种基于低频信号的改进方法（LF-CFG），通过自适应阈值减少冗余信息，缓解分类器自由引导（CFG）中的过饱和和不真实伪影问题。
...
Method: 引入自适应阈值测量冗余信息位置，通过分析低频信息变化率确定合理阈值，并采用降权策略减少冗余信息影响。

Result: 实验表明LF-CFG能有效缓解多种扩散模型（如Stable Diffusion-XL等）中的过饱和和伪影问题。

Conclusion: LF-CFG为分类器自由引导提供了一种低频信号改进视角，显著提升了生成质量。
...
### [237] [Evaluation of Traffic Signals for Daily Traffic Pattern](https://arxiv.org/abs/2506.21469)
*Mohammad Shokrolah Shirazi,Hung-Fu Chang*
...
Method: 开发了基于视觉的跟踪系统估计TMC，结合仿真工具SUMO进行信号评估，并提出了动态、静态和混合三种信号配置方法。

Result: 实验表明，90和120秒的信号周期效果最佳；动态配置在四个交叉口表现更好，而混合方法在高峰和非高峰时段适应性更强。

Conclusion: 混合方法在交通分布不均时表现最优，为交通信号设计提供了灵活且高效的解决方案。
...
### [238] [Logios : An open source Greek Polytonic Optical Character Recognition system](https://arxiv.org/abs/2506.21474)
*Perifanos Konstantinos,Goutsos Dionisis*

Main category: cs.CV

TL;DR: 提出一种针对希腊多调文本的OCR系统，结合卷积层和循环层，显著提升识别准确率和效率。


<details>
  <summary>Details</summary>
Motivation: 传统OCR方法在处理希腊多调文本时存在局限性，需改进。

Method: 结合卷积层（特征提取）和循环层（序列学习）设计OCR系统。

Result: 系统在准确率和效率上有显著提升，并开源模型。
...
### [239] [Global and Local Entailment Learning for Natural World Imagery](https://arxiv.org/abs/2506.21476)
*Srikumar Sastry,Aayush Dhakal,Eric Xing,Subash Khanal,Nathan Jacobs*

Main category: cs.CV

TL;DR: 提出了一种名为RCME的框架，通过显式建模传递性强制蕴含，优化视觉-语言模型中概念的偏序关系，提升了层次结构学习性能。


<details>
  <summary>Details</summary>
Motivation: 现有方法未能显式建模蕴含的传递性，限制了视觉-语言模型中层次结构的学习效果。

Method: 引入Radial Cross-Modal Embeddings (RCME)框架，显式建模传递性强制蕴含，优化概念的偏序关系。

Result: 在层次物种分类和层次检索任务中，性能优于现有最先进模型。

Conclusion: RCME框架有效提升了视觉-语言模型中层次结构的学习能力，代码和模型已开源。
...
### [240] [Towards Reliable Detection of Empty Space: Conditional Marked Point Processes for Object Detection](https://arxiv.org/abs/2506.21486)
*Tobias J. Riedlinger,Kira Maag,Hanno Gottschalk*
...
<details>
  <summary>Details</summary>
Motivation: 现有目标检测和分割模型的置信度估计往往不准确，且无法量化未检测区域的不确定性，这在自动驾驶等应用中存在安全隐患。

Method: 提出了一种基于标记点过程的空间统计学框架，通过似然训练提供明确的置信度估计。
...
### [241] [Mitigating Hallucination of Large Vision-Language Models via Dynamic Logits Calibration](https://arxiv.org/abs/2506.21509)
*Jiahe Chen,Jiaying He,Qian Shao,Qiyuan Chen,Jiahe Ying,Hongxia Xu,Jintai Chen,Jianwei Zheng,Jian Wu*

Main category: cs.CV

TL;DR: 论文提出动态对数校准（DLC）方法，通过动态对齐视觉证据减少大视觉语言模型（LVLM）的幻觉问题，提升生成文本的可靠性。
...
Method: DLC在解码阶段利用CLIP评估图像与生成文本的语义对齐，并通过相对视觉优势（RVA）动态调整输出对数，结合自适应权重机制平衡视觉引导与文本质量。
...
### [242] [GGTalker: Talking Head Systhesis with Generalizable Gaussian Priors and Identity-Specific Adaptation](https://arxiv.org/abs/2506.21513)
*Wentao Hu,Shunkai Li,Ziqiao Peng,Haoxian Zhang,Fan Shi,Xiaoqiang Liu,Pengfei Wan,Di Zhang,Hui Tian*
...
<details>
  <summary>Details</summary>
Motivation: 现有方法在固定视角和小规模音频变化下表现良好，但难以处理大角度头部旋转和分布外音频，且需要耗时的身份特定训练。缺乏足够的3D先验限制了合成说话头部的泛化能力。

Method: GGTalker采用两阶段Prior-Adaptation训练策略，学习高斯头部先验并适应个体特征。训练音频-表情和表情-视觉先验以捕捉通用唇动模式和头部纹理分布。在定制适应阶段，精确建模个体说话风格和纹理细节。

Result: GGTalker在渲染质量、3D一致性、唇同步准确性和训练效率方面达到最先进水平。

Conclusion: GGTalker通过结合通用先验和身份特定适应，解决了现有方法的局限性，显著提升了语音驱动3D说话头部的生成质量与泛化能力。
...
### [243] [G$^{2}$D: Boosting Multimodal Learning with Gradient-Guided Distillation](https://arxiv.org/abs/2506.21514)
*Mohammed Rakib,Arunkumar Bagavathi*

Main category: cs.CV

TL;DR: G$^{2}$D是一种知识蒸馏框架，通过动态模态优先级技术解决多模态学习中的模态不平衡问题，提升弱模态的利用率。
...
Result: 在多个数据集上验证，G$^{2}$D提升了弱模态的重要性，性能优于现有方法。
...
### [244] [MADrive: Memory-Augmented Driving Scene Modeling](https://arxiv.org/abs/2506.21520)
*Polina Karpikova,Daniil Selikhanovych,Kirill Struminsky,Ruslan Musaev,Maria Golitsyna,Dmitry Baranchuk*
...
<details>
  <summary>Details</summary>
Motivation: 现有自动驾驶环境重建方法难以支持显著改变或新颖驾驶场景的逼真合成。

Method: 引入MAD-Cars数据集和检索模块，从记忆库中检索相似车辆实例，重建并整合到目标场景中。

Result: 实验证明，替换后的车辆提供了完整的多视角表示，支持显著改变配置的逼真合成。

Conclusion: MADrive框架通过记忆增强技术，提升了场景重建的灵活性和逼真度。
...
### [245] [WAFT: Warping-Alone Field Transforms for Optical Flow](https://arxiv.org/abs/2506.21526)
*Yihan Wang,Jia Deng*

Main category: cs.CV

TL;DR: WAFT是一种简单高效的光流方法，通过高分辨率变形替代成本体积，实现了更高精度和更低内存消耗。
...
Conclusion: WAFT展示了无需成本体积的高性能光流估计潜力，代码和模型已开源。
...
### [246] [Maximal Matching Matters: Preventing Representation Collapse for Robust Cross-Modal Retrieval](https://arxiv.org/abs/2506.21538)
*Hani Alomari,Anushka Sivakumar,Andrew Zhang,Chris Thomas*

Main category: cs.CV

TL;DR: 论文提出了一种改进的跨模态图像文本检索方法，通过最大化嵌入集之间的匹配相似性，结合两种损失函数提升性能。


<details>
  <summary>Details</summary>
Motivation: 传统单向量嵌入方法难以捕捉跨模态的多样关联，而现有集合表示方法存在稀疏监督和集合塌陷问题。
...
### [247] [StruMamba3D: Exploring Structural Mamba for Self-supervised Point Cloud Representation Learning](https://arxiv.org/abs/2506.21541)
*Chuxin Wang,Yixin Zha,Wenfei Yang,Tianzhu Zhang*
...
<details>
  <summary>Details</summary>
Motivation: Mamba方法在点云表示学习中表现出色，但仍存在破坏点邻接性和长序列记忆丢失的问题。

Method: 设计了空间状态代理保留点间空间依赖，增强SSM的状态更新策略，并引入轻量卷积和序列长度自适应策略。

Result: 在四个下游任务中表现优异，ModelNet40准确率达95.1%，ScanObjectNN达92.75%。

Conclusion: StruMamba3D通过改进空间依赖性和序列处理能力，显著提升了点云表示学习性能。
...
### [248] [DeOcc-1-to-3: 3D De-Occlusion from a Single Image via Self-Supervised Multi-View Diffusion](https://arxiv.org/abs/2506.21544)
*Yansong Qu,Shaohui Dai,Xinyang Li,Yuze Wang,You Shen,Liujuan Cao,Rongrong Ji*

Main category: cs.CV

TL;DR: 提出了一种端到端的框架，用于从单张部分遮挡图像生成多视角视图，以改进3D重建质量。
...
Result: 能够从遮挡图像生成六种结构一致的新视角视图，无需先验修复或手动标注。
...
### [249] [SAM4D: Segment Anything in Camera and LiDAR Streams](https://arxiv.org/abs/2506.21547)
*Jianyun Xu,Song Wang,Ziqian Ni,Chunyong Hu,Sheng Yang,Jianke Zhu,Qiang Li*
...
<details>
  <summary>Details</summary>
Motivation: 解决自动驾驶场景中动态变化的多模态数据分割问题，并避免人工标注瓶颈。

Method: 提出统一多模态位置编码（UMPE）和运动感知跨模态记忆注意力（MCMA），并开发多模态自动数据引擎生成伪标签。

Result: 在Waymo-4DSeg数据集上展示了强大的跨模态分割能力和高效的数据标注潜力。

Conclusion: SAM4D在多模态分割和数据标注方面表现出色，具有实际应用潜力。
...
### [250] [SiM3D: Single-instance Multiview Multimodal and Multisetup 3D Anomaly Detection Benchmark](https://arxiv.org/abs/2506.21549)
*Alex Costanzino,Pierluigi Zama Ramirez,Luigi Lella,Matteo Ragaglia,Alessandro Oliva,Giuseppe Lisanti,Luigi Di Stefano*
...
<details>
  <summary>Details</summary>
Motivation: 工业制造中对单实例异常检测的需求，以及现有方法在多视角和多模态信息整合上的不足。

Method: 提出SiM3D基准，包含多模态多视角数据集，采用高分辨率图像和点云数据，并提供手动标注的3D分割真值。

Result: 通过适应单视角方法并评估其在Anomaly Volumes上的性能，建立了多视角3D ADS任务的参考基线。

Conclusion: SiM3D为3D ADS任务提供了首个多模态多视角基准，填补了从合成数据泛化到真实数据的空白。
...
### [251] [Towards Probabilistic Question Answering Over Tabular Data](https://arxiv.org/abs/2506.20747)
...
<details>
  <summary>Details</summary>
Motivation: 现有问答系统（如NL2SQL）在事实性问题表现良好，但在需要不确定性推理的概率性问题上表现不足。

Method: 通过从表格中构建贝叶斯网络，将自然语言查询转化为概率查询，并利用大型语言模型生成最终答案。

Result: 实验结果表明，该方法显著优于基线，展示了符号-神经混合推理的优势。

Conclusion: LUCARIO框架在概率性问答任务中表现出色，证明了结合符号推理和神经方法的有效性。
...
### [252] [Multi-lingual Functional Evaluation for Large Language Models](https://arxiv.org/abs/2506.20793)
*Victor Ojewale,Inioluwa Deborah Raji,Suresh Venkatasubramanian*

Main category: cs.CL

TL;DR: 论文提出了多语言功能基准测试CL-GSM Symbolic和CL-IFEval，通过翻译现有英语基准测试到五种语言，评估大语言模型在多语言环境中的实际表现和鲁棒性。
...
Method: 通过将英语功能基准测试模板翻译为法语、西班牙语、印地语、阿拉伯语和约鲁巴语，创建了多语言功能基准测试CL-GSM Symbolic和CL-IFEval。

Result: 结果显示，某些静态基准测试（如M-MMLU）与功能性能更接近，而模型在不同语言中的鲁棒性差异显著，阿拉伯语和英语表现最稳定。

Conclusion: 多语言功能基准测试能更全面地评估模型的实际表现和鲁棒性，为未来研究提供了更有效的评估工具。
...
### [253] [The Ideation-Execution Gap: Execution Outcomes of LLM-Generated versus Human Research Ideas](https://arxiv.org/abs/2506.20803)
*Chenglei Si,Tatsunori Hashimoto,Diyi Yang*

Main category: cs.CL

TL;DR: 研究发现，尽管LLM生成的研究想法在初期被认为更具新颖性，但实际执行后其评分显著下降，表明LLM生成的想法在执行效果上不如人类专家。
...
Method: 招募43位专家研究人员，随机分配执行LLM生成或人类专家提出的研究想法，并撰写短论文，最后由NLP专家盲审评分。

Result: 执行后，LLM生成的想法在所有评估指标（新颖性、兴奋度、有效性和总体评分）上评分显著下降，甚至在某些指标上人类想法反超。

Conclusion: 当前LLM在生成真正有效的研究想法上存在局限性，且缺乏执行结果的研究想法评估具有挑战性。
...
### [254] [MultiFinRAG: An Optimized Multimodal Retrieval-Augmented Generation (RAG) Framework for Financial Question Answering](https://arxiv.org/abs/2506.20821)
...
<details>
  <summary>Details</summary>
Motivation: 传统LLM和RAG在处理多模态金融文档时存在token限制、布局丢失和跨模态上下文碎片化的问题。

Method: MultiFinRAG通过轻量级多模态LLM提取结构化JSON和文本摘要，结合模态感知检索和动态回退策略实现跨模态推理。

Result: 在涉及文本、表格、图像和多模态推理的复杂金融QA任务中，MultiFinRAG比ChatGPT-4o（免费版）准确率高19个百分点。

Conclusion: MultiFinRAG在商品硬件上实现了高效的多模态金融文档问答，显著优于现有方法。
...
### [255] [Uncovering Hidden Violent Tendencies in LLMs: A Demographic Analysis via Behavioral Vignettes](https://arxiv.org/abs/2506.20822)
...
Method: 使用社会科学工具VBVQ评估LLMs，引入基于人设的提示以评估潜在偏见，并在零样本设置下测试六种LLMs。

Result: LLMs的文本生成与内部暴力偏好不一致，且暴力倾向因人口统计特征而异，与社会科学发现相矛盾。

Conclusion: LLMs在暴力内容处理中存在潜在偏见和局限性，需进一步研究其道德推理能力。
...
### [256] [Decide less, communicate more: On the construct validity of end-to-end fact-checking in medicine](https://arxiv.org/abs/2506.20876)
*Sebastian Joseph,Lily Chen,Barry Wei,Michael Mackert,Iain J. Marshall,Paul Pu Liang,Ramez Kouzy,Byron C. Wallace,Junyi Jessy Li*

Main category: cs.CL

TL;DR: 研究探讨了医学领域自动事实核查系统的挑战，指出其未广泛应用的原因，并建议将其视为交互式沟通问题而非端到端流程。


<details>
  <summary>Details</summary>
Motivation: 由于医学决策的高风险性和医学文献的复杂性，公众对自动事实核查系统的需求增加，但现有系统未得到广泛应用。研究旨在揭示医学事实核查的根本挑战。

Method: 通过分析临床专家如何验证社交媒体上的真实医学声明，研究探讨了医学事实核查的难点。

Result: 研究发现医学事实核查面临三大挑战：声明与临床试验证据的关联困难、声明模糊性与意图不匹配、以及主观的真实性标签。

Conclusion: 研究建议将医学事实核查视为交互式沟通问题，而非端到端流程，以更好地应对其复杂性。
...
### [257] [Optimising Language Models for Downstream Tasks: A Post-Training Perspective](https://arxiv.org/abs/2506.20917)
*Zhengyan Shi*

Main category: cs.CL

TL;DR: 该论文提出了一系列改进语言模型（LM）适应下游任务的方法，包括利用未标注数据的预训练技术、参数高效微调方法、改进的监督微调方法以及新的评估基准，显著提升了LM的鲁棒性、效率和泛化能力。


<details>
  <summary>Details</summary>
Motivation: 尽管语言模型在NLP中表现出色，但其适应特定任务时仍面临效率低、鲁棒性差、计算成本高等问题，限制了其在现实语言任务中的应用。

Method: 1. 从未标注数据中提取任务相关知识；2. 提出参数高效的微调方法；3. 改进监督微调方法；4. 开发新的评估基准。

Result: 这些方法显著提升了语言模型的鲁棒性、效率和泛化能力，使其更适应广泛的应用场景。

Conclusion: 这些进展为实现更鲁棒、高效的语言模型迈出了重要一步，推动了人工通用智能的发展。
...
### [258] [FineWeb2: One Pipeline to Scale Them All -- Adapting Pre-Training Data Processing to Every Language](https://arxiv.org/abs/2506.20920)
*Guilherme Penedo,Hynek Kydlíček,Vinko Sabolčec,Bettina Messmer,Negar Foroutan,Amir Hossein Kargaran,Colin Raffel,Martin Jaggi,Leandro Von Werra,Thomas Wolf*

Main category: cs.CL

TL;DR: 本文提出了一种基于FineWeb的新型多语言预训练数据集构建管道，支持自动适应多种语言，并通过实验验证其性能优于现有数据集。此外，还引入了一种基于重复计数和质量的数据集平衡方法，最终发布了包含1000多种语言的20TB数据集FineWeb2。
...
Method: 设计了一种新的预训练数据集构建管道，支持自动适应多语言，并通过九种语言的实验验证其设计选择。引入了一种基于重复计数和质量的数据集平衡方法。

Result: 实验表明，该管道构建的非英语语料库能训练出性能更优的模型。最终发布了包含1000多种语言的20TB数据集FineWeb2。

Conclusion: 本文提出的管道和方法在多语言预训练数据集构建中表现出色，为多语言LLMs的发展提供了重要支持。
...
### [259] [KaLM-Embedding-V2: Superior Training Techniques and Data Inspire A Versatile Embedding Model](https://arxiv.org/abs/2506.20923)
...
Method: 1. 采用双向Transformer和均值池化生成固定长度嵌入；2. 多阶段训练流程（预训练、微调、参数平均）；3. 引入焦点重加权机制和在线硬负样本混合策略。

Result: 在MTEB中英文评测中显著优于同类模型，性能接近更大规模的模型。

Conclusion: KaLM-Embedding-V2为紧凑型嵌入模型设立了新标准。
...
### [260] [Can Gradient Descent Simulate Prompting?](https://arxiv.org/abs/2506.20989)
...
Method: 提出了一种元训练方法，利用梯度下降更新参数，以LM自身的提示预测为目标，无需真实标签。

Result: 实验显示，梯度更新能部分或完全恢复提示模型的性能，并在特定任务上表现优异。

Conclusion: 结果表明梯度下降具有强大的表达能力，为长上下文建模和梯度学习泛化能力提供了新思路。
...
### [261] [SAC: A Framework for Measuring and Inducing Personality Traits in LLMs with Dynamic Intensity Control](https://arxiv.org/abs/2506.20993)
*Adithya Chittem,Aishna Shrivastava,Sai Tarun Pendela,Jagat Sesh Challa,Dhruv Kumar*

Main category: cs.CL

TL;DR: 论文提出了一种扩展的机器性格清单（MPI），结合16PF模型和特定属性控制（SAC）框架，以实现对大型语言模型（LLM）性格特质的精细控制和动态调整。


<details>
  <summary>Details</summary>
Motivation: 现有LLM性格模型多依赖Big Five框架，性格维度粗糙且缺乏对特质强度的控制机制，限制了模型的表达能力和应用场景。

Method: 扩展MPI以纳入16PF模型，开发SAC框架，通过形容词语义锚定和行为问题动态调整特质强度。

Result: 实验表明，连续强度谱比二元切换更能实现一致且可控的性格表达，且特质强度的变化会系统影响相关特质。

Conclusion: 该方法为LLM提供了更精细的性格控制，推动了人机交互在医疗、教育等领域的应用，迈向更人性化的社交机器。
...
### [262] [Large Language Models Acing Chartered Accountancy](https://arxiv.org/abs/2506.21031)
...
<details>
  <summary>Details</summary>
Motivation: 解决LLMs在特定金融领域知识应用的不确定性，填补印度金融背景下的研究空白。

Method: 使用CA-Ben基准（基于ICAI考试数据）评估六种LLMs，采用标准化协议。

Result: Claude 3.5 Sonnet和GPT-4o表现最佳，数值计算和法律解释存在挑战。

Conclusion: 未来可通过混合推理和检索增强生成方法改进LLMs的定量分析和法律解释能力。
...
### [263] [A Semi-supervised Scalable Unified Framework for E-commerce Query Classification](https://arxiv.org/abs/2506.21049)
...
<details>
  <summary>Details</summary>
Motivation: 电商查询分类任务中，查询短且缺乏上下文，标签信息无法充分利用，现有方法依赖用户点击行为，导致马太效应，且缺乏统一框架。

Method: SSUF框架包含知识增强、标签增强和结构增强模块，分别增强查询表示、减少对后验标签的依赖，并优化标签关系表示。

Result: 离线与在线A/B实验表明，SSUF显著优于现有最先进模型。

Conclusion: SSUF为电商查询分类提供了一种高效、统一的解决方案，解决了信息不足和标签依赖问题。
...
### [264] [MT2-CSD: A New Dataset and Multi-Semantic Knowledge Fusion Method for Conversational Stance Detection](https://arxiv.org/abs/2506.21053)
...
<details>
  <summary>Details</summary>
Motivation: 传统立场检测研究局限于单实例分析，无法建模真实社交媒体中的多轮讨论，缺乏相关数据集阻碍了进展。
...
### [265] [CBF-AFA: Chunk-Based Multi-SSL Fusion for Automatic Fluency Assessment](https://arxiv.org/abs/2506.20243)
...
<details>
  <summary>Details</summary>
Motivation: 自动流利度评估在捕捉非母语者的语音节奏、停顿和不流利方面存在挑战，需要更精细的方法。

Method: 结合多种自监督学习模型（Wav2Vec2、HuBERT、WavLM），采用分块策略和CNN-BiLSTM框架，融合声学和语言特征。

Result: 在Avalinguo和Speechocean762数据集上，F1分数和Pearson相关系数显著提升，优于基线方法。

Conclusion: 分块多自监督学习融合方法对流利度评估有效，但需进一步研究其在非规则韵律方言中的泛化能力。
...
### [266] [DALR: Dual-level Alignment Learning for Multimodal Sentence Representation Learning](https://arxiv.org/abs/2506.21096)
...
<details>
  <summary>Details</summary>
Motivation: 现有方法在图像和文本对齐上过于粗糙，存在跨模态偏差和模态内语义分歧，影响了句子表示的质量。

Method: DALR通过一致性学习模块软化负样本，并利用辅助任务的语义相似性实现细粒度跨模态对齐；同时结合排名蒸馏和全局模态内对齐学习，捕捉更复杂的句子关系。

Result: 在语义文本相似性（STS）和迁移（TR）任务上的实验表明，DALR优于现有基线方法。

Conclusion: DALR通过双层次对齐学习有效提升了多模态句子表示的质量，为相关任务提供了更优的解决方案。
...
### [267] [ComRAG: Retrieval-Augmented Generation with Dynamic Vector Stores for Real-time Community Question Answering in Industry](https://arxiv.org/abs/2506.21098)
...
Result: 在三个工业数据集上，ComRAG在向量相似度上提升25.9%，延迟降低8.7%至23.3%，块增长率从20.23%降至2.06%。

Conclusion: ComRAG显著优于现有基线，适合工业部署，解决了实时社区问答中的知识利用和效率问题。
...
### [268] [Progtuning: Progressive Fine-tuning Framework for Transformer-based Language Models](https://arxiv.org/abs/2506.21119)
*Xiaoshuang Ji,Zhendong Zhao,Xiaojun Chen,Xin Zhao,Zeyao Liu*

Main category: cs.CL

TL;DR: Progtuning是一种结合渐进式学习的新型微调框架，通过逐步减少Transformer块的更新数量，优化资源分配，减少约25%的参数更新，同时保持性能。


<details>
  <summary>Details</summary>
Motivation: 随着模型规模增大，全参数微调成本高昂，现有参数高效微调方法未考虑Transformer块的贡献不均，导致资源分配低效。
...
### [269] [Compressed and Smooth Latent Space for Text Diffusion Modeling](https://arxiv.org/abs/2506.21170)
*Viacheslav Meshchaninov,Egor Chimbulatov,Alexander Shabalin,Aleksandr Abramov,Dmitry Vetrov*

Main category: cs.CL

TL;DR: Cosmos是一种基于扩散模型的新型文本生成方法，通过在压缩的潜在空间中操作，实现了并行生成和高效推理。


<details>
  <summary>Details</summary>
Motivation: 自回归语言模型在文本生成中存在解码速度慢和全局一致性难以保持的问题，扩散模型虽能提供并行生成和灵活控制，但受限于高维度的标记级表示。

Method: Cosmos利用自动编码器在压缩的潜在空间中学习文本表示，同时结合预训练语言编码器的冻结激活，实现语义基础和扰动增强。

Result: 实验表明，Cosmos在保持生成质量的同时，压缩了8倍的文本表示，并在多个生成任务中优于或与现有方法相当，推理速度提升2倍以上。

Conclusion: Cosmos通过压缩潜在空间和并行生成，显著提升了文本生成的效率和性能，为扩散模型在文本生成中的应用提供了新思路。
...
### [270] [Maintaining MTEB: Towards Long Term Usability and Reproducibility of Embedding Benchmarks](https://arxiv.org/abs/2506.21182)
...
<details>
  <summary>Details</summary>
Motivation: 提升MTEB基准测试的工程实践，确保其长期可复现性和可扩展性，以保持其在文本嵌入模型评估中的核心地位。

Method: 采用持续集成管道验证数据集完整性、自动化测试执行和评估结果泛化性，同时设计增强可复现性和可用性的方案。

Result: 成功扩展MTEB，使其更全面且保持质量，为机器学习评估框架的可复现性和可用性提供了实践参考。

Conclusion: 本文为基准测试维护者提供了确保可复现性和可用性的宝贵经验，MTEB的工程实践对领域具有重要参考价值。
...
### [271] [Prompt-Guided Turn-Taking Prediction](https://arxiv.org/abs/2506.21191)
*Koji Inoue,Mikey Elmers,Yahui Fu,Zi Haur Pang,Divesh Lala,Keiko Ochi,Tatsuya Kawahara*

Main category: cs.CL

TL;DR: 提出了一种基于文本提示的动态控制对话轮换预测模型，通过指令（如“更快”或“更平静”）实现直观控制，实验证明其提高了预测准确性并有效调整轮换行为。


<details>
  <summary>Details</summary>
Motivation: 对话系统和机器人需要动态控制对话轮换行为，现有方法缺乏直观的调节手段。

Method: 在基于Transformer的语音活动预测（VAP）模型中引入文本提示嵌入，结合通道内和跨通道Transformer。

Result: 使用950小时对话数据和LLM生成的合成提示，模型提升了预测准确性并能根据提示动态调整轮换行为。

Conclusion: 文本提示控制的模型在对话轮换预测中具有可行性和有效性。
...
### [272] [Enhancing Automatic Term Extraction with Large Language Models via Syntactic Retrieval](https://arxiv.org/abs/2506.21222)
*Yongchan Chun,Minhyuk Kim,Dongjun Kim,Chanjun Park,Heuiseok Lim*

Main category: cs.CL

TL;DR: 本文提出了一种基于检索的提示策略，利用句法相似性而非语义相似性在少样本设置下进行自动术语提取（ATE），并验证了其在领域内和跨领域任务中的有效性。


<details>
  <summary>Details</summary>
Motivation: 尽管大型语言模型（LLMs）在多种NLP任务中表现优异，但其在自动术语提取（ATE）中的应用尚未充分探索。本文旨在探索LLMs在ATE中的潜力，并提出一种更可靠的术语边界捕捉方法。

Method: 提出了一种基于检索的提示策略，通过句法相似性选择示例，而非传统的语义相似性。该方法领域无关，适用于少样本设置。

Result: 在三个专门的ATE基准测试中，句法检索方法显著提高了F1分数，证明了其在领域内和跨领域任务中的有效性。
...
### [273] [Agent-RewardBench: Towards a Unified Benchmark for Reward Modeling across Perception, Planning, and Safety in Real-World Multimodal Agents](https://arxiv.org/abs/2506.21252)
*Tianyi Men,Zhuoran Jin,Pengfei Cao,Yubo Chen,Kang Liu,Jun Zhao*

Main category: cs.CL

TL;DR: 提出了Agent-RewardBench，一个评估多模态大语言模型（MLLMs）奖励建模能力的基准，解决现有代理在自我修正和泛化上的不足。


<details>
  <summary>Details</summary>
Motivation: 多模态代理在现实任务中表现受限，缺乏外部反馈导致自我修正和泛化能力不足，需要专门的奖励模型评估基准。

Method: 设计了Agent-RewardBench，包含多维度评估、步骤级奖励评估和高质量数据采样，覆盖7种场景和10种模型。

Result: 实验表明，即使最先进的多模态模型在奖励建模上表现有限，需专门训练。

Conclusion: Agent-RewardBench为代理奖励建模提供了有效评估工具，凸显了专门训练的必要性。
...
### [274] [Cat and Mouse -- Can Fake Text Generation Outpace Detector Systems?](https://arxiv.org/abs/2506.21274)
*Andrea McGlinchey,Peter J Barclay*

Main category: cs.CL

TL;DR: 研究表明，尽管大型语言模型（LLM）能生成逼真的“假文本”，但简单分类器仍能以较低资源实现较高检测准确率。实验发现，某些模型（如Gemini）在生成欺骗性文本方面有所提升，但检测假文本的可行性可能持续存在。


<details>
  <summary>Details</summary>
Motivation: 探讨大型语言模型生成假文本的能力是否会因模型规模扩大而超越检测器的能力，以及检测假文本的可行性是否会达到瓶颈。

Method: 通过统计分类器检测古典侦探小说风格的假文本，比较不同版本模型（如Gemini和GPT）的生成欺骗性文本能力。

Result: Gemini在0.5版本提升后生成欺骗性文本的能力增强，而GPT未表现出类似趋势。

Conclusion: 即使模型规模不断扩大，检测假文本仍可能可行，但新模型架构可能提升欺骗性。
...
### [275] [Double-Checker: Enhancing Reasoning of Slow-Thinking LLMs via Self-Critical Fine-Tuning](https://arxiv.org/abs/2506.21285)
*Xin Xu,Tianhao Chen,Fan Zhang,Wanlong Liu,Pengxiang Li,Ajay Kumar Jaiswal,Yuchen Yan,Jishan Hu,Yang Wang,Hao Chen,Shiwei Liu,Shizhe Diao,Can Yang,Lu Yin*

Main category: cs.CL

TL;DR: 论文提出了Double-Checker框架，通过自我批判和迭代优化增强慢思考LLMs的推理能力，显著提升了性能。


<details>
  <summary>Details</summary>
Motivation: 慢思考LLMs在生成批判性反馈和优化解决方案方面能力有限，需要一种方法来提升其推理能力。

Method: 通过微调1,730个自我批判实例，Double-Checker框架使LLMs能够在推理过程中迭代批判和优化其输出。
...
### [276] [Small Encoders Can Rival Large Decoders in Detecting Groundedness](https://arxiv.org/abs/2506.21288)
...
<details>
  <summary>Details</summary>
Motivation: LLMs在上下文信息不足时容易产生不可靠的回答，因此需要确保回答的groundedness（基于上下文）。
...
Conclusion: 轻量级模型可以有效替代LLMs进行groundedness检测，节省资源并提高效率。
...
### [277] [Detecting Referring Expressions in Visually Grounded Dialogue with Autoregressive Language Models](https://arxiv.org/abs/2506.21294)
*Bram Willemsen,Gabriel Skantze*

Main category: cs.CL

TL;DR: 本文探讨了仅使用文本的自回归语言模型方法从视觉对话中提取指代表达式的效果，发现仅依赖语言上下文也能有效完成任务，但任务本质是多模态的。
...
Method: 使用预训练的大型语言模型（LLM），通过下一个词预测标注提及范围，采用参数高效微调。
...
### [278] [Structuralist Approach to AI Literary Criticism: Leveraging Greimas Semiotic Square for Large Language Models](https://arxiv.org/abs/2506.21360)
*Fangzhou Dong,Yifan Zeng,Yingpeng Sang,Hong Shen*

Main category: cs.CL

TL;DR: GLASS框架通过Greimas符号学方阵提升大语言模型（LLMs）的文学分析能力，构建首个相关数据集，并验证其高效性。


<details>
  <summary>Details</summary>
Motivation: 解决LLMs在专业文学批评中的不足，尤其是对思想深刻、叙事复杂作品的分析。

Method: 提出GLASS框架，基于Greimas符号学方阵（GSS），构建数据集并设计定量指标。

Result: 框架表现优异，与专家批评对比验证了其高效性，并应用于39部经典作品。
...
### [279] [Leveraging LLM-Assisted Query Understanding for Live Retrieval-Augmented Generation](https://arxiv.org/abs/2506.21384)
*Guanting Dong,Xiaoxi Li,Yuyao Zhang,Mengjie Deng*

Main category: cs.CL

TL;DR: Omni-RAG是一个新框架，旨在提升RAG系统在实时开放领域中的鲁棒性和有效性，通过LLM辅助的查询理解和模块化处理复杂、多意图的查询。
...
Method: Omni-RAG采用三个模块：深度查询理解与分解、意图感知知识检索、以及重排序与生成，分别处理查询预处理、多子查询检索和结果优化。

Result: Omni-RAG能够有效处理复杂和噪声查询，提升RAG系统在实际应用中的表现。

Conclusion: Omni-RAG填补了当前RAG能力与实际需求之间的差距，为实时开放领域应用提供了更强大的支持。
...
### [280] [Domain Knowledge-Enhanced LLMs for Fraud and Concept Drift Detection](https://arxiv.org/abs/2506.21443)
...
<details>
  <summary>Details</summary>
Motivation: 动态平台上语言模式的变化和概念漂移使欺诈对话检测变得困难，LLMs在风险敏感场景中表现不佳。

Method: 提出DK-Enhanced LLM框架，包含三个模块：欺诈检测、漂移检测和漂移分类。
...
### [281] [Text2Cypher Across Languages: Evaluating Foundational Models Beyond English](https://arxiv.org/abs/2506.21445)
...
<details>
  <summary>Details</summary>
Motivation: 现有研究多集中于英语，缺乏对其他语言的评估，本文旨在填补这一空白。

Method: 通过翻译英文问题创建多语言测试集，使用标准化提示和指标评估模型性能。

Result: 模型性能依次为英语最高、西班牙语次之、土耳其语最低，提示翻译影响不大。
...
### [282] [Aligning Spoken Dialogue Models from User Interactions](https://arxiv.org/abs/2506.21463)
...
### [283] [TopK Language Models](https://arxiv.org/abs/2506.21468)
*Ryosuke Takahashi,Tatsuro Inaba,Kentaro Inui,Benjamin Heinzerling*

Main category: cs.CL

TL;DR: 论文提出了一种改进的Transformer架构，通过引入TopK激活函数，解决了稀疏自编码器（SAE）在语言模型解释性中的不足，提升了模型的稳定性和可解释性。
...
Result: TopK语言模型在模型大小、计算效率和可解释性之间取得了良好平衡，保持了原始能力，同时支持神经元干预和跨检查点分析。

Conclusion: TopK语言模型为理解语言模型的学习和概念表示提供了稳定可靠的工具，有望推动模型可解释性和可控性的研究。
...
### [284] [Bridging Offline and Online Reinforcement Learning for LLMs](https://arxiv.org/abs/2506.21495)
*Jack Lanchantin,Angelica Chen,Janice Lan,Xian Li,Swarnadeep Saha,Tianlu Wang,Jing Xu,Ping Yu,Weizhe Yuan,Jason E Weston,Sainbayar Sukhbaatar,Ilia Kulikov*

Main category: cs.CL

TL;DR: 研究比较了强化学习方法在大型语言模型微调中的效果，发现在线和半在线方法表现相似且优于离线方法，多任务学习能提升性能。


<details>
  <summary>Details</summary>
Motivation: 探讨强化学习方法在不同训练模式（离线、半在线、在线）下对可验证和不可验证任务的效果。

Method: 比较在线和半在线直接偏好优化与组奖励策略优化目标，分析训练动态和超参数选择策略。

Result: 在线和半在线方法表现相似且优于离线方法，多任务学习能提升性能。

Conclusion: 在线和半在线方法在微调中表现优异，多任务学习有助于提升任务性能。
...
### [285] [Enhancing User Engagement in Socially-Driven Dialogue through Interactive LLM Alignments](https://arxiv.org/abs/2506.21497)
*Jiashuo Wang,Kaitao Song,Chunpu Xu,Changhe Song,Yang Xiao,Dongsheng Li,Lili Qiu,Wenjie Li*

Main category: cs.CL

TL;DR: 该论文提出了一种通过交互式LLMs学习用户参与度的方法，利用未来对话发展的信号作为奖励，并通过i×MCTS和DPO优化模型。


<details>
  <summary>Details</summary>
Motivation: 现有方法在社交驱动对话中未能明确保证用户参与度，因此需要更直接的指标来优化交互式LLMs。

Method: 采用用户反应作为奖励信号，使用i×MCTS模拟用户交互并收集数据，通过DPO对齐模型。

Result: 在情感支持和说服对话场景中，该方法显著提升了用户参与度。

Conclusion: 通过直接优化用户参与度指标，交互式LLMs在社交对话中表现更优。
...
### [286] [skLEP: A Slovak General Language Understanding Benchmark](https://arxiv.org/abs/2506.21508)
*Marek Šuppa,Andrej Ridzik,Daniel Hládek,Tomáš Javůrek,Viktória Ondrejová,Kristína Sásiková,Martin Tamajka,Marián Šimko*

Main category: cs.CL

TL;DR: 介绍了首个针对斯洛伐克自然语言理解（NLU）模型的综合基准skLEP，包含九种任务，评估模型能力。


<details>
  <summary>Details</summary>
Motivation: 填补斯洛伐克NLU评估资源的空白，促进相关研究。

Method: 结合新数据集和翻译的英语资源，构建skLEP基准，并评估多种预训练模型。

Result: 发布了完整的基准数据、开源工具包和公开排行榜。

Conclusion: skLEP有望推动斯洛伐克NLU研究的可重复性和未来发展。
...
### [287] [Potemkin Understanding in Large Language Models](https://arxiv.org/abs/2506.21521)
*Marina Mancoridis,Bec Weeks,Keyon Vafa,Sendhil Mullainathan*

Main category: cs.CL

TL;DR: 论文探讨了基于基准测试评估大型语言模型（LLM）能力的合理性，提出了量化模型“虚假理解”的方法，并发现这种现象普遍存在。


<details>
  <summary>Details</summary>
Motivation: 质疑通过基准测试评估LLM能力的有效性，因为模型可能在表面上回答问题，但实际缺乏与人类相似的理解。

Method: 引入一个形式化框架，设计两种量化方法：一种基于特定领域的基准测试，另一种提供普遍性的下限估计。

Result: 发现“虚假理解”现象在模型、任务和领域中普遍存在，且反映了概念表征的内部不一致性。

Conclusion: 基准测试可能无法真实反映LLM的理解能力，需要更深入的方法评估模型的内在一致性。
...
### [288] ["What's Up, Doc?": Analyzing How Users Seek Health Information in Large-Scale Conversational AI Datasets](https://arxiv.org/abs/2506.21532)
*Akshay Paruchuri,Maryam Aziz,Rohit Vartak,Ayman Ali,Best Uchehara,Xin Liu,Ishan Chatterjee,Monica Agrawal*

Main category: cs.CL

TL;DR: 论文分析了11K真实世界对话数据集HealthChat-11K，研究了用户如何通过LLMs获取医疗信息，揭示了常见交互模式、不完整上下文、情感行为等问题。
...
Method: 通过筛选大规模对话AI数据集构建HealthChat-11K，结合临床驱动的分类法分析21个医疗领域的用户交互。

Result: 发现用户交互模式、不完整上下文、情感行为及可能导致谄媚的提问方式，突显LLMs在医疗支持方面的改进需求。

Conclusion: LLMs作为医疗对话AI需进一步优化以提升支持能力。
...
### [289] [Data Efficacy for Language Model Training](https://arxiv.org/abs/2506.21545)
*Yalun Dai,Yangyu Huang,Xin Zhang,Wenshan Wu,Chong Li,Wenhui Lu,Shijie Cao,Li Dong,Scarlett Li*

Main category: cs.CL

TL;DR: 论文提出了一种名为DELT的通用范式，通过优化训练数据的组织（数据效能）来提升语言模型性能，包括数据评分、选择和排序三个组件。实验表明，DELT在不增加数据量和模型规模的情况下显著提升了模型性能。


<details>
  <summary>Details</summary>
Motivation: 当前研究主要集中在数据效率（如数据过滤和选择），而数据效能（即数据组织的优化）尚未充分探索。本文旨在填补这一空白，通过优化数据组织提升模型性能。

Method: 提出了DELT范式，包含数据评分（如LQS）、数据选择和数据排序（如FO）。LQS从梯度一致性角度评估数据的可学习性和质量，FO则解决模型遗忘和数据分布偏差问题。

Result: 实验表明，DELT的各个组件均能不同程度提升模型性能，其中LQS和FO的组合效果最佳。数据效能与数据效率可结合使用。

Conclusion: 数据效能是语言模型训练中一个具有潜力的研究方向，DELT为优化数据组织提供了有效框架。
...
### [290] [IMA-Catcher: An IMpact-Aware Nonprehensile Catching Framework based on Combined Optimization and Learning](https://arxiv.org/abs/2506.20801)
*Francesco Tassi,Jianzhuang Zhao,Gustavo J. G. Lahr,Luna Gava,Marco Monforte,Arren Glover,Chiara Bartolozzi,Arash Ajoudani*

Main category: cs.RO

TL;DR: 论文提出了一种隐式感知冲击的框架，用于机器人在飞行物体捕捉任务中减少冲击力，分前捕捉和后捕捉两阶段优化轨迹和能量耗散。
...
Method: 前捕捉阶段通过实时最优规划器生成轨迹以减少速度差异；后捕捉阶段基于人类演示生成轨迹以平滑耗散能量。使用分层二次规划控制器确保约束。

Result: 实验表明，无速度匹配时任务不可行；反射质量最小化增加了方法的鲁棒性，并在多轴捕捉中验证了泛化能力。

Conclusion: 提出的框架有效减少了捕捉时的冲击力，提高了任务的可行性和鲁棒性。
...
### [291] [Online Planning for Cooperative Air-Ground Robot Systems with Unknown Fuel Requirements](https://arxiv.org/abs/2506.20804)
*Ritvik Agarwal,Behnoushsadat Hatami,Alvika Gautam,Parikshit Maini*

Main category: cs.RO

TL;DR: 提出了一种在线燃料约束无人机路径规划方法，结合地面移动加油站的动态调整策略。
...
### [292] [Model-Based Real-Time Pose and Sag Estimation of Overhead Power Lines Using LiDAR for Drone Inspection](https://arxiv.org/abs/2506.20812)
...
Method: 提出一种估计方法，通过最小化LiDAR测量与整体导体阵列几何模型的误差，而非单独跟踪每根导体。

Result: 实验表明，该方法在部分观测、噪声和异常值下仍能实现准确跟踪，求解器每帧收敛时间低于50毫秒，且对异常值的容忍度是有效测量的两倍。

Conclusion: 该方法在复杂环境下表现出鲁棒性和高效性，适用于无人机电力线检测。
...
### [293] [Cooperative Circumnavigation for Multi-Quadrotor Systems via Onboard Sensing](https://arxiv.org/abs/2506.20954)
...
<details>
  <summary>Details</summary>
Motivation: 解决多四旋翼系统在视觉遮挡环境下对移动目标的协同跟踪问题，提升搜索与救援任务的鲁棒性。

Method: 采用异构感知策略和状态估计算法，开发改进的卡尔曼滤波融合视觉-惯性里程计与距离测量，设计事件触发的分布式卡尔曼滤波实现目标状态估计。

Result: 通过室内外实验验证了框架在遮挡环境下的高效性，并展示了其固有的容错特性。

Conclusion: 该框架在搜索与救援等实际应用中具有潜在价值。
...
### [294] [Parallels Between VLA Model Post-Training and Human Motor Learning: Progress, Challenges, and Trends](https://arxiv.org/abs/2506.20966)
...
Method: 通过人类运动学习视角，提出了环境感知、本体意识、任务理解和多组件整合四个维度的后训练分类法。

Result: 总结了当前VLA模型后训练方法，并建立了指导未来研究的框架。

Conclusion: 本文为VLA模型的后训练提供了全面视角和实践指导，推动了相关研究的发展。
...
### [295] [Fault-Tolerant Spacecraft Attitude Determination using State Estimation Techniques](https://arxiv.org/abs/2506.21016)
...
<details>
  <summary>Details</summary>
Motivation: 研究不同滤波器在卫星姿态估计中的表现，以及如何应对传感器测量中的故障。

Method: 使用扩展卡尔曼滤波、无迹卡尔曼滤波和粒子滤波，分析其在低地球轨道卫星中的性能，并探讨故障检测与恢复技术。

Result: 得出不同滤波器在多种故障模式下的性能表现。

Conclusion: 扩展卡尔曼滤波、无迹卡尔曼滤波和粒子滤波为卫星姿态估计提供了鲁棒框架，故障检测与恢复技术能有效应对传感器故障。
...
### [296] [ThermalDiffusion: Visual-to-Thermal Image-to-Image Translation for Autonomous Navigation](https://arxiv.org/abs/2506.20969)
...
<details>
  <summary>Details</summary>
Motivation: 热成像相机在夜间或恶劣环境下（如雾、灰尘）能提供有价值的信息，但现有数据集缺乏热成像数据，限制了其在机器人领域的应用。

Method: 使用条件扩散模型，通过自注意力机制学习真实物体的热特性，将现有RGB图像转换为热成像图像。

Result: 提出的方法能够生成合成热成像数据，填补现有数据集的不足。

Conclusion: 通过合成热成像数据，可以加速热成像相机在机器人领域的应用。
...
### [297] [Active Disturbance Rejection Control for Trajectory Tracking of a Seagoing USV: Design, Simulation, and Field Experiments](https://arxiv.org/abs/2506.21265)
...
<details>
  <summary>Details</summary>
Motivation: 解决无人水面艇（USV）在波浪和洋流等环境干扰下的轨迹跟踪控制问题。

Method: 采用主动抗扰控制（ADRC）设计控制器，并通过仿真和实地测试（港口和海上）验证性能。
...
### [298] [STEP Planner: Constructing cross-hierarchical subgoal tree as an embodied long-horizon task planner](https://arxiv.org/abs/2506.21030)
...
<details>
  <summary>Details</summary>
Motivation: LLM在长时程任务规划中成功率低，需要改进。

Method: 构建子目标树，结合分解模型和终止模型，形成分层结构。

Result: 在VirtualHome WAH-NL和真实机器人实验中，成功率分别达到34%和25%。
...
TL;DR: V2X-REALM是一种基于视觉语言模型的框架，用于解决自动驾驶在长尾场景中的鲁棒性问题，通过自适应多模态学习和创新模块提升性能。
...
Conclusion: V2X-REALM推动了端到端协作自动驾驶的可扩展性，提升了复杂驾驶条件下的性能。
...
### [300] [Knowledge-Driven Imitation Learning: Enabling Generalization Across Diverse Conditions](https://arxiv.org/abs/2506.21057)
*Zhuochen Miao,Jun Lv,Hongjie Fang,Yang Jin,Cewu Lu*

Main category: cs.RO

TL;DR: 提出了一种知识驱动的模仿学习框架，通过外部语义知识抽象同类物体的表示，显著提升了机器人操作的泛化能力。
...
Method: 引入语义关键点图作为知识模板，开发了从粗到细的模板匹配算法，优化结构一致性和语义相似性。

Result: 在三个真实机器人操作任务中表现优异，仅需四分之一的专家演示即超越基于图像的扩散策略。

Conclusion: 该工作开创了知识驱动的数据高效学习方法，适用于真实场景。代码和材料已公开。
...
### [301] [Control of Marine Robots in the Era of Data-Driven Intelligence](https://arxiv.org/abs/2506.21063)
*Lin Hong,Lu Liu,Zhouhua Peng,Fumin Zhang*

Main category: cs.RO

TL;DR: 综述了数据驱动智能在海洋机器人控制中的最新进展，总结了开源资源并展望了未来研究方向。


<details>
  <summary>Details</summary>
Motivation: 传统模型控制方法在海洋机器人非线性动态和复杂环境中的局限性促使转向数据驱动智能控制。

Method: 回顾了数据驱动控制在个体和协作海洋机器人系统中的成就，并总结了相关开源资源。

Result: 展示了数据驱动控制在海洋机器人领域的潜力和当前进展。

Conclusion: 提出了未来研究方向，旨在实现海洋机器人在实际应用中的高级自主性。
...
### [302] [CURL-SLAM: Continuous and Compact LiDAR Mapping](https://arxiv.org/abs/2506.21077)
...
Method: 利用CURL的球形谐波隐式编码，将LiDAR姿态估计优化问题扩展到局部Bundle Adjustment，实现姿态优化和地图校正。
...
### [303] [UAIbot: Beginner-friendly web-based simulator for interactive robotics learning and research](https://arxiv.org/abs/2506.21178)
...
<details>
  <summary>Details</summary>
Motivation: 传统模拟平台通常存在安装复杂、使用门槛高等问题，UAIbot通过提供Python和JavaScript接口，使学习体验更便捷。

Method: UAIbot通过交互式探索数学和物理原理（如机械臂运动学和行人流动力学）来实现其目标。

Result: UAIbot成为深化学生理解、快速实验和促进研究传播的有效工具。
...
### [304] [Dynamic Risk-Aware MPPI for Mobile Robots in Crowds via Efficient Monte Carlo Approximations](https://arxiv.org/abs/2506.21205)
*Elia Trevisan,Khaled A. Mustafa,Godert Notten,Xinwei Wang,Javier Alonso-Mora*

Main category: cs.RO

TL;DR: 提出了一种动态风险感知的模型预测路径积分控制（DRA-MPPI），用于实时处理机器人运动规划中的不确定性轨迹预测。


<details>
  <summary>Details</summary>
Motivation: 传统方法难以处理非高斯随机预测和实时约束下的运动规划问题。

Method: 利用MPPI的无梯度特性，通过蒙特卡洛方法高效近似多动态障碍物的联合碰撞概率（CP），并基于CP阈值或加权目标优化轨迹。

Result: DRA-MPPI在真实和模拟实验中表现优于现有方法，如S-MPC、Frenet规划和原始MPPI。

Conclusion: DRA-MPPI有效解决了机器人冻结问题并提高了安全性。
...
### [305] [ACTLLM: Action Consistency Tuned Large Language Model](https://arxiv.org/abs/2506.21250)
...
Result: 在多样化场景中表现出色，有效解决基于视觉的机器人操作任务。
...
### [306] [Real-time Terrain Analysis for Off-road Autonomous Vehicles](https://arxiv.org/abs/2506.21347)
...
<details>
  <summary>Details</summary>
Motivation: 解决自动驾驶车辆在路面不平情况下可能出现的路线偏离和路面接触问题。

Method: 采用贝叶斯校准方法，结合高斯过程代理模型和半车辆模型，实时估计路面粗糙度，并与Simplex控制器集成动态调整车速。

Result: 实验证明系统能实时准确预测路面粗糙度，并通过动态控制策略提升车辆安全性。

Conclusion: 该贝叶斯框架为自动驾驶车辆提供了高效且安全的解决方案，降低了路面不平带来的操作风险。
...
### [307] [WorldVLA: Towards Autoregressive Action World Model](https://arxiv.org/abs/2506.21539)
...
TL;DR: WorldVLA是一个自回归动作世界模型，整合了视觉-语言-动作（VLA）模型与世界模型，通过动作和图像理解预测未来图像，并生成后续动作。实验表明其优于独立模型，但自回归动作生成存在误差传播问题，提出注意力掩码策略以改善性能。
...
Method: 整合VLA模型与世界模型，利用动作和图像理解预测未来图像，生成后续动作；提出注意力掩码策略以减少自回归动作生成中的误差传播。

Result: WorldVLA优于独立模型，但自回归动作生成性能下降；注意力掩码策略显著提升动作块生成任务性能。
...
### [308] [Distributed Lyapunov Functions for Nonlinear Networks](https://arxiv.org/abs/2506.20728)
*Yiming Wang,Arthur N. Montanari,Adilson E. Motter*

Main category: eess.SY

TL;DR: 提出了一种基于局部信息的分布式方法，用于构建Lyapunov函数，以解决高维非线性网络中多稳态吸引域（ROAs）的复杂形态问题。


<details>
  <summary>Details</summary>
Motivation: 高维非线性网络的多稳态吸引域形态复杂，传统优化方法难以自动构建Lyapunov函数。

Method: 通过局部信息构建部分Lyapunov函数，利用增强比较引理和SOS优化迭代聚合为复合Lyapunov函数。

Result: 复合函数能准确近似高维非凸吸引域的体积和形状，并在van der Pol和Ising振荡器网络中验证了有效性。

Conclusion: 该方法为高维非线性系统的吸引域分析提供了有效工具。
...
### [309] [Noise-Tolerant Hybrid Approach for Data-Driven Predictive Control](https://arxiv.org/abs/2506.20780)
*Mahmood Mazare,Hossein Ramezani*

Main category: eess.SY

TL;DR: 提出了一种噪声容忍的数据驱动预测控制框架（NTDPC），通过奇异值分解在降阶Hankel矩阵中分离系统动态与噪声，提高了预测精度和计算效率。
...
Method: 集成奇异值分解技术，分离系统动态与噪声，并引入灵敏度指数支持不同噪声水平下的数据范围选择。

Result: 仿真结果表明，相比现有混合方法，NTDPC框架具有更高的鲁棒性和效率。

Conclusion: NTDPC框架有效解决了噪声对预测控制的影响，适用于更短数据范围和更低计算成本的应用场景。
...
### [310] [DPLib: A Standard Benchmark Library for Distributed Power System Analysis and Optimization](https://arxiv.org/abs/2506.20819)
*Milad Hasanzadeh,Amin Kargarian*

Main category: eess.SY

TL;DR: DPLib是一个开源的MATLAB基准库，用于支持分布式和去中心化电力系统分析与优化的研究，填补了现有工具的空白。
...
Method: DPLib提供20多个多区域基准测试案例和基于图的分区工具，将MATPOWER系统分解为多个电气一致区域，并提供分布式OPF求解器。

Result: 生成的测试案例通过数值结果验证，为可重复的分布式电力系统研究奠定了基础。

Conclusion: DPLib填补了分布式电力系统研究工具的空白，为未来研究提供了标准化支持。
...
### [311] [Resilience Through Escalation: A Graph-Based PACE Architecture for Satellite Threat Response](https://arxiv.org/abs/2506.20882)
*Anouar Boumeftah,Sarah McKenzie-Picot,Peter Klimas,Gunes Karabulut Kurt*

Main category: eess.SY

TL;DR: 论文提出了一种基于PACE方法的卫星系统韧性设计框架，通过动态韧性指数和三种决策模型评估系统在干扰下的表现。


<details>
  <summary>Details</summary>
Motivation: 传统冗余策略难以应对动态多向量威胁，需开发更有效的韧性设计方法。

Method: 采用PACE方法论，结合威胁评分框架（如CVSS、DREAD等），设计静态、自适应和softmax决策模型。

Result: 轻量级决策感知回退机制显著提升卫星系统的生存能力和运行连续性。

Conclusion: PACE框架为下一代空间资产提供了有效的韧性设计解决方案。
...
### [312] [Optimal Parameter Design for Power Electronic Converters Using a Probabilistic Learning-Based Stochastic Surrogate Model](https://arxiv.org/abs/2506.20987)
*Akash Mahajan,Shivam Chaturvedi,Srijita Das,Wencong Su,Van-Hai Bui*

Main category: eess.SY

TL;DR: 本文提出了一种基于概率学习的随机替代建模框架，用于优化电力电子转换器的设计参数，显著减少设计时间，并提高效率和热约束的平衡。


<details>
  <summary>Details</summary>
Motivation: 电力电子转换器的设计需要在效率和热约束之间找到平衡，以确保高性能且不牺牲安全性。传统方法耗时且难以满足需求，因此需要一种更高效的方法。

Method: 采用神经网络分类器筛选可行参数配置，结合概率预测模型评估效率和温度，并使用启发式优化模型优化多目标函数。

Result: 该方法在预测准确性和优化结果上显著优于遗传算法、粒子群优化等传统算法。

Conclusion: 该框架为电力电子设计提供了高效、可靠的解决方案，显著提升了设计效率和性能。
...
### [313] [Coordinated Control of Autonomous Vehicles for Traffic Density Reduction at a Signalized Junction: An MPC Approach](https://arxiv.org/abs/2506.21302)
*Rudra Sen,Subashish Datta*

Main category: eess.SY

TL;DR: 提出了一种双模模型预测控制（MPC）架构，用于优化信号灯路口的交通密度和高密度交通下的协作换道，提升城市交通效率与安全性。


<details>
  <summary>Details</summary>
Motivation: 随着城市交通系统的快速发展，如何有效且安全地管理交通成为关键问题。联网自动驾驶车辆（CAVs）的互联能力为交通流优化和协调提供了新机会。

Method: 采用双模MPC架构，结合在线计算的最大控制不变终端集，解决信号灯路口交通密度和高密度交通下的协作换道问题。

Result: 通过数值模拟验证了所提方法的有效性，确保了递归可行性和收敛性。

Conclusion: 该方法为CAVs提供了响应式决策支持，显著提升了城市交通的效率和安全性。
...
### [314] [Estimating Technical Loss without Power Flows: A Practical, Data-Driven Approach for Loss Estimation in Distribution Grids](https://arxiv.org/abs/2506.21311)
*Mohini Bariya,Genevieve Flaspohler*

Main category: eess.SY

TL;DR: 本文提出了一种无需功率流测量的新方法，利用稀疏电压幅值测量来估计和定位技术损耗，为低收入和中等收入国家电网提供了一种可行的解决方案。


<details>
  <summary>Details</summary>
Motivation: 低收入和中等收入国家的电网因基础设施薄弱和技术损耗高（超过20%）而面临巨大挑战，亟需低成本、高效的损耗估计方法。

Method: 利用电网中稀疏位置的电压幅值测量数据，开发了一种无需功率流测量的技术损耗估计方法。

Result: 该方法为低收入和中等收入国家电网提供了一种可行的技术损耗估计和定位工具。

Conclusion: 这一方法为电网损耗干预措施的设计和实施提供了关键支持，有助于提升电网的物理和经济强度。
...
### [315] [Joint Scheduling of DER under Demand Charges: Structure and Approximation](https://arxiv.org/abs/2506.21510)
...
<details>
  <summary>Details</summary>
Motivation: 研究动机是解决分布式能源资源（包括灵活负载、可再生能源和电池储能系统）在净计量和需求费用框架下的联合调度问题，以最大化运营盈余。

Method: 方法包括将问题建模为随机动态规划，分析最优控制策略的阈值结构，并提出一种高效的近似算法以降低计算复杂度。

Result: 结果表明，提出的算法在调度范围内线性扩展，并在性能上优于其他DER控制策略，包括基于强化学习的方法。

Conclusion: 结论是提出的算法在多种存储和电价参数下表现优异，接近理论上的性能上限。
...
### [316] [Global and Local Contrastive Learning for Joint Representations from Cardiac MRI and ECG](https://arxiv.org/abs/2506.20683)
...
Method: PTACL采用全局患者级和局部时间级对比损失，对齐ECG和CMR的表征，无需额外可学习参数。

Result: 在UK Biobank数据上，PTACL在患者相似性检索和CMR功能参数预测任务中表现优于基线方法。

Conclusion: PTACL有望通过ECG增强非侵入性心脏诊断，代码已开源。
...
### [317] [Building Lightweight Semantic Segmentation Models for Aerial Images Using Dual Relation Distillation](https://arxiv.org/abs/2506.20688)
*Minglong Li,Lianlei Shan,Weiqiang Wang,Ke Lv,Bin Luo,Si-Bao Chen*

Main category: eess.IV

TL;DR: 提出了一种新颖的双重关系蒸馏（DRD）技术，通过传递空间和通道关系来提升轻量模型的语义分割性能。


<details>
  <summary>Details</summary>
Motivation: 解决CNN模型在语义分割中因计算量大而导致的低推理速度问题，通过知识蒸馏实现精度与效率的平衡。

Method: 分别计算教师模型和学生模型的空间与通道关系图，并通过最小化距离对齐这些关系图。

Result: 在三个数据集（Vaihingen、Potsdam和Cityscapes）上验证了DRD能显著提升学生模型的性能，且不增加额外计算开销。

Conclusion: DRD技术通过传递空间和通道关系，有效提升了轻量模型的分割精度，具有实际应用价值。
...
### [318] [U-R-VEDA: Integrating UNET, Residual Links, Edge and Dual Attention, and Vision Transformer for Accurate Semantic Segmentation of CMRs](https://arxiv.org/abs/2506.20689)
...
### [319] [Development of MR spectral analysis method robust against static magnetic field inhomogeneity](https://arxiv.org/abs/2506.20897)
*Shuki Maruyama,Hidenori Takeshima*

Main category: eess.IV

TL;DR: 提出了一种基于深度学习的谱分析方法，通过模拟B0不均匀性诱导的谱变化，显著提高了谱分析的准确性。
...
Method: 利用深度学习模型，基于B0图和健康人脑代谢物比例生成模拟谱，并通过视觉和定量评估验证模拟谱质量。模型训练结合实测、模拟和建模谱。

Result: 模拟谱与实测谱接近，模型性能显著优于传统方法（如LCModel），代谢物比例误差显著降低。

Conclusion: 新方法通过增加训练样本，有望提高谱分析准确性。
...
### [320] [A Novel Framework for Integrating 3D Ultrasound into Percutaneous Liver Tumour Ablation](https://arxiv.org/abs/2506.21162)
*Shuwei Xing,Derek W. Cool,David Tessier,Elvis C. S. Chen,Terry M. Peters,Aaron Fenster*

Main category: eess.IV

TL;DR: 提出了一种将3D超声（US）整合到标准消融工作流程的新框架，包括2D US-CT/MRI配准和可视化技术，显著提升了配准精度和效率。


<details>
  <summary>Details</summary>
Motivation: 3D超声在肝肿瘤消融中具有潜力，但肿瘤识别难题阻碍了其广泛应用，需开发更有效的整合方法。

Method: 提出2D US-CT/MRI配准方法，利用3D US作为中介降低复杂度，并开发了直观的多模态图像可视化技术。

Result: 2D US-CT/MRI配准误差为2-4 mm，运行时间0.22s/对；非刚性配准比刚性配准误差降低40%。

Conclusion: 该框架提升了3D US在消融治疗中的应用潜力，有望扩展其临床治疗作用。
...
### [321] [Uncover Treasures in DCT: Advancing JPEG Quality Enhancement by Exploiting Latent Correlations](https://arxiv.org/abs/2506.21171)
...
Conclusion: AJQE方法在DCT域实现了高性能和低复杂度的JPEG质量增强。
...
### [322] [GANet-Seg: Adversarial Learning for Brain Tumor Segmentation with Hybrid Generative Models](https://arxiv.org/abs/2506.21245)
*Qifei Cui,Xinyu Lu*

Main category: eess.IV

TL;DR: 提出了一种结合预训练GAN和Unet架构的脑肿瘤分割框架，通过全局异常检测和精细化掩模生成网络提升分割精度。
...
Method: 结合预训练GAN和Unet架构，利用全局异常检测模块和精细化掩模生成网络，通过对抗损失约束和多模态MRI数据增强。

Result: 在BraTS数据集上表现优异，Dice和HD95指标优于基线，减少了对全标注数据的依赖。

Conclusion: 该方法具有可扩展性，适用于临床实践中的脑肿瘤分割任务。
...
### [323] [Lightweight Physics-Informed Zero-Shot Ultrasound Plane Wave Denoising](https://arxiv.org/abs/2506.21499)
*Hojat Asgariandehkordi,Mostafa Sharifzadeh,Hassan Rivaz*

Main category: eess.IV

TL;DR: 提出一种零样本去噪框架，用于低角度CPWC成像，通过自监督残差学习提升图像对比度，无需额外训练数据。


<details>
  <summary>Details</summary>
Motivation: 传统CPWC成像在增加角度提升图像质量时会降低帧率并引入模糊伪影，且对噪声敏感。

Method: 将传输角度分为两个子集生成含噪声的复合图像，通过自监督残差学习训练轻量级模型去噪。
...
TL;DR: 本文研究了3D多模态大语言模型（MLLMs）在放射学报告生成（RRG）中的应用，探讨了视觉输入表示、投影器、大语言模型（LLMs）和微调技术，并提出了两种知识增强方法，性能提升10%，在MICCAI 2024 AMOS-MM挑战赛中排名第二。


<details>
  <summary>Details</summary>
Motivation: 探索3D MLLMs在RRG中的设计空间，以提升放射学报告的自动化生成性能。

Method: 系统研究了3D MLLMs的设计要素，包括视觉输入表示、投影器、LLMs和微调技术，并引入了两种知识增强方法。

Result: 在1,687例AMOS-MM数据集上，RRG性能与LLM大小无关，更大的体积尺寸不一定提升性能，结合分割掩码可提升效果。

Conclusion: 3D MLLMs在RRG中具有潜力，设计选择和知识增强方法显著影响性能。
